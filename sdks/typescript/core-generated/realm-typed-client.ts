...
export type OwnableAssetKind = "WORK" | "ITEM";
export type OwnableAssetStatus = "DRAFT" | "READY" | "ARCHIVED" | "DELETED";
...
export type ResourceControllerKind = "ACCOUNT" | "WORLD";
...
export type ResourceStatus = "PENDING" | "READY" | "FAILED" | "DELETED";
export type ResourceType = "IMAGE" | "VIDEO" | "AUDIO" | "TEXT";
...
export interface WorldCreationEligibilityDto {
  readonly canCreateWorld: boolean;
}
...
export interface WorldPublicMediaDto {
  ...
  readonly unavailableResourceRefs: readonly (string)[];
}
...
export const BundleStatusValue = {
  DRAFT: "DRAFT",
  PUBLISHED: "PUBLISHED",
  ARCHIVED: "ARCHIVED",
} as const satisfies Record<string, BundleStatus>;
...
export const OwnableAssetKindValues = [
  "WORK",
  "ITEM",
] as const satisfies readonly OwnableAssetKind[];

export const OwnableAssetKindValue = {
  WORK: "WORK",
  ITEM: "ITEM",
} as const satisfies Record<string, OwnableAssetKind>;

export const OwnableAssetStatusValues = [
  "DRAFT",
  "READY",
  "ARCHIVED",
  "DELETED",
] as const satisfies readonly OwnableAssetStatus[];

export const OwnableAssetStatusValue = {
  DRAFT: "DRAFT",
  READY: "READY",
  ARCHIVED: "ARCHIVED",
  DELETED: "DELETED",
} as const satisfies Record<string, OwnableAssetStatus>;
...
export const ResourceControllerKindValues = [
  "ACCOUNT",
  "WORLD",
] as const satisfies readonly ResourceControllerKind[];

export const ResourceControllerKindValue = {
  ACCOUNT: "ACCOUNT",
  WORLD: "WORLD",
} as const satisfies Record<string, ResourceControllerKind>;
...
export interface RealmTypedModelMap {
  ...
  readonly "OwnableAssetKind": OwnableAssetKind;
  readonly "OwnableAssetStatus": OwnableAssetStatus;
  ...
  readonly "ResourceControllerKind": ResourceControllerKind;
  ...
  readonly "WorldCreationEligibilityDto": WorldCreationEligibilityDto;
...
export interface RealmListAssetsOperationRequest {
  ...
  readonly query?: {
    readonly kind?: OwnableAssetKind;
    readonly status?: OwnableAssetStatus;
...
export interface RealmListResourcesOperationRequest {
  ...
  readonly query?: {
    ...
    readonly worldId?: string;
    readonly sourceRef?: string;
    readonly controllerKind?: ResourceControllerKind;
    readonly controllerId?: string;
...
export type RealmTransitControllerGetActiveTransitOperationResponse = TransitDetailDto | null;
...
export interface RealmWorldCoreControllerGetWorldCreationEligibilityOperationRequest {
  readonly path: {
...
export type RealmWorldCoreControllerGetWorldCreationEligibilityOperationResponse = WorldCreationEligibilityDto;
...
export class RealmTypedClient {
  ...
  async worldCoreControllerGetWorldCreationEligibility(request: RealmWorldCoreControllerGetWorldCreationEligibilityOperationRequest, options: RealmTypedCallOptions = {}): Promise<RealmWorldCoreControllerGetWorldCreationEligibilityOperationResponse> {
    const response = await this.core.unary<unknown, RealmWorldCoreControllerGetWorldCreationEligibilityOperationRequest>({
      methodId: "WorldCoreController_getWorldCreationEligibility",
      body: request,
      metadata: options.metadata,
      timeoutMs: options.timeoutMs,
      signal: options.signal,
    ...
    return decodeRealmResponse("WorldCoreController_getWorldCreationEligibility", response) as RealmWorldCoreControllerGetWorldCreationEligibilityOperationResponse;
  }
