...
import type { AccountSessionEvent, BeginLoginRequest, BeginLoginResponse, CompleteLoginRequest, CompleteLoginResponse, DecideLocalAppGrantRequest, DecideLocalAppGrantResponse, GetAccountSessionStatusRequest, GetAccountSessionStatusResponse, GetLocalAppGrantStatusRequest, GetLocalAppGrantStatusResponse, InvokeRealmUnaryRequest, InvokeRealmUnaryResponse, IssueScopedAppBindingRequest, IssueScopedAppBindingResponse, IssueWorkspaceBindingRequest, IssueWorkspaceBindingResponse, LogoutRequest, LogoutResponse, RequestLocalAppGrantRequest, RequestLocalAppGrantResponse, RequestPresenceVerificationRequest, RequestPresenceVerificationResponse, RevokeLocalAppGrantRequest, RevokeLocalAppGrantResponse, RevokeScopedAppBindingRequest, RevokeScopedAppBindingResponse, RevokeWorkspaceBindingRequest, RevokeWorkspaceBindingResponse, SubscribeAccountSessionEventsRequest, SwitchAccountRequest, SwitchAccountResponse } from "./runtime-protobuf/runtime/v1/account";
...
export type { AccountCaller, AccountProjection, AccountSessionEvent, BeginLoginRequest, BeginLoginResponse, CompleteLoginRequest, CompleteLoginResponse, DecideLocalAppGrantRequest, DecideLocalAppGrantResponse, GetAccountSessionStatusRequest, GetAccountSessionStatusResponse, GetLocalAppGrantStatusRequest, GetLocalAppGrantStatusResponse, InvokeRealmUnaryRequest, InvokeRealmUnaryResponse, IssueScopedAppBindingRequest, IssueScopedAppBindingResponse, IssueWorkspaceBindingRequest, IssueWorkspaceBindingResponse, LocalAppGrantProjection, LogoutRequest, LogoutResponse, RequestLocalAppGrantRequest, RequestLocalAppGrantResponse, RequestPresenceVerificationRequest, RequestPresenceVerificationResponse, RevokeLocalAppGrantRequest, RevokeLocalAppGrantResponse, RevokeScopedAppBindingRequest, RevokeScopedAppBindingResponse, RevokeWorkspaceBindingRequest, RevokeWorkspaceBindingResponse, ScopedAppBindingRelation, SubscribeAccountSessionEventsRequest, SwitchAccountRequest, SwitchAccountResponse, WorkspaceBindingRelation, WorkspaceMembershipProjection } from "./runtime-protobuf/runtime/v1/account";
...
export type { DecideLocalDevelopmentProjectRequest, DecideLocalDevelopmentProjectResponse, EndLocalDevelopmentRunRequest, EndLocalDevelopmentRunResponse, EvaluateLocalDevelopmentProjectRequest, EvaluateLocalDevelopmentProjectResponse, GetDeveloperModeStatusRequest, GetDeveloperModeStatusResponse, ListLocalDevelopmentAuthorizationsRequest, ListLocalDevelopmentAuthorizationsResponse, LocalDevelopmentAuthorizationProjection, LocalDevelopmentProjectProjection, ReactivateLocalDevelopmentProjectRequest, ReactivateLocalDevelopmentProjectResponse, RevokeLocalDevelopmentAuthorizationRequest, RevokeLocalDevelopmentAuthorizationResponse, SetDeveloperModeRequest, SetDeveloperModeResponse } from "./runtime-protobuf/runtime/v1/development";
...
export { DeveloperModeState, LocalDevelopmentAuthorizationState, LocalDevelopmentDecision, LocalDevelopmentShellKind } from "./runtime-protobuf/runtime/v1/development";
...
export class RuntimeTypedClient {
  ...
  async decideLocalAppGrant(request: DecideLocalAppGrantRequest, options: RuntimeTypedCallOptions = {}): Promise<DecideLocalAppGrantResponse> {
    return this.core.unary<DecideLocalAppGrantResponse, DecideLocalAppGrantRequest>({
      methodId: "/nimi.runtime.v1.RuntimeAccountService/DecideLocalAppGrant",
      body: request,
      metadata: options.metadata,
      timeoutMs: options.timeoutMs,
      signal: options.signal,
  ...
  async getLocalAppGrantStatus(request: GetLocalAppGrantStatusRequest, options: RuntimeTypedCallOptions = {}): Promise<GetLocalAppGrantStatusResponse> {
    return this.core.unary<GetLocalAppGrantStatusResponse, GetLocalAppGrantStatusRequest>({
      methodId: "/nimi.runtime.v1.RuntimeAccountService/GetLocalAppGrantStatus",
      body: request,
      metadata: options.metadata,
      timeoutMs: options.timeoutMs,
      signal: options.signal,
  ...
  async requestLocalAppGrant(request: RequestLocalAppGrantRequest, options: RuntimeTypedCallOptions = {}): Promise<RequestLocalAppGrantResponse> {
    return this.core.unary<RequestLocalAppGrantResponse, RequestLocalAppGrantRequest>({
      methodId: "/nimi.runtime.v1.RuntimeAccountService/RequestLocalAppGrant",
      body: request,
      metadata: options.metadata,
      timeoutMs: options.timeoutMs,
      signal: options.signal,
  ...
  async revokeLocalAppGrant(request: RevokeLocalAppGrantRequest, options: RuntimeTypedCallOptions = {}): Promise<RevokeLocalAppGrantResponse> {
    return this.core.unary<RevokeLocalAppGrantResponse, RevokeLocalAppGrantRequest>({
      methodId: "/nimi.runtime.v1.RuntimeAccountService/RevokeLocalAppGrant",
      body: request,
      metadata: options.metadata,
      timeoutMs: options.timeoutMs,
      signal: options.signal,
  ...
  async listLocalAppAgentInventory(request: ListLocalAppAgentInventoryRequest, options: RuntimeTypedCallOptions = {}): Promise<ListLocalAppAgentInventoryResponse> {
    return this.core.unary<ListLocalAppAgentInventoryResponse, ListLocalAppAgentInventoryRequest>({
  ...
  async reactivateLocalDevelopmentProject(request: ReactivateLocalDevelopmentProjectRequest, options: RuntimeTypedCallOptions = {}): Promise<ReactivateLocalDevelopmentProjectResponse> {
    return this.core.unary<ReactivateLocalDevelopmentProjectResponse, ReactivateLocalDevelopmentProjectRequest>({
