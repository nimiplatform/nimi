...
export class RuntimeTypedClient {
  ...
  async transcribeLocalAppAgentAudio(request: TranscribeLocalAppAgentAudioRequest, options: RuntimeTypedCallOptions = {}): Promise<TranscribeLocalAppAgentAudioResponse> {
    return this.core.unary<TranscribeLocalAppAgentAudioResponse, TranscribeLocalAppAgentAudioRequest>({
