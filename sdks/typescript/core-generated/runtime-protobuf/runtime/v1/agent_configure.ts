 ...
 *
 * @generated from protobuf message nimi.runtime.v1.LocalAppAgentRouteIntent
 */
export interface LocalAppAgentRouteIntent {
    /**
...
export interface LocalAppAgentModelSettingsProjection {
    ...
    capabilities: string[];
    /**
     * @generated from protobuf field: repeated nimi.runtime.v1.LocalAppAgentRouteIntent route_intents = 2
     */
    routeIntents: LocalAppAgentRouteIntent[];
    /**
...
export interface LocalAppAgentConfigurationSnapshotResponse {
    /**
     * @generated from protobuf field: nimi.runtime.v1.LocalAppAgentModelSettingsProjection projection = 1
     */
...
export interface UpdateLocalAppAgentConfigurationRequest {
    ...
    /**
     * @generated from protobuf field: repeated nimi.runtime.v1.LocalAppAgentRouteIntent route_intents = 3
     */
    routeIntents: LocalAppAgentRouteIntent[];
}
/**
...
class LocalAppAgentRouteIntent$Type extends MessageType<LocalAppAgentRouteIntent> {
    constructor() {
        super("nimi.runtime.v1.LocalAppAgentRouteIntent", [
    ...
    create(value?: PartialMessage<LocalAppAgentRouteIntent>): LocalAppAgentRouteIntent {
        ...
        if (value !== undefined)
            reflectionMergePartial<LocalAppAgentRouteIntent>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: LocalAppAgentRouteIntent): LocalAppAgentRouteIntent {
    ...
    internalBinaryWrite(message: LocalAppAgentRouteIntent, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string capability = 1; */
...
/**
 * @generated MessageType for protobuf message nimi.runtime.v1.LocalAppAgentRouteIntent
 */
export const LocalAppAgentRouteIntent = new LocalAppAgentRouteIntent$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class LocalAppAgentModelSettingsProjection$Type extends MessageType<LocalAppAgentModelSettingsProjection> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: LocalAppAgentModelSettingsProjection): LocalAppAgentModelSettingsProjection {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated string capabilities */ 1:
                    ...
                    break;
                case /* repeated nimi.runtime.v1.LocalAppAgentRouteIntent route_intents */ 2:
                    message.routeIntents.push(LocalAppAgentRouteIntent.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: LocalAppAgentModelSettingsProjection, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated string capabilities = 1; */
        for (let i = 0; i < message.capabilities.length; i++)
            writer.tag(1, WireType.LengthDelimited).string(message.capabilities[i]);
        /* repeated nimi.runtime.v1.LocalAppAgentRouteIntent route_intents = 2; */
        for (let i = 0; i < message.routeIntents.length; i++)
            LocalAppAgentRouteIntent.internalBinaryWrite(message.routeIntents[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
...
/**
 * @generated MessageType for protobuf message nimi.runtime.v1.LocalAppAgentModelSettingsProjection
 */
export const LocalAppAgentModelSettingsProjection = new LocalAppAgentModelSettingsProjection$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class LocalAppAgentConfigurationSnapshotResponse$Type extends MessageType<LocalAppAgentConfigurationSnapshotResponse> {
    constructor() {
        super("nimi.runtime.v1.LocalAppAgentConfigurationSnapshotResponse", [
            { no: 1, name: "projection", kind: "message", T: () => LocalAppAgentModelSettingsProjection }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: LocalAppAgentConfigurationSnapshotResponse): LocalAppAgentConfigurationSnapshotResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* nimi.runtime.v1.LocalAppAgentModelSettingsProjection projection */ 1:
                    message.projection = LocalAppAgentModelSettingsProjection.internalBinaryRead(reader, reader.uint32(), options, message.projection);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: LocalAppAgentConfigurationSnapshotResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* nimi.runtime.v1.LocalAppAgentModelSettingsProjection projection = 1; */
        if (message.projection)
            LocalAppAgentModelSettingsProjection.internalBinaryWrite(message.projection, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class UpdateLocalAppAgentConfigurationRequest$Type extends MessageType<UpdateLocalAppAgentConfigurationRequest> {
    constructor() {
        super("nimi.runtime.v1.UpdateLocalAppAgentConfigurationRequest", [
            ...
            { no: 3, name: "route_intents", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => LocalAppAgentRouteIntent }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 expected_configuration_revision */ 2:
                    ...
                    break;
                case /* repeated nimi.runtime.v1.LocalAppAgentRouteIntent route_intents */ 3:
                    message.routeIntents.push(LocalAppAgentRouteIntent.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: UpdateLocalAppAgentConfigurationRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated nimi.runtime.v1.LocalAppAgentRouteIntent route_intents = 3; */
        for (let i = 0; i < message.routeIntents.length; i++)
            LocalAppAgentRouteIntent.internalBinaryWrite(message.routeIntents[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
