...
function strictMaterializationRecord(
  value: unknown,
  label: string,
...
function strictMaterializationRequestId(value: unknown): string {
...
function toRuntimeCharacterSourceRefV3(value: unknown): CharacterSourceRefV3 {
