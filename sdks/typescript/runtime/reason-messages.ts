...
export const NIMI_RUNTIME_REASON_CODES = Object.freeze({
  ...
  AI_LOCAL_EXECUTION_CANCELED: 'AI_LOCAL_EXECUTION_CANCELED',
  AI_LOCAL_EXECUTION_OUT_OF_MEMORY: 'AI_LOCAL_EXECUTION_OUT_OF_MEMORY',
...
const RUNTIME_REASON_CODE_MESSAGE_ENTRIES = [
  ...
  [NIMI_RUNTIME_REASON_CODES.AI_LOCAL_SPEECH_PREFLIGHT_BLOCKED, 'Runtime could not start the local speech capability on this host.'],
  ...
  [NIMI_RUNTIME_REASON_CODES.AI_LOCAL_SPEECH_ENV_INIT_FAILED, 'Runtime local speech environment initialization failed. Inspect Runtime diagnostics.'],
  [NIMI_RUNTIME_REASON_CODES.AI_LOCAL_SPEECH_HOST_INIT_FAILED, 'Runtime could not start the local speech capability.'],
  [NIMI_RUNTIME_REASON_CODES.AI_LOCAL_SPEECH_CAPABILITY_DOWNLOAD_FAILED, 'A required Runtime local speech asset is missing.'],
  [NIMI_RUNTIME_REASON_CODES.AI_LOCAL_SPEECH_BUNDLE_DEGRADED, 'The Runtime local speech bundle is unavailable.'],
  ...
  [NIMI_RUNTIME_REASON_CODES.AI_MEDIA_OPTION_UNSUPPORTED, 'Media option is not supported.'],
  [NIMI_RUNTIME_REASON_CODES.AI_LOCAL_EXECUTION_CANCELED, 'Local AI execution was canceled.'],
  [NIMI_RUNTIME_REASON_CODES.AI_LOCAL_EXECUTION_OUT_OF_MEMORY, 'Local AI execution ran out of memory.'],
