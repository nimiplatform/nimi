...
import type {
  ...
  AppPackageInfo,
  AppPackageJob,
  AppSafetyDeclaration,
  AppSafetyOutputDeclaration,
  AppStorageProjection,
  ApprovedAppCatalogStorageDisclosure,
  ApprovedAppCatalogTarget,
  BindLocalAppProcessRequest,
  BindLocalAppProcessResponse,
  CancelAppPackageJobRequest,
  CancelAppPackageJobResponse,
  CommittedAppRelease,
  CompleteAppPackageUninstallRequest,
  CompleteAppPackageUninstallResponse,
  DiscardLocalAppPackageRequest,
  DiscardLocalAppPackageResponse,
  EndInstalledAppRunRequest,
  EndInstalledAppRunResponse,
  ...
  ListApprovedAppCatalogTargetsRequest,
  ListApprovedAppCatalogTargetsResponse,
  ...
  LocalAppAssetRange,
  LocalAppAssetRecord,
  LocalAppPackagePreview,
  MoveLocalAppAssetRequest,
  MoveLocalAppAssetResponse,
  PauseAppPackageJobRequest,
  PauseAppPackageJobResponse,
  PrepareInstalledAppLaunchRequest,
  PrepareInstalledAppLaunchResponse,
  PrepareLocalAppLaunchRequest,
  PrepareLocalAppLaunchResponse,
  PrepareLocalAppPackageRequest,
  PrepareLocalAppPackageResponse,
  ...
  ReorderAppPackageJobRequest,
  ReorderAppPackageJobResponse,
  ResumeAppPackageJobRequest,
  ResumeAppPackageJobResponse,
  ...
  StartAppPackageUninstallRequest,
  StartAppPackageUninstallResponse,
  StartAppPackageUpdateRequest,
  StartAppPackageUpdateResponse,
  StartLocalAppPackageInstallRequest,
  StartLocalAppPackageInstallResponse,
  StartLocalAppPackageUpdateRequest,
  StartLocalAppPackageUpdateResponse,
...
import type {
  AppActivityAgentAssociation,
  AppActivityFilter,
  AppActivityOpenResult,
  AppActivityRecord,
  AppActivitySource,
  AppActivityUserView,
  ...
  ResolveAppActivityOpenLaunchRequest,
  ResolveAppActivityOpenLaunchResponse,
...
} from "../../core-generated/runtime-protobuf/runtime/v1/app_activity";
