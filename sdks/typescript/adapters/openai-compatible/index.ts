...
export const NIMI_OPENAI_COMPATIBLE_ADAPTER_MANIFEST = {
  ...
  capabilityLevel: 'L2',
  capabilities: {
    'chat.completions.create': 'supported',
    'chat.completions.stream': 'supported',
    'chat.messages.system': 'supported',
    'chat.messages.developer': 'supported',
    'chat.messages.user': 'supported',
    'chat.messages.assistant': 'supported',
    'chat.messages.tool': 'supported',
    'tools.function.definitions': 'supported',
    'tools.function.tool_choice': 'supported',
    'tools.function.return_tool_calls': 'supported',
    'tools.execute': 'unsupported',
    responseFormat: 'supported',
    logprobs: 'unsupported',
    multiChoice: 'unsupported',
    storedChatCrud: 'unsupported',
    responsesApi: 'unsupported',
    completionsApi: 'unsupported',
    embeddingsApi: 'unsupported',
    builtInTools: 'unsupported',
    runtimeRestBypass: 'unsupported',
  },
