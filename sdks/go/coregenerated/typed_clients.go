...
const (
	DEVELOPERMODESTATEUNSPECIFIED DeveloperModeState = "DEVELOPER_MODE_STATE_UNSPECIFIED"
	DEVELOPERMODESTATEDISABLED DeveloperModeState = "DEVELOPER_MODE_STATE_DISABLED"
	DEVELOPERMODESTATEENABLED DeveloperModeState = "DEVELOPER_MODE_STATE_ENABLED"
	DEVELOPERMODESTATEUNAVAILABLE DeveloperModeState = "DEVELOPER_MODE_STATE_UNAVAILABLE"
)
...
const (
	LOCALAPPSESSIONSTATEUNSPECIFIED LocalAppSessionState = "LOCAL_APP_SESSION_STATE_UNSPECIFIED"
	LOCALAPPSESSIONSTATEREADY LocalAppSessionState = "LOCAL_APP_SESSION_STATE_READY"
	LOCALAPPSESSIONSTATERUNTIMEUNAVAILABLE LocalAppSessionState = "LOCAL_APP_SESSION_STATE_RUNTIME_UNAVAILABLE"
	LOCALAPPSESSIONSTATEREVOKED LocalAppSessionState = "LOCAL_APP_SESSION_STATE_REVOKED"
	LOCALAPPSESSIONSTATEACCOUNTCHANGED LocalAppSessionState = "LOCAL_APP_SESSION_STATE_ACCOUNT_CHANGED"
	LOCALAPPSESSIONSTATEPROCESSREPLACED LocalAppSessionState = "LOCAL_APP_SESSION_STATE_PROCESS_REPLACED"
)

type LocalAppTrustClass string

const (
	LOCALAPPTRUSTCLASSUNSPECIFIED LocalAppTrustClass = "LOCAL_APP_TRUST_CLASS_UNSPECIFIED"
	LOCALAPPTRUSTCLASSVERIFIED LocalAppTrustClass = "LOCAL_APP_TRUST_CLASS_VERIFIED"
	LOCALAPPTRUSTCLASSUSERIMPORTED LocalAppTrustClass = "LOCAL_APP_TRUST_CLASS_USER_IMPORTED"
	LOCALAPPTRUSTCLASSLOCALDEVELOPMENT LocalAppTrustClass = "LOCAL_APP_TRUST_CLASS_LOCAL_DEVELOPMENT"
)
...
const (
	LOCALCAPABILITYINTERPRETABILITYUNSPECIFIED LocalCapabilityInterpretability = "LOCAL_CAPABILITY_INTERPRETABILITY_UNSPECIFIED"
	LOCALCAPABILITYINTERPRETABILITYINTERPRETABLE LocalCapabilityInterpretability = "LOCAL_CAPABILITY_INTERPRETABILITY_INTERPRETABLE"
	LOCALCAPABILITYINTERPRETABILITYUNAVAILABLE LocalCapabilityInterpretability = "LOCAL_CAPABILITY_INTERPRETABILITY_UNAVAILABLE"
)

type LocalCapabilityReason string

const (
	LOCALCAPABILITYREASONUNSPECIFIED LocalCapabilityReason = "LOCAL_CAPABILITY_REASON_UNSPECIFIED"
	LOCALCAPABILITYREASONDRIVERNOTFOUND LocalCapabilityReason = "LOCAL_CAPABILITY_REASON_DRIVER_NOT_FOUND"
	LOCALCAPABILITYREASONDRIVERDIALECTUNSUPPORTED LocalCapabilityReason = "LOCAL_CAPABILITY_REASON_DRIVER_DIALECT_UNSUPPORTED"
	LOCALCAPABILITYREASONIMPLEMENTATIONUNSUPPORTED LocalCapabilityReason = "LOCAL_CAPABILITY_REASON_IMPLEMENTATION_UNSUPPORTED"
	LOCALCAPABILITYREASONPORTABLECONFIGINVALID LocalCapabilityReason = "LOCAL_CAPABILITY_REASON_PORTABLE_CONFIG_INVALID"
	LOCALCAPABILITYREASONFEATUREUNSUPPORTED LocalCapabilityReason = "LOCAL_CAPABILITY_REASON_FEATURE_UNSUPPORTED"
	LOCALCAPABILITYREASONREQUIREDBINDINGMISSING LocalCapabilityReason = "LOCAL_CAPABILITY_REASON_REQUIRED_BINDING_MISSING"
	LOCALCAPABILITYREASONBINDINGAMBIGUOUS LocalCapabilityReason = "LOCAL_CAPABILITY_REASON_BINDING_AMBIGUOUS"
	LOCALCAPABILITYREASONLOCALASSETNOTFOUND LocalCapabilityReason = "LOCAL_CAPABILITY_REASON_LOCAL_ASSET_NOT_FOUND"
...
const (
	LOCALCAPABILITYREQUIREMENTPOLICYUNSPECIFIED LocalCapabilityRequirementPolicy = "LOCAL_CAPABILITY_REQUIREMENT_POLICY_UNSPECIFIED"
	LOCALCAPABILITYREQUIREMENTPOLICYSTRICT LocalCapabilityRequirementPolicy = "LOCAL_CAPABILITY_REQUIREMENT_POLICY_STRICT"
...
const (
	LOCALCAPABILITYREQUIREMENTROLEUNSPECIFIED LocalCapabilityRequirementRole = "LOCAL_CAPABILITY_REQUIREMENT_ROLE_UNSPECIFIED"
	LOCALCAPABILITYREQUIREMENTROLEMAIN LocalCapabilityRequirementRole = "LOCAL_CAPABILITY_REQUIREMENT_ROLE_MAIN"
...
const (
	...
	RUNTIMEEXECUTABLETRUSTINVALID ReasonCode = "RUNTIME_EXECUTABLE_TRUST_INVALID"
	...
	LOCALAPPPROVENANCEUNAVAILABLE ReasonCode = "LOCAL_APP_PROVENANCE_UNAVAILABLE"
	LOCALAPPLAUNCHLEASEREQUIRED ReasonCode = "LOCAL_APP_LAUNCH_LEASE_REQUIRED"
	LOCALAPPLAUNCHLEASEMISMATCH ReasonCode = "LOCAL_APP_LAUNCH_LEASE_MISMATCH"
	...
	AILOCALEXECUTIONLOADFAILED ReasonCode = "AI_LOCAL_EXECUTION_LOAD_FAILED"
...
type ApplyLocalAppSharedLocalAgentAIProfileRequest struct {
	ProfileJson []byte `json:"profile_json,omitempty"`
}

type ApplyLocalAppSharedLocalAgentAIProfileResponse struct {
...
type CapabilityImplementationIdentity struct {
	...
	DriverDialect string `json:"driver_dialect,omitempty"`
}
...
type GetAgentResponse struct {
	Agent *LocalAgentRecord `json:"agent,omitempty"`
}
...
type ListAgentsResponse struct {
	Agents []LocalAgentRecord `json:"agents,omitempty"`
	NextPageToken string `json:"next_page_token,omitempty"`
}
...
type PreviewLocalAppSharedLocalAgentAIProfileRequest struct {
	ProfileJson []byte `json:"profile_json,omitempty"`
}

type PreviewLocalAppSharedLocalAgentAIProfileResponse struct {
	Before *LocalAppSharedLocalAgentAIConfigProjection `json:"before,omitempty"`
	After *LocalAppSharedLocalAgentAIConfigProjection `json:"after,omitempty"`
}
...
type PreviewSharedLocalAgentAIProfileResponse struct {
	Before *AIConfig `json:"before,omitempty"`
	After *AIConfig `json:"after,omitempty"`
}
...
func (c RuntimeTypedClient) ApplyLocalAppSharedLocalAgentAIProfile(ctx context.Context, request ApplyLocalAppSharedLocalAgentAIProfileRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (ApplyLocalAppSharedLocalAgentAIProfileResponse, error) {
	raw, err := c.callTyped(ctx, "/nimi.runtime.v1.RuntimeAgentService/ApplyLocalAppSharedLocalAgentAIProfile", request, metadata, timeoutMS)
	if err != nil {
		return ApplyLocalAppSharedLocalAgentAIProfileResponse{}, err
	}
	return decodeRuntimeTypedResponse[ApplyLocalAppSharedLocalAgentAIProfileResponse](raw, "ApplyLocalAppSharedLocalAgentAIProfileResponse")
}
...
func (c RuntimeTypedClient) GetLocalAppSharedLocalAgentAIConfig(ctx context.Context, request GetLocalAppSharedLocalAgentAIConfigRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (GetLocalAppSharedLocalAgentAIConfigResponse, error) {
	...
	if err != nil {
		return GetLocalAppSharedLocalAgentAIConfigResponse{}, err
	}
	return decodeRuntimeTypedResponse[GetLocalAppSharedLocalAgentAIConfigResponse](raw, "GetLocalAppSharedLocalAgentAIConfigResponse")
}
...
func (c RuntimeTypedClient) GetSharedLocalAgentAIConfig(ctx context.Context, request GetSharedLocalAgentAIConfigRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (GetSharedLocalAgentAIConfigResponse, error) {
	raw, err := c.callTyped(ctx, "/nimi.runtime.v1.RuntimeAgentService/GetSharedLocalAgentAIConfig", request, metadata, timeoutMS)
	if err != nil {
		return GetSharedLocalAgentAIConfigResponse{}, err
	}
...
func (c RuntimeTypedClient) OverwriteLocalAppSharedLocalAgentAIConfig(ctx context.Context, request OverwriteLocalAppSharedLocalAgentAIConfigRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (OverwriteLocalAppSharedLocalAgentAIConfigResponse, error) {
	raw, err := c.callTyped(ctx, "/nimi.runtime.v1.RuntimeAgentService/OverwriteLocalAppSharedLocalAgentAIConfig", request, metadata, timeoutMS)
	if err != nil {
		return OverwriteLocalAppSharedLocalAgentAIConfigResponse{}, err
	}
	return decodeRuntimeTypedResponse[OverwriteLocalAppSharedLocalAgentAIConfigResponse](raw, "OverwriteLocalAppSharedLocalAgentAIConfigResponse")
}

func (c RuntimeTypedClient) OverwriteSharedLocalAgentAIConfig(ctx context.Context, request OverwriteSharedLocalAgentAIConfigRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (OverwriteSharedLocalAgentAIConfigResponse, error) {
	raw, err := c.callTyped(ctx, "/nimi.runtime.v1.RuntimeAgentService/OverwriteSharedLocalAgentAIConfig", request, metadata, timeoutMS)
	if err != nil {
		return OverwriteSharedLocalAgentAIConfigResponse{}, err
	}
	return decodeRuntimeTypedResponse[OverwriteSharedLocalAgentAIConfigResponse](raw, "OverwriteSharedLocalAgentAIConfigResponse")
}

func (c RuntimeTypedClient) PreviewLocalAppSharedLocalAgentAIProfile(ctx context.Context, request PreviewLocalAppSharedLocalAgentAIProfileRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (PreviewLocalAppSharedLocalAgentAIProfileResponse, error) {
	raw, err := c.callTyped(ctx, "/nimi.runtime.v1.RuntimeAgentService/PreviewLocalAppSharedLocalAgentAIProfile", request, metadata, timeoutMS)
	if err != nil {
		return PreviewLocalAppSharedLocalAgentAIProfileResponse{}, err
	}
	return decodeRuntimeTypedResponse[PreviewLocalAppSharedLocalAgentAIProfileResponse](raw, "PreviewLocalAppSharedLocalAgentAIProfileResponse")
}

func (c RuntimeTypedClient) PreviewSharedLocalAgentAIProfile(ctx context.Context, request PreviewSharedLocalAgentAIProfileRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (PreviewSharedLocalAgentAIProfileResponse, error) {
	raw, err := c.callTyped(ctx, "/nimi.runtime.v1.RuntimeAgentService/PreviewSharedLocalAgentAIProfile", request, metadata, timeoutMS)
	if err != nil {
		return PreviewSharedLocalAgentAIProfileResponse{}, err
	}
...
func (c RuntimeTypedClient) BindLocalAppProcess(ctx context.Context, request BindLocalAppProcessRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (BindLocalAppProcessResponse, error) {
	...
	if err != nil {
		return BindLocalAppProcessResponse{}, err
	}
...
func (c RuntimeTypedClient) OpenLocalAppSession(ctx context.Context, request OpenLocalAppSessionRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (OpenLocalAppSessionResponse, error) {
	raw, err := c.callTyped(ctx, "/nimi.runtime.v1.RuntimeAuthService/OpenLocalAppSession", request, metadata, timeoutMS)
	if err != nil {
...
func (c RuntimeTypedClient) GetDeveloperModeStatus(ctx context.Context, request GetDeveloperModeStatusRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (GetDeveloperModeStatusResponse, error) {
	raw, err := c.callTyped(ctx, "/nimi.runtime.v1.RuntimeDevelopmentService/GetDeveloperModeStatus", request, metadata, timeoutMS)
	if err != nil {
...
func (c RuntimeTypedClient) SetDeveloperMode(ctx context.Context, request SetDeveloperModeRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (SetDeveloperModeResponse, error) {
	raw, err := c.callTyped(ctx, "/nimi.runtime.v1.RuntimeDevelopmentService/SetDeveloperMode", request, metadata, timeoutMS)
	if err != nil {
		return SetDeveloperModeResponse{}, err
	}
	return decodeRuntimeTypedResponse[SetDeveloperModeResponse](raw, "SetDeveloperModeResponse")
}
...
func (c RuntimeTypedClient) RequestRuntimeRestart(ctx context.Context, request RequestRuntimeRestartRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (RequestRuntimeRestartResponse, error) {
	raw, err := c.callTyped(ctx, "/nimi.runtime.v1.RuntimeServiceControlService/RequestRuntimeRestart", request, metadata, timeoutMS)
	if err != nil {
...
type RealmFeedbackControllerSubmitFeedbackOperationRequest struct {
	...
	Body    CreateFeedbackDto `json:"body,omitempty"`
}
...
type RealmWorldCoreControllerCreateWorldRelationshipOperationPath struct {
	WorldId string `json:"worldId,omitempty"`
}

type RealmWorldCoreControllerCreateWorldRelationshipOperationQuery struct {

}

type RealmWorldCoreControllerCreateWorldRelationshipOperationHeaders struct {

}

type RealmWorldCoreControllerCreateWorldRelationshipOperationRequest struct {
	Path    RealmWorldCoreControllerCreateWorldRelationshipOperationPath `json:"path,omitempty"`
	Query   RealmWorldCoreControllerCreateWorldRelationshipOperationQuery `json:"query,omitempty"`
	Headers RealmWorldCoreControllerCreateWorldRelationshipOperationHeaders `json:"headers,omitempty"`
...
type RealmWorldCoreControllerGetWorldRelationshipOperationPath struct {
	RelationshipId string `json:"relationshipId,omitempty"`
}

type RealmWorldCoreControllerGetWorldRelationshipOperationQuery struct {

}

type RealmWorldCoreControllerGetWorldRelationshipOperationHeaders struct {

}

type RealmWorldCoreControllerGetWorldRelationshipOperationRequest struct {
	Path    RealmWorldCoreControllerGetWorldRelationshipOperationPath `json:"path,omitempty"`
	Query   RealmWorldCoreControllerGetWorldRelationshipOperationQuery `json:"query,omitempty"`
	Headers RealmWorldCoreControllerGetWorldRelationshipOperationHeaders `json:"headers,omitempty"`
	Body    struct{} `json:"body,omitempty"`
}
...
type RealmWorldCoreControllerListWorldRelationshipsOperationPath struct {
	WorldId string `json:"worldId,omitempty"`
}
...
type RealmWorldCoreControllerListWorldRelationshipsOperationRequest struct {
	Path    RealmWorldCoreControllerListWorldRelationshipsOperationPath `json:"path,omitempty"`
	Query   RealmWorldCoreControllerListWorldRelationshipsOperationQuery `json:"query,omitempty"`
	Headers RealmWorldCoreControllerListWorldRelationshipsOperationHeaders `json:"headers,omitempty"`
	Body    struct{} `json:"body,omitempty"`
}
...
type RealmWorldCoreControllerReplaceWorldRelationshipOperationPath struct {
	RelationshipId string `json:"relationshipId,omitempty"`
}

type RealmWorldCoreControllerReplaceWorldRelationshipOperationQuery struct {

}

type RealmWorldCoreControllerReplaceWorldRelationshipOperationHeaders struct {

}

type RealmWorldCoreControllerReplaceWorldRelationshipOperationRequest struct {
	Path    RealmWorldCoreControllerReplaceWorldRelationshipOperationPath `json:"path,omitempty"`
	Query   RealmWorldCoreControllerReplaceWorldRelationshipOperationQuery `json:"query,omitempty"`
	Headers RealmWorldCoreControllerReplaceWorldRelationshipOperationHeaders `json:"headers,omitempty"`
	Body    ReplaceWorldRelationshipCoreDto `json:"body,omitempty"`
}

type RealmWorldPublicControllerGetCharacterSourceOperationPath struct {

}

type RealmWorldPublicControllerGetCharacterSourceOperationQuery struct {

}

type RealmWorldPublicControllerGetCharacterSourceOperationHeaders struct {

}

type RealmWorldPublicControllerGetCharacterSourceOperationRequest struct {
	Path    RealmWorldPublicControllerGetCharacterSourceOperationPath `json:"path,omitempty"`
	Query   RealmWorldPublicControllerGetCharacterSourceOperationQuery `json:"query,omitempty"`
	Headers RealmWorldPublicControllerGetCharacterSourceOperationHeaders `json:"headers,omitempty"`
	Body    WorldPublicCharacterSourceRequestDto `json:"body,omitempty"`
}
...
func (c RealmTypedClient) WorldCoreControllerCreateWorldRelationship(ctx context.Context, request RealmWorldCoreControllerCreateWorldRelationshipOperationRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (WorldRelationshipCoreDto, error) {
	raw, err := c.operationTyped(ctx, "WorldCoreController_createWorldRelationship", request, metadata, timeoutMS)
	if err != nil {
		return WorldRelationshipCoreDto{}, err
	}
...
func (c RealmTypedClient) WorldCoreControllerGetWorldRelationship(ctx context.Context, request RealmWorldCoreControllerGetWorldRelationshipOperationRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (WorldRelationshipCoreDto, error) {
	raw, err := c.operationTyped(ctx, "WorldCoreController_getWorldRelationship", request, metadata, timeoutMS)
	if err != nil {
		return WorldRelationshipCoreDto{}, err
	}
	return decodeTypedResponse[WorldRelationshipCoreDto](raw)
...
func (c RealmTypedClient) WorldCoreControllerListWorldRelationships(ctx context.Context, request RealmWorldCoreControllerListWorldRelationshipsOperationRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) ([]WorldRelationshipCoreDto, error) {
	raw, err := c.operationTyped(ctx, "WorldCoreController_listWorldRelationships", request, metadata, timeoutMS)
	if err != nil {
		return []WorldRelationshipCoreDto{}, err
	}
	return decodeTypedResponse[[]WorldRelationshipCoreDto](raw)
...
func (c RealmTypedClient) WorldCoreControllerReplaceWorldRelationship(ctx context.Context, request RealmWorldCoreControllerReplaceWorldRelationshipOperationRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (WorldRelationshipCoreDto, error) {
	raw, err := c.operationTyped(ctx, "WorldCoreController_replaceWorldRelationship", request, metadata, timeoutMS)
	if err != nil {
		return WorldRelationshipCoreDto{}, err
	}
	return decodeTypedResponse[WorldRelationshipCoreDto](raw)
...
func (c RealmTypedClient) WorldPublicControllerGetCharacterSource(ctx context.Context, request RealmWorldPublicControllerGetCharacterSourceOperationRequest, metadata sdkstypes.CoreMetadata, timeoutMS int64) (WorldPublicSourceCardDto, error) {
	raw, err := c.operationTyped(ctx, "WorldPublicController_getCharacterSource", request, metadata, timeoutMS)
	if err != nil {
