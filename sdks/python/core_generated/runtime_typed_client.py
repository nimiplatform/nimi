...
AgentSourceCognitionStatus = Literal["AGENT_SOURCE_COGNITION_STATUS_UNSPECIFIED", "AGENT_SOURCE_COGNITION_STATUS_UNCONFIGURED", "AGENT_SOURCE_COGNITION_STATUS_BUILDING", "AGENT_SOURCE_COGNITION_STATUS_READY", "AGENT_SOURCE_COGNITION_STATUS_UNAVAILABLE", "AGENT_SOURCE_COGNITION_STATUS_FAILURE", "AGENT_SOURCE_COGNITION_STATUS_NO_HITS", "AGENT_SOURCE_COGNITION_STATUS_NO_RESULT"]
...
AiVideoPixelFormat = Literal["AI_VIDEO_PIXEL_FORMAT_UNSPECIFIED", "AI_VIDEO_PIXEL_FORMAT_RGB8"]
AppActivityChangeKind = Literal["APP_ACTIVITY_CHANGE_KIND_UNSPECIFIED", "APP_ACTIVITY_CHANGE_KIND_UPSERT", "APP_ACTIVITY_CHANGE_KIND_REMOVE"]
AppActivityKind = Literal["APP_ACTIVITY_KIND_UNSPECIFIED", "APP_ACTIVITY_KIND_ACTIVITY", "APP_ACTIVITY_KIND_TODO"]
AppActivityOpenCompletion = Literal["APP_ACTIVITY_OPEN_COMPLETION_UNSPECIFIED", "APP_ACTIVITY_OPEN_COMPLETION_OPENED", "APP_ACTIVITY_OPEN_COMPLETION_OBJECT_UNAVAILABLE"]
AppActivityOpenLaunchSourceClass = Literal["APP_ACTIVITY_OPEN_LAUNCH_SOURCE_CLASS_UNSPECIFIED", "APP_ACTIVITY_OPEN_LAUNCH_SOURCE_CLASS_INSTALLED", "APP_ACTIVITY_OPEN_LAUNCH_SOURCE_CLASS_LOCAL_DEVELOPMENT"]
AppActivityOpenOutcome = Literal["APP_ACTIVITY_OPEN_OUTCOME_UNSPECIFIED", "APP_ACTIVITY_OPEN_OUTCOME_OPENED", "APP_ACTIVITY_OPEN_OUTCOME_UNAVAILABLE", "APP_ACTIVITY_OPEN_OUTCOME_FAILED"]
AppActivityOpenReason = Literal["APP_ACTIVITY_OPEN_REASON_UNSPECIFIED", "APP_ACTIVITY_OPEN_REASON_OPENED", "APP_ACTIVITY_OPEN_REASON_NOT_OPENABLE", "APP_ACTIVITY_OPEN_REASON_SOURCE_UNAVAILABLE", "APP_ACTIVITY_OPEN_REASON_OBJECT_UNAVAILABLE", "APP_ACTIVITY_OPEN_REASON_SOURCE_NOT_READY", "APP_ACTIVITY_OPEN_REASON_CANCELED", "APP_ACTIVITY_OPEN_REASON_ACTIVITY_UNAVAILABLE"]
AppActivitySourceKind = Literal["APP_ACTIVITY_SOURCE_KIND_UNSPECIFIED", "APP_ACTIVITY_SOURCE_KIND_APP", "APP_ACTIVITY_SOURCE_KIND_RUNTIME_AGENT"]
AppActivityTodoState = Literal["APP_ACTIVITY_TODO_STATE_UNSPECIFIED", "APP_ACTIVITY_TODO_STATE_OPEN", "APP_ACTIVITY_TODO_STATE_COMPLETED", "APP_ACTIVITY_TODO_STATE_CANCELLED"]
...
ExecutionInterruptionCause = Literal["EXECUTION_INTERRUPTION_CAUSE_UNSPECIFIED", "EXECUTION_INTERRUPTION_CAUSE_RUNTIME_RESTART"]
ExecutionMode = Literal["EXECUTION_MODE_UNSPECIFIED", "EXECUTION_MODE_SYNC", "EXECUTION_MODE_STREAM", "EXECUTION_MODE_ASYNC_JOB"]
ExecutionResubmitDisposition = Literal["EXECUTION_RESUBMIT_DISPOSITION_UNSPECIFIED", "EXECUTION_RESUBMIT_DISPOSITION_CALLER_MAY_RESUBMIT"]
...
FaceSwapNoFacePolicy = Literal["FACE_SWAP_NO_FACE_POLICY_UNSPECIFIED", "FACE_SWAP_NO_FACE_POLICY_FAIL", "FACE_SWAP_NO_FACE_POLICY_PRESERVE_FRAME"]
...
LocalAppConversationMessageRole = Literal["LOCAL_APP_CONVERSATION_MESSAGE_ROLE_UNSPECIFIED", "LOCAL_APP_CONVERSATION_MESSAGE_ROLE_USER", "LOCAL_APP_CONVERSATION_MESSAGE_ROLE_ASSISTANT", "LOCAL_APP_CONVERSATION_MESSAGE_ROLE_APP"]
...
LocalAssetKind = Literal["LOCAL_ASSET_KIND_UNSPECIFIED", "LOCAL_ASSET_KIND_CHAT", "LOCAL_ASSET_KIND_IMAGE", "LOCAL_ASSET_KIND_VIDEO", "LOCAL_ASSET_KIND_TTS", "LOCAL_ASSET_KIND_STT", "LOCAL_ASSET_KIND_EMBEDDING", "LOCAL_ASSET_KIND_MUSIC", "LOCAL_ASSET_KIND_VISION", "LOCAL_ASSET_KIND_VAE", "LOCAL_ASSET_KIND_CLIP", "LOCAL_ASSET_KIND_LORA", "LOCAL_ASSET_KIND_CONTROLNET", "LOCAL_ASSET_KIND_AUXILIARY"]
...
LocalCapabilityRequirementPresence = Literal["LOCAL_CAPABILITY_REQUIREMENT_PRESENCE_UNSPECIFIED", "LOCAL_CAPABILITY_REQUIREMENT_PRESENCE_REQUIRED", "LOCAL_CAPABILITY_REQUIREMENT_PRESENCE_OPTIONAL_CONDITIONAL"]
LocalCapabilityRequirementResolution = Literal["LOCAL_CAPABILITY_REQUIREMENT_RESOLUTION_UNSPECIFIED", "LOCAL_CAPABILITY_REQUIREMENT_RESOLUTION_UNRESOLVED", "LOCAL_CAPABILITY_REQUIREMENT_RESOLUTION_CONFIGURED", "LOCAL_CAPABILITY_REQUIREMENT_RESOLUTION_NOT_CONFIGURED"]
...
LocalTransferAction = Literal["LOCAL_TRANSFER_ACTION_UNSPECIFIED", "LOCAL_TRANSFER_ACTION_PAUSE", "LOCAL_TRANSFER_ACTION_RESUME", "LOCAL_TRANSFER_ACTION_CANCEL", "LOCAL_TRANSFER_ACTION_REIMPORT", "LOCAL_TRANSFER_ACTION_CHECK_SYNC", "LOCAL_TRANSFER_ACTION_VIEW_RELATED_TRANSFER"]
LocalTransferDisposition = Literal["LOCAL_TRANSFER_DISPOSITION_UNSPECIFIED", "LOCAL_TRANSFER_DISPOSITION_CREATED", "LOCAL_TRANSFER_DISPOSITION_REUSED"]
...
Modal = Literal["MODAL_UNSPECIFIED", "MODAL_TEXT", "MODAL_IMAGE", "MODAL_VIDEO", "MODAL_TTS", "MODAL_STT", "MODAL_EMBEDDING", "MODAL_MUSIC", "MODAL_WORLD", "MODAL_VISION"]
...
class AIConfigLocalLoadoutOptions:
    options: tuple[AIConfigLocalResourceProjection, ...] = field(default_factory=tuple)

@dataclass(frozen=True)
class AIConfigLocalLoadoutOptionsQuery:
    capability_contract: str | None = None
    search: str | None = None

@dataclass(frozen=True)
class AIConfigLocalResourceProjection:
...
class AgentConversationContextSummary:
    ...
    revision: int | None = None
    covered_sequence_start: int | None = None
    covered_sequence_end: int | None = None
...
class AgentSourceCognitionSummary:
    adapter_status: AgentSourceCognitionStatus | None = None
    selection_status: AgentSourceCognitionStatus | None = None
    generation: int | None = None
    candidate_count: int | None = None
    included_unit_count: int | None = None
    omitted_unit_count: int | None = None
...
class AgentTurnContextBudgetSummary:
    ...
    reserved_reasoning_tokens: int | None = None
...
class AgentTurnContextSummary:
    ...
    conversation_anchor_id: str | None = None
    turn_id: str | None = None
    source_cognition: AgentSourceCognitionSummary | None = None
    conversation_summary: AgentConversationContextSummary | None = None
...
@dataclass(frozen=True)
class AiVideoFrameDisposition:
    sequence: int | None = None
    timestamp_us: int | None = None
    reason_code: ReasonCode | None = None

@dataclass(frozen=True)
class AiVideoSessionFormat:
    width: int | None = None
    height: int | None = None
    pixel_format: AiVideoPixelFormat | None = None

@dataclass(frozen=True)
class AiVideoSessionResult:
    video_session_id: str | None = None
    generation: int | None = None
    transformed: AiVideoTransformedFrame | None = None
    no_target_face: AiVideoFrameDisposition | None = None
    input_dropped: AiVideoFrameDisposition | None = None
    input_rejected: AiVideoFrameDisposition | None = None
    session_terminal: AiVideoSessionTerminal | None = None

@dataclass(frozen=True)
class AiVideoSessionTerminal:
    reason_code: ReasonCode | None = None

@dataclass(frozen=True)
class AiVideoTransformedFrame:
    sequence: int | None = None
    timestamp_us: int | None = None
    frame: bytes | None = None
...
@dataclass(frozen=True)
class AppActivityAgentAssociation:
    agent_ref: str | None = None
    display_name: str | None = None

@dataclass(frozen=True)
class AppActivityFilter:
    source_ref: str | None = None
    kind: AppActivityKind | None = None
    todo_states: tuple[AppActivityTodoState, ...] = field(default_factory=tuple)
    agent_ref: str | None = None
    occurred_after: str | None = None
    occurred_before: str | None = None

@dataclass(frozen=True)
class AppActivityOpenResult:
    outcome: AppActivityOpenOutcome | None = None
    reason: AppActivityOpenReason | None = None

@dataclass(frozen=True)
class AppActivityRecord:
    activity_id: str | None = None
    source: AppActivitySource | None = None
    key: str | None = None
    revision: int | None = None
    kind: AppActivityKind | None = None
    todo_state: AppActivityTodoState | None = None
    ...
    agent: AppActivityAgentAssociation | None = None
    occurred_at: str | None = None
    published_at: str | None = None
    updated_at: str | None = None
    change_seq: int | None = None
    user_view: AppActivityUserView | None = None

@dataclass(frozen=True)
class AppActivitySource:
    kind: AppActivitySourceKind | None = None
    source_ref: str | None = None
    app_id: str | None = None
    display_name: str | None = None
...
@dataclass(frozen=True)
class AppActivityUserView:
    read_through_revision: int | None = None
...
class AppPackageInfo:
    ...
    capability_contract_refs: tuple[str, ...] = field(default_factory=tuple)
    required_standardized_feature_refs: tuple[str, ...] = field(default_factory=tuple)
    storage_policy_kind: str | None = None
    os_storage_disclosure: tuple[ApprovedAppCatalogStorageDisclosure, ...] = field(default_factory=tuple)
    author: str | None = None
    homepage_url: str | None = None
    support_url: str | None = None
    safety_declaration: AppSafetyDeclaration | None = None

@dataclass(frozen=True)
class AppPackageJob:
    job_id: bytes | None = None
    app_id: str | None = None
    source_class: AppPackageSourceClass | None = None
    kind: AppPackageJobKind | None = None
    target_ref: str | None = None
    phase: AppPackageJobPhase | None = None
    progress_basis: AppPackageProgressBasis | None = None
...
@dataclass(frozen=True)
class AppSafetyDeclaration:
    intended_audience: str | None = None
    content_descriptors: tuple[str, ...] = field(default_factory=tuple)
    ai_direct_interaction: bool | None = None
    ai_interaction_notice: str | None = None
    ai_risk_features: tuple[str, ...] = field(default_factory=tuple)
    ai_subject_notice: str | None = None
    ai_outputs: tuple[AppSafetyOutputDeclaration, ...] = field(default_factory=tuple)
    publisher_direct_external_network: bool | None = None
    telemetry: tuple[str, ...] = field(default_factory=tuple)
    third_party_account: str | None = None
    user_content_sharing: str | None = None
    commercial_features: tuple[str, ...] = field(default_factory=tuple)
    sensitive_data_categories: tuple[str, ...] = field(default_factory=tuple)
    high_impact_decision_uses: tuple[str, ...] = field(default_factory=tuple)

@dataclass(frozen=True)
class AppSafetyOutputDeclaration:
    modality: str | None = None
    exposure: str | None = None
    publication_control: str | None = None
    in_product_notice: str | None = None
    export_visible_marking: str | None = None
    machine_readable_marking: str | None = None
...
class ApprovedAppCatalogTarget:
    approved_target_selector: bytes | None = None
    observed_registry_revision: str | None = None
    descriptor_id: str | None = None
    app_id: str | None = None
    display_name: str | None = None
    version: str | None = None
    publisher_github_namespace: str | None = None
    source_repository: str | None = None
    source_license_spdx_expression: str | None = None
    app_access: tuple[str, ...] = field(default_factory=tuple)
    capability_contract_refs: tuple[str, ...] = field(default_factory=tuple)
    required_standardized_feature_refs: tuple[str, ...] = field(default_factory=tuple)
    storage_policy_kind: str | None = None
    os_storage_disclosures: tuple[ApprovedAppCatalogStorageDisclosure, ...] = field(default_factory=tuple)
    target_id: str | None = None
    os: str | None = None
    arch: str | None = None
    ...
    windows_code_signing: str | None = None
    observed_signing_subject: str | None = None
...
@dataclass(frozen=True)
class CancelAppPackageJobRequest:
    job_id: bytes | None = None
    expected_phase: AppPackageJobPhase | None = None
    reason_code: str | None = None

@dataclass(frozen=True)
class CancelAppPackageJobResponse:
...
@dataclass(frozen=True)
class CloseVideoSessionRequest:
    video_session_id: str | None = None
    generation: int | None = None

@dataclass(frozen=True)
class CloseVideoSessionResponse:
...
@dataclass(frozen=True)
class CommittedAppRelease:
    app_id: str | None = None
    source_class: AppPackageSourceClass | None = None
    version: str | None = None
    release_ref: str | None = None
    launch_selector: bytes | None = None
    committed_at: str | None = None
    display_name: str | None = None
    app_access: tuple[str, ...] = field(default_factory=tuple)

@dataclass(frozen=True)
class CompleteAppActivityOpenRequestRequest:
    delivery_id: str | None = None
    completion: AppActivityOpenCompletion | None = None

@dataclass(frozen=True)
class CompleteAppActivityOpenRequestResponse:
    accepted: bool | None = None

@dataclass(frozen=True)
class CompleteAppPackageUninstallRequest:
    job_id: bytes | None = None
    launch_selector: bytes | None = None
...
@dataclass(frozen=True)
class DiscardLocalAppPackageRequest:
    candidate_selector: bytes | None = None

@dataclass(frozen=True)
class DiscardLocalAppPackageResponse:
    reason_code: ReasonCode | None = None
...
@dataclass(frozen=True)
class EndInstalledAppRunRequest:
    launch_id: bytes | None = None

@dataclass(frozen=True)
class EndInstalledAppRunResponse:
    reason_code: ReasonCode | None = None
...
class ExecuteLocalAppScenarioResponse:
    ...
    text_decide: TextDecisionResult | None = None
...
@dataclass(frozen=True)
class ExecutionInterruption:
    cause: ExecutionInterruptionCause | None = None
    resubmit_disposition: ExecutionResubmitDisposition | None = None
...
@dataclass(frozen=True)
class GetAppPackageInfoRequest:
    approved_target_selector: bytes | None = None
    launch_selector: bytes | None = None
    installed_release_ref: str | None = None

@dataclass(frozen=True)
class GetAppPackageInfoResponse:
    info: AppPackageInfo | None = None
    reason_code: ReasonCode | None = None

@dataclass(frozen=True)
class GetAppPackageJobRequest:
    job_id: bytes | None = None

@dataclass(frozen=True)
class GetAppPackageJobResponse:
    job: AppPackageJob | None = None
    reason_code: ReasonCode | None = None
...
class GetLocalAppScenarioJobResponse:
    ...
    vision_locate: VisionLocateResult | None = None
...
@dataclass(frozen=True)
class GetProductControlCheckSyncRequest:
    pass
...
@dataclass(frozen=True)
class ImageFaceSwapResult:
    artifacts: tuple[ScenarioArtifact, ...] = field(default_factory=tuple)

@dataclass(frozen=True)
class ImageFaceSwapScenarioSpec:
    reference_image_artifact_id: str | None = None
    target_image_artifact_id: str | None = None
...
@dataclass(frozen=True)
class InitializeProductControlRootActivationRequest:
    pass
...
@dataclass(frozen=True)
class ListAppActivitiesRequest:
    filter: AppActivityFilter | None = None
    page_size: int | None = None
    page_token: str | None = None

@dataclass(frozen=True)
class ListAppActivitiesResponse:
    records: tuple[AppActivityRecord, ...] = field(default_factory=tuple)
    next_page_token: str | None = None
    baseline_change_seq: int | None = None

@dataclass(frozen=True)
class ListAppPackageJobsRequest:
    pass

@dataclass(frozen=True)
class ListAppPackageJobsResponse:
    jobs: tuple[AppPackageJob, ...] = field(default_factory=tuple)
    reason_code: ReasonCode | None = None

@dataclass(frozen=True)
class ListApprovedAppCatalogTargetsRequest:
    pass

@dataclass(frozen=True)
class ListApprovedAppCatalogTargetsResponse:
    targets: tuple[ApprovedAppCatalogTarget, ...] = field(default_factory=tuple)
    reason_code: ReasonCode | None = None
...
@dataclass(frozen=True)
class ListCommittedAppReleasesResponse:
    releases: tuple[CommittedAppRelease, ...] = field(default_factory=tuple)
    reason_code: ReasonCode | None = None
...
class LoadoutEffectiveInputIdentity:
    ...
    recipe_custody: tuple[LoadoutRecipeCustodyReference, ...] = field(default_factory=tuple)
    admitted_features: tuple[str, ...] = field(default_factory=tuple)
    admitted_text_behaviors: tuple[TextBehaviorKind, ...] = field(default_factory=tuple)
...
class LoadoutModelAxis:
    ...
    resolution: LocalCapabilityRequirementResolution | None = None
...
class LocalEnvironmentPlan:
    ...
    candidate_loadout_id: str | None = None
...
class LocalTransferProgressEvent:
    ...
    disposition: LocalTransferDisposition | None = None
    available_actions: tuple[LocalTransferAction, ...] = field(default_factory=tuple)
    related_install_session_id: str | None = None
...
class MachineLoadouts:
    ...
    selection_revisions: Mapping[str, str] = field(default_factory=dict)

@dataclass(frozen=True)
class MarkAppActivityReadRequest:
    activity_id: str | None = None
    displayed_revision: int | None = None

@dataclass(frozen=True)
class MarkAppActivityReadResponse:
    record: AppActivityRecord | None = None
...
@dataclass(frozen=True)
class OpenAppActivityResponse:
    open_request_id: str | None = None
    result: AppActivityOpenResult | None = None
...
@dataclass(frozen=True)
class OpenVideoSessionRequest:
    reference_image_artifact_id: str | None = None
    format: AiVideoSessionFormat | None = None

@dataclass(frozen=True)
class OpenVideoSessionResponse:
    video_session_id: str | None = None
    generation: int | None = None
    format: AiVideoSessionFormat | None = None
    maximum_in_flight_submissions: int | None = None
...
@dataclass(frozen=True)
class PrepareInstalledAppLaunchRequest:
    launch_selector: bytes | None = None

@dataclass(frozen=True)
class PrepareInstalledAppLaunchResponse:
    launch_id: bytes | None = None
    app_id: str | None = None
    version: str | None = None
    ...
    executable_sha256: bytes | None = None
    execution_profile_ref: str | None = None
    bind_deadline: str | None = None
    reason_code: ReasonCode | None = None
...
class PrepareLoadoutRequest:
    ...
    display_name: str | None = None
    provenance: Mapping[str, object] | None = None
    expected_loadout_revision: str | None = None
...
@dataclass(frozen=True)
class PrepareLocalAppPackageResponse:
    preview: LocalAppPackagePreview | None = None
    reason_code: ReasonCode | None = None
...
@dataclass(frozen=True)
class ReadVideoSessionResultRequest:
    video_session_id: str | None = None
    generation: int | None = None

@dataclass(frozen=True)
class ReadVideoSessionResultResponse:
    result: AiVideoSessionResult | None = None
...
class ReasoningConfig:
    ...
    presentation: ReasoningPresentation | None = None

@dataclass(frozen=True)
class ReasoningContinuityCarrier:
    kind: str | None = None
    version: int | None = None
...
@dataclass(frozen=True)
class ReplaceProductControlDataRootRequest:
...
@dataclass(frozen=True)
class ResolveAppActivityOpenLaunchRequest:
    open_request_id: str | None = None

@dataclass(frozen=True)
class ResolveAppActivityOpenLaunchResponse:
    source_class: AppActivityOpenLaunchSourceClass | None = None
    launch_selector: bytes | None = None
    app_id: str | None = None
...
@dataclass(frozen=True)
class RevealLocalAppAssetRequest:
    relative_path: str | None = None

@dataclass(frozen=True)
class RevealLocalAppAssetResponse:
    asset: LocalAppAssetRecord | None = None
...
class ScenarioStreamDelta:
    ...
    text_output_item: TextOutputItemDelta | None = None
...
class SelectLoadoutRequest:
    ...
    loadout_id: str | None = None
    confirmed_machine_impact: bool | None = None
    expected_selection_revision: str | None = None
    expected_candidate_revision: str | None = None
    expect_no_prior_selection: bool | None = None
...
@dataclass(frozen=True)
class StartAppPackageInstallRequest:
    approved_target_selector: bytes | None = None

@dataclass(frozen=True)
class StartAppPackageInstallResponse:
    job: AppPackageJob | None = None
    reason_code: ReasonCode | None = None

@dataclass(frozen=True)
class StartAppPackageUninstallRequest:
    launch_selector: bytes | None = None

@dataclass(frozen=True)
class StartAppPackageUninstallResponse:
    job: AppPackageJob | None = None
    reason_code: ReasonCode | None = None

@dataclass(frozen=True)
class StartAppPackageUpdateRequest:
    approved_target_selector: bytes | None = None
    launch_selector: bytes | None = None
    installed_version: str | None = None

@dataclass(frozen=True)
class StartAppPackageUpdateResponse:
    job: AppPackageJob | None = None
    reason_code: ReasonCode | None = None
...
@dataclass(frozen=True)
class StartLocalAppPackageInstallResponse:
    job: AppPackageJob | None = None
    reason_code: ReasonCode | None = None

@dataclass(frozen=True)
class StartLocalAppPackageUpdateRequest:
    candidate_selector: bytes | None = None
    launch_selector: bytes | None = None
    installed_version: str | None = None

@dataclass(frozen=True)
class StartLocalAppPackageUpdateResponse:
    job: AppPackageJob | None = None
    reason_code: ReasonCode | None = None
...
@dataclass(frozen=True)
class StartProductControlCheckSyncRequest:
    pass
...
@dataclass(frozen=True)
class SubmitVideoSessionFrameRequest:
    video_session_id: str | None = None
    generation: int | None = None
    sequence: int | None = None
    timestamp_us: int | None = None
...
@dataclass(frozen=True)
class SubmitVideoSessionFrameResponse:
    accepted: bool | None = None
    sequence: int | None = None
...
@dataclass(frozen=True)
class SubscribeAppActivityChangesRequest:
    after_change_seq: int | None = None

@dataclass(frozen=True)
class SubscribeAppActivityChangesResponse:
    change_seq: int | None = None
    kind: AppActivityChangeKind | None = None
    activity_id: str | None = None
    record: AppActivityRecord | None = None

@dataclass(frozen=True)
class SubscribeAppActivityOpenRequestsRequest:
    pass

@dataclass(frozen=True)
class SubscribeAppActivityOpenRequestsResponse:
    delivery_id: str | None = None
    activity_id: str | None = None
    object_ref: str | None = None
    activity_type: str | None = None
...
class TextBehaviorCapabilityProjection:
    kind: TextBehaviorKind | None = None
    implementation_supported: bool | None = None
    configuration_state: TextBehaviorConfigurationState | None = None
    reasons: tuple[LocalCapabilityReason, ...] = field(default_factory=tuple)
    implementation_tool_use: ToolUseCapabilityProjection | None = None
    configured_tool_use: ToolUseCapabilityProjection | None = None

@dataclass(frozen=True)
class TextDecideScenarioSpec:
    state: TextDecisionContent | None = None
    questions: tuple[TextDecisionQuestion, ...] = field(default_factory=tuple)

@dataclass(frozen=True)
class TextDecisionAnswer:
    question_id: str | None = None
    choice: TextDecisionChoiceAnswer | None = None
    boolean: TextDecisionBooleanAnswer | None = None

@dataclass(frozen=True)
class TextDecisionBoolean:
    true_criterion: TextDecisionContent | None = None
    false_criterion: TextDecisionContent | None = None

@dataclass(frozen=True)
class TextDecisionBooleanAnswer:
    true_probability: float | None = None

@dataclass(frozen=True)
class TextDecisionCandidate:
    id: str | None = None
    description: TextDecisionContent | None = None

@dataclass(frozen=True)
class TextDecisionCandidateProbability:
    candidate_id: str | None = None
    probability: float | None = None

@dataclass(frozen=True)
class TextDecisionChoice:
    candidates: tuple[TextDecisionCandidate, ...] = field(default_factory=tuple)

@dataclass(frozen=True)
class TextDecisionChoiceAnswer:
    selected_candidate_id: str | None = None
    probabilities: tuple[TextDecisionCandidateProbability, ...] = field(default_factory=tuple)

@dataclass(frozen=True)
class TextDecisionContent:
    text: str | None = None
    json: str | None = None

@dataclass(frozen=True)
class TextDecisionQuestion:
    id: str | None = None
    instructions: TextDecisionContent | None = None
    choice: TextDecisionChoice | None = None
    boolean: TextDecisionBoolean | None = None

@dataclass(frozen=True)
class TextDecisionResult:
    answers: tuple[TextDecisionAnswer, ...] = field(default_factory=tuple)
...
class TextOutputItem:
    text: TextOutputText | None = None
    reasoning_summary: ReasoningSummary | None = None
    tool_call: ToolCall | None = None
    reasoning_continuity: ReasoningContinuityCarrier | None = None

@dataclass(frozen=True)
class TextOutputItemDelta:
    item_index: int | None = None
    text: TextOutputTextDelta | None = None
    reasoning_summary: ReasoningSummaryDelta | None = None
    tool_call: ToolCall | None = None
    reasoning_continuity: ReasoningContinuityCarrier | None = None
    item_completed: bool | None = None

@dataclass(frozen=True)
class TextOutputText:
    text: str | None = None
...
@dataclass(frozen=True)
class TextTurnItem:
    output: TextOutputItem | None = None
...
@dataclass(frozen=True)
class ToolUseCapabilityProjection:
    supported_tool_spec_kinds: tuple[ToolSpecKind, ...] = field(default_factory=tuple)
    supported_tool_choice_modes: tuple[ToolChoiceMode, ...] = field(default_factory=tuple)
    supports_single_call: bool | None = None
    supports_multiple_calls: bool | None = None
    supports_parallel_calls: bool | None = None
    supports_sync: bool | None = None
    supports_stream: bool | None = None
    supports_tool_only_response: bool | None = None
    supports_tool_result_round_trip: bool | None = None
    supports_mixed_text_and_tool_calls: bool | None = None
...
@dataclass(frozen=True)
class VideoFaceSwapResult:
    artifacts: tuple[ScenarioArtifact, ...] = field(default_factory=tuple)
    summary: VideoFaceSwapSummary | None = None

@dataclass(frozen=True)
class VideoFaceSwapScenarioSpec:
    reference_image_artifact_id: str | None = None
    target_video_artifact_id: str | None = None
    no_face_policy: FaceSwapNoFacePolicy | None = None

@dataclass(frozen=True)
class VideoFaceSwapSummary:
    total_frames: int | None = None
    transformed_frames: int | None = None
    preserved_frames: int | None = None
...
class VisionLocateResult:
    ...
    width: int | None = None
    height: int | None = None
    locations: tuple[VisionLocation, ...] = field(default_factory=tuple)

@dataclass(frozen=True)
class VisionLocateScenarioSpec:
    image_artifact_id: str | None = None
    query: str | None = None
    geometry: VisionLocateGeometry | None = None

@dataclass(frozen=True)
class VisionLocation:
    label: str | None = None
    box: VisionLocateBox | None = None
    point: VisionLocatePoint | None = None
...
class RuntimeTypedClient:
    ...
    async def list_local_app_shared_local_agent_aiconfig_options(self, request: ListLocalAppSharedLocalAgentAIConfigOptionsRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ListLocalAppSharedLocalAgentAIConfigOptionsResponse:
        ...
        return _decode_model(ListLocalAppSharedLocalAgentAIConfigOptionsResponse, raw)
    ...
    async def list_shared_local_agent_aiconfig_options(self, request: ListSharedLocalAgentAIConfigOptionsRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ListSharedLocalAgentAIConfigOptionsResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAgentService/ListSharedLocalAgentAIConfigOptions", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ListSharedLocalAgentAIConfigOptionsResponse, raw)
    ...
    async def list_app_aiconfig_options(self, request: ListAppAIConfigOptionsRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ListAppAIConfigOptionsResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAiService/ListAppAIConfigOptions", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ListAppAIConfigOptionsResponse, raw)
    ...
    async def close_video_session(self, request: CloseVideoSessionRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> CloseVideoSessionResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAiVideoSessionService/CloseVideoSession", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(CloseVideoSessionResponse, raw)

    async def open_video_session(self, request: OpenVideoSessionRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> OpenVideoSessionResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAiVideoSessionService/OpenVideoSession", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(OpenVideoSessionResponse, raw)

    async def read_video_session_result(self, request: ReadVideoSessionResultRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ReadVideoSessionResultResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAiVideoSessionService/ReadVideoSessionResult", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ReadVideoSessionResultResponse, raw)

    async def submit_video_session_frame(self, request: SubmitVideoSessionFrameRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> SubmitVideoSessionFrameResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAiVideoSessionService/SubmitVideoSessionFrame", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(SubmitVideoSessionFrameResponse, raw)

    async def complete_app_activity_open_request(self, request: CompleteAppActivityOpenRequestRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> CompleteAppActivityOpenRequestResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppActivityService/CompleteAppActivityOpenRequest", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(CompleteAppActivityOpenRequestResponse, raw)

    async def list_app_activities(self, request: ListAppActivitiesRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ListAppActivitiesResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppActivityService/ListAppActivities", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ListAppActivitiesResponse, raw)

    async def mark_app_activity_read(self, request: MarkAppActivityReadRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> MarkAppActivityReadResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppActivityService/MarkAppActivityRead", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(MarkAppActivityReadResponse, raw)

    def open_app_activity(self, request: OpenAppActivityRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> AsyncIterator[OpenAppActivityResponse]:
        return self._stream("/nimi.runtime.v1.RuntimeAppActivityService/OpenAppActivity", _model_body(request), OpenAppActivityResponse, metadata=metadata, timeout_ms=timeout_ms)

    async def put_app_activity(self, request: PutAppActivityRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> PutAppActivityResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppActivityService/PutAppActivity", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(PutAppActivityResponse, raw)

    async def resolve_app_activity_open_launch(self, request: ResolveAppActivityOpenLaunchRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ResolveAppActivityOpenLaunchResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppActivityService/ResolveAppActivityOpenLaunch", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ResolveAppActivityOpenLaunchResponse, raw)

    def subscribe_app_activity_changes(self, request: SubscribeAppActivityChangesRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> AsyncIterator[SubscribeAppActivityChangesResponse]:
        return self._stream("/nimi.runtime.v1.RuntimeAppActivityService/SubscribeAppActivityChanges", _model_body(request), SubscribeAppActivityChangesResponse, metadata=metadata, timeout_ms=timeout_ms)

    def subscribe_app_activity_open_requests(self, request: SubscribeAppActivityOpenRequestsRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> AsyncIterator[SubscribeAppActivityOpenRequestsResponse]:
        return self._stream("/nimi.runtime.v1.RuntimeAppActivityService/SubscribeAppActivityOpenRequests", _model_body(request), SubscribeAppActivityOpenRequestsResponse, metadata=metadata, timeout_ms=timeout_ms)

    async def cancel_app_package_job(self, request: CancelAppPackageJobRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> CancelAppPackageJobResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/CancelAppPackageJob", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(CancelAppPackageJobResponse, raw)

    async def discard_local_app_package(self, request: DiscardLocalAppPackageRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> DiscardLocalAppPackageResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/DiscardLocalAppPackage", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(DiscardLocalAppPackageResponse, raw)

    async def get_app_package_info(self, request: GetAppPackageInfoRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> GetAppPackageInfoResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/GetAppPackageInfo", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(GetAppPackageInfoResponse, raw)

    async def get_app_package_job(self, request: GetAppPackageJobRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> GetAppPackageJobResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/GetAppPackageJob", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(GetAppPackageJobResponse, raw)

    async def list_app_package_jobs(self, request: ListAppPackageJobsRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ListAppPackageJobsResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/ListAppPackageJobs", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ListAppPackageJobsResponse, raw)

    async def list_approved_app_catalog_targets(self, request: ListApprovedAppCatalogTargetsRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ListApprovedAppCatalogTargetsResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/ListApprovedAppCatalogTargets", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ListApprovedAppCatalogTargetsResponse, raw)
    ...
    async def prepare_local_app_package(self, request: PrepareLocalAppPackageRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> PrepareLocalAppPackageResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/PrepareLocalAppPackage", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(PrepareLocalAppPackageResponse, raw)
    ...
    async def start_app_package_install(self, request: StartAppPackageInstallRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> StartAppPackageInstallResponse:
        ...
        return _decode_model(StartAppPackageInstallResponse, raw)

    async def start_app_package_uninstall(self, request: StartAppPackageUninstallRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> StartAppPackageUninstallResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/StartAppPackageUninstall", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(StartAppPackageUninstallResponse, raw)

    async def start_app_package_update(self, request: StartAppPackageUpdateRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> StartAppPackageUpdateResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/StartAppPackageUpdate", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(StartAppPackageUpdateResponse, raw)

    async def start_local_app_package_install(self, request: StartLocalAppPackageInstallRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> StartLocalAppPackageInstallResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/StartLocalAppPackageInstall", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(StartLocalAppPackageInstallResponse, raw)

    async def start_local_app_package_update(self, request: StartLocalAppPackageUpdateRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> StartLocalAppPackageUpdateResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppPackageService/StartLocalAppPackageUpdate", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(StartLocalAppPackageUpdateResponse, raw)
    ...
    async def complete_app_package_uninstall(self, request: CompleteAppPackageUninstallRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> CompleteAppPackageUninstallResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppService/CompleteAppPackageUninstall", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(CompleteAppPackageUninstallResponse, raw)

    async def end_installed_app_run(self, request: EndInstalledAppRunRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> EndInstalledAppRunResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppService/EndInstalledAppRun", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(EndInstalledAppRunResponse, raw)
    ...
    async def prepare_installed_app_launch(self, request: PrepareInstalledAppLaunchRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> PrepareInstalledAppLaunchResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppService/PrepareInstalledAppLaunch", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(PrepareInstalledAppLaunchResponse, raw)
    ...
    async def reveal_local_app_asset(self, request: RevealLocalAppAssetRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> RevealLocalAppAssetResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeAppService/RevealLocalAppAsset", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(RevealLocalAppAssetResponse, raw)
    ...
    async def get_product_control_check_sync(self, request: GetProductControlCheckSyncRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> CheckSyncProjectionJson:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeLocalService/GetProductControlCheckSync", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(CheckSyncProjectionJson, raw)
    ...
    async def initialize_product_control_root_activation(self, request: InitializeProductControlRootActivationRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ProductControlProjectionJson:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeLocalService/InitializeProductControlRootActivation", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ProductControlProjectionJson, raw)
    ...
    async def replace_product_control_data_root(self, request: ReplaceProductControlDataRootRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ProductControlProjectionJson:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeLocalService/ReplaceProductControlDataRoot", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ProductControlProjectionJson, raw)
    ...
    async def start_product_control_check_sync(self, request: StartProductControlCheckSyncRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> CheckSyncProjectionJson:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeLocalService/StartProductControlCheckSync", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(CheckSyncProjectionJson, raw)
