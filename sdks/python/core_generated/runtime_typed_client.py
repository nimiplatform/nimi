...
ConnectorGrantStatus = Literal["CONNECTOR_GRANT_STATUS_UNSPECIFIED", "CONNECTOR_GRANT_STATUS_ACTIVE", "CONNECTOR_GRANT_STATUS_REVOKED"]
...
@dataclass(frozen=True)
class ClearLocalCapabilitySelectionRequest:
    capability_contract: str | None = None

@dataclass(frozen=True)
class ClearLocalCapabilitySelectionResponse:
    pass
...
class ConnectorGrant:
    ...
    connector_id: str | None = None
    account_id: str | None = None
    status: ConnectorGrantStatus | None = None
    created_at: str | None = None
...
@dataclass(frozen=True)
class CreateConnectorGrantRequest:
    connector_id: str | None = None

@dataclass(frozen=True)
class CreateConnectorGrantResponse:
...
@dataclass(frozen=True)
class DeleteLocalCapabilityConfigurationRequest:
    configuration_id: str | None = None

@dataclass(frozen=True)
class DeleteLocalCapabilityConfigurationResponse:
    pass
...
@dataclass(frozen=True)
class ListConnectorGrantsRequest:
    page_size: int | None = None
    page_token: str | None = None

@dataclass(frozen=True)
class ListConnectorGrantsResponse:
    grants: tuple[ConnectorGrant, ...] = field(default_factory=tuple)
    next_page_token: str | None = None
...
@dataclass(frozen=True)
class RevokeConnectorGrantRequest:
    grant_id: str | None = None

@dataclass(frozen=True)
class RevokeConnectorGrantResponse:
    grant: ConnectorGrant | None = None
...
@dataclass(frozen=True)
class SelectLocalCapabilityConfigurationRequest:
    capability_contract: str | None = None
    configuration_id: str | None = None

@dataclass(frozen=True)
class SelectLocalCapabilityConfigurationResponse:
    selection: LocalCapabilitySelection | None = None
...
class RuntimeTypedClient:
    ...
    async def create_connector_grant(self, request: CreateConnectorGrantRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> CreateConnectorGrantResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeConnectorService/CreateConnectorGrant", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(CreateConnectorGrantResponse, raw)
    ...
    async def list_connector_grants(self, request: ListConnectorGrantsRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ListConnectorGrantsResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeConnectorService/ListConnectorGrants", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ListConnectorGrantsResponse, raw)
    ...
    async def revoke_connector_grant(self, request: RevokeConnectorGrantRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> RevokeConnectorGrantResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeConnectorService/RevokeConnectorGrant", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(RevokeConnectorGrantResponse, raw)
    ...
    async def clear_local_capability_selection(self, request: ClearLocalCapabilitySelectionRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> ClearLocalCapabilitySelectionResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeLocalService/ClearLocalCapabilitySelection", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(ClearLocalCapabilitySelectionResponse, raw)
    ...
    async def delete_local_capability_configuration(self, request: DeleteLocalCapabilityConfigurationRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> DeleteLocalCapabilityConfigurationResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeLocalService/DeleteLocalCapabilityConfiguration", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(DeleteLocalCapabilityConfigurationResponse, raw)
    ...
    async def select_local_capability_configuration(self, request: SelectLocalCapabilityConfigurationRequest, *, metadata: Mapping[str, str] | None = None, timeout_ms: int | None = None) -> SelectLocalCapabilityConfigurationResponse:
        raw: object = await self._core.unary(CoreUnaryRequest(method_id="/nimi.runtime.v1.RuntimeLocalService/SelectLocalCapabilityConfiguration", body=_model_body(request), metadata=metadata, timeout_ms=timeout_ms))
        return _decode_model(SelectLocalCapabilityConfigurationResponse, raw)
