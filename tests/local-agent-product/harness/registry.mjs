...
export const acceptanceCatalogPath = path.join(repoRoot, 'config', 'local-agent-product-acceptance-points.yaml');
...
export function readAcceptanceCatalog(filePath = acceptanceCatalogPath) {
