...
const source = fs.readFileSync(path.join(import.meta.dirname, 'run-dev-kernel-carrier-preflight.mjs'), 'utf8');

test('protected-carrier preflight binds fixed-service identity to the focused authority assertions', () => {
  for (const name of [
