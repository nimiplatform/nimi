...
const devKernelCheckpointPrerequisites = [
  ...
  ['remembered-project-admitted', ['process-mismatch-denied']],
  ['remembered-authority-boundary', ['remembered-project-admitted']],
  ['edit-build-process-replaced', ['remembered-authority-boundary']],
  ['app-private-storage-after-process-replacement', ['edit-build-process-replaced']],
  ['mode-off-dormant', ['app-private-storage-after-process-replacement']],
