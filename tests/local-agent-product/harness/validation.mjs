...
const devKernelCheckpointPrerequisites = [
  ...
  ['local-app-session-bound', ['run-once-project-admitted']],
  ['app-private-storage-base-entitlement', ['local-app-session-bound']],
  ['reserved-permission-unavailable', ['local-app-session-bound']],
  ['reserved-permission-request-denied', ['reserved-permission-unavailable']],
  ['process-mismatch-denied', ['app-private-storage-base-entitlement', 'reserved-permission-request-denied']],
  ['allow-project-admitted', ['process-mismatch-denied']],
  ['allow-project-authority-boundary', ['allow-project-admitted']],
  ['edit-build-process-replaced', ['allow-project-authority-boundary']],
  ['app-private-storage-after-process-replacement', ['edit-build-process-replaced']],
  ['mode-off-live-authority-revoked', ['app-private-storage-after-process-replacement']],
  ['allow-project-reused-after-mode-reenable', ['mode-off-live-authority-revoked']],
  ['fixed-service-restarted', ['allow-project-reused-after-mode-reenable']],
  ['app-private-storage-after-runtime-restart', ['fixed-service-restarted']],
  ['account-switch-invalidated', ['app-private-storage-after-runtime-restart']],
  ['project-revoked-session-invalidated', ['account-switch-invalidated']],
  ['desktop-real-shell-acceptance', ['project-revoked-session-invalidated']],
  ['zhiyu-real-shell-acceptance', ['project-revoked-session-invalidated']],
