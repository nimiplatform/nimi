...
| `relay:local:assets:verified` | unary | local | `runtime.local.listVerifiedAssets` | RL-IPC-011 |
| `relay:local:assets:catalog-search` | unary | local | `runtime.local.searchCatalogModels` | RL-IPC-011 |
| `relay:local:assets:install-plan` | unary | local | `runtime.local.resolveModelInstallPlan` | RL-IPC-011 |
| `relay:local:assets:install` | unary | local | `runtime.local.installVerifiedAsset` | RL-IPC-011 |
| `relay:local:assets:install-verified` | unary | local | `runtime.local.installVerifiedAsset` | RL-IPC-011 |
| `relay:local:assets:import` | unary | local | `runtime.local.importLocalAsset` | RL-IPC-011 |
| `relay:local:assets:remove` | unary | local | `runtime.local.removeLocalAsset` | RL-IPC-011 |
| `relay:local:assets:start` | unary | local | `runtime.local.startLocalAsset` | RL-IPC-011 |
| `relay:local:assets:stop` | unary | local | `runtime.local.stopLocalAsset` | RL-IPC-011 |
| `relay:local:assets:health` | unary | local | `runtime.local.checkLocalAssetHealth` | RL-IPC-011 |
| `relay:local:assets:warm` | unary | local | `runtime.local.warmLocalAsset` | RL-IPC-011 |
