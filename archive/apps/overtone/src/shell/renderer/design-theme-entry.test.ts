...
describe('overtone design theme entry contract', () => {
  it('uses the shared Nimi theme provider with the overtone accent pack', () => {
    expect(mainSource).toMatch(/@nimiplatform\/kit\/ui/);
  ...
  it('imports the shared foundation and overtone accent styles', () => {
    expect(stylesSource).toMatch(/@nimiplatform\/kit\/ui\/styles\.css/);
    expect(stylesSource).toMatch(/@nimiplatform\/kit\/ui\/themes\/light\.css/);
    expect(stylesSource).toMatch(/@nimiplatform\/kit\/ui\/themes\/dark\.css/);
    expect(stylesSource).toMatch(/@nimiplatform\/kit\/ui\/themes\/overtone-accent\.css/);
