...
export const SIMULATOR_PRODUCT_FLOWS: Readonly<Record<string, SimulatorProductFlowDefinition>> = Object.freeze({
  'world.pin': Object.freeze({
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ type: 'directive', name: 'notice', moduleId: 'lab', text: '世界巡游观察到一条新足迹 · 回声谷' } as const),
      Object.freeze({ type: 'directive', name: 'toast', title: '足迹已提交 · 回声谷', detail: 'Desktop → 生态共享 · Lab 的世界巡游可见' } as const),
  ...
  'handoff.zhiyu': Object.freeze({
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ type: 'directive', name: 'toast', title: '已交接 · 回声谷 → 织羽', detail: '意图已翻译为织羽的实例路由状态' } as const),
  ...
  'local-agent.project': Object.freeze({
    ...
    steps: Object.freeze([
      ...
      Object.freeze({ type: 'directive', name: 'focus-app', moduleId: 'zhiyu' } as const),
      Object.freeze({ type: 'directive', name: 'toast', title: '摘要已投递 · Nimi → 织羽', detail: '只读投影 · 不含任何写权限' } as const),
