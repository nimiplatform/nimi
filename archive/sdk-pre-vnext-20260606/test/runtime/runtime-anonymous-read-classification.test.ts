...
test('RuntimeAnonymousReadMethodIds set has exactly 147 members (current spec shard size)', () => {
  ...
  assert.equal(distinct.size, 147, 'classifier set must contain exactly 147 method ids');
});
