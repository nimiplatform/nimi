export const RuntimeMethodIds = {
  ...
  externalAgent: {
    getGatewayStatus: '/nimi.runtime.v1.RuntimeExternalAgentService/GetExternalAgentGatewayStatus',
    issueToken: '/nimi.runtime.v1.RuntimeExternalAgentService/IssueExternalAgentToken',
    revokeToken: '/nimi.runtime.v1.RuntimeExternalAgentService/RevokeExternalAgentToken',
    listTokens: '/nimi.runtime.v1.RuntimeExternalAgentService/ListExternalAgentTokens',
  },
  account: {
  ...
  local: {
    ...
    listCatalogVariants: '/nimi.runtime.v1.RuntimeLocalService/ListCatalogVariants',
    getRecommendationFeed: '/nimi.runtime.v1.RuntimeLocalService/GetRecommendationFeed',
    resolveModelInstallPlan: '/nimi.runtime.v1.RuntimeLocalService/ResolveModelInstallPlan',
    installModelFromPlan: '/nimi.runtime.v1.RuntimeLocalService/InstallModelFromPlan',
    ...
    importLocalAssetBundle: '/nimi.runtime.v1.RuntimeLocalService/ImportLocalAssetBundle',
    rescanLocalAssetBundle: '/nimi.runtime.v1.RuntimeLocalService/RescanLocalAssetBundle',
    ...
    prepareProfileRuntimeDescriptor: '/nimi.runtime.v1.RuntimeLocalService/PrepareProfileRuntimeDescriptor',
    ...
    mintRuntimeBaselineReadiness: '/nimi.runtime.v1.RuntimeLocalService/MintRuntimeBaselineReadiness',
    resolveRuntimeBaselineReadiness: '/nimi.runtime.v1.RuntimeLocalService/ResolveRuntimeBaselineReadiness',
    mintFirstRunExecutionEvidence: '/nimi.runtime.v1.RuntimeLocalService/MintFirstRunExecutionEvidence',
    resolveFirstRunExecutionEvidence: '/nimi.runtime.v1.RuntimeLocalService/ResolveFirstRunExecutionEvidence',
    ...
    getProductControlRecord: '/nimi.runtime.v1.RuntimeLocalService/GetProductControlRecord',
    getProductControlSelectedDataRoot: '/nimi.runtime.v1.RuntimeLocalService/GetProductControlSelectedDataRoot',
    ensureProductControlRecordCreated: '/nimi.runtime.v1.RuntimeLocalService/EnsureProductControlRecordCreated',
    selectProductControlDataRoot: '/nimi.runtime.v1.RuntimeLocalService/SelectProductControlDataRoot',
    setProductControlFirstRunInstallLevel: '/nimi.runtime.v1.RuntimeLocalService/SetProductControlFirstRunInstallLevel',
    completeProductControlFirstRunDeviceEnvironmentScan: '/nimi.runtime.v1.RuntimeLocalService/CompleteProductControlFirstRunDeviceEnvironmentScan',
    admitProductControlReadyForUse: '/nimi.runtime.v1.RuntimeLocalService/AdmitProductControlReadyForUse',
    recordProductControlAccountDefaultProfileEvidence: '/nimi.runtime.v1.RuntimeLocalService/RecordProductControlAccountDefaultProfileEvidence',
    recordProductControlFirstRunLocalAiReadyEvidence: '/nimi.runtime.v1.RuntimeLocalService/RecordProductControlFirstRunLocalAiReadyEvidence',
    reconcileProductControlFirstRunSetupState: '/nimi.runtime.v1.RuntimeLocalService/ReconcileProductControlFirstRunSetupState',
  ...
  memory: {
    ...
    getMemoryEmbeddingRuntimeIntent: '/nimi.runtime.v1.RuntimeCognitionService/GetMemoryEmbeddingRuntimeIntent',
    setMemoryEmbeddingRuntimeIntent: '/nimi.runtime.v1.RuntimeCognitionService/SetMemoryEmbeddingRuntimeIntent',
  ...
  agent: {
    ...
    getCompanionParticipationProjection: '/nimi.runtime.v1.RuntimeAgentService/GetCompanionParticipationProjection',
    requestCompanionParticipation: '/nimi.runtime.v1.RuntimeAgentService/RequestCompanionParticipation',
    cancelCompanionParticipation: '/nimi.runtime.v1.RuntimeAgentService/CancelCompanionParticipation',
    openCompanionParticipationReplay: '/nimi.runtime.v1.RuntimeAgentService/OpenCompanionParticipationReplay',
    ...
    getAgentCanonicalMemoryBankStatus: '/nimi.runtime.v1.RuntimeAgentService/GetAgentCanonicalMemoryBankStatus',
    requestAgentCanonicalMemoryBankBind: '/nimi.runtime.v1.RuntimeAgentService/RequestAgentCanonicalMemoryBankBind',
  ...
  app: {
    ...
    getAccountAppLibrary: '/nimi.runtime.v1.RuntimeAppService/GetAccountAppLibrary',
...
export const RuntimeWriteMethodIds: readonly string[] = Object.freeze([
  ...
  RuntimeMethodIds.local.prepareProfileRuntimeDescriptor,
