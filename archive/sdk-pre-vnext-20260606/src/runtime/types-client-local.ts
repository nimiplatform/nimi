...
export type RuntimeLocalServiceClient = {
  ...
  prepareProfileRuntimeDescriptor(request: PrepareProfileRuntimeDescriptorRequest, options?: RuntimeCallOptions): Promise<PrepareProfileRuntimeDescriptorResponse>;
