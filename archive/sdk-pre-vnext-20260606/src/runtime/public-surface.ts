// Shared authoritative export surface for @nimiplatform/sdk/runtime and
// @nimiplatform/sdk/runtime/browser. Node-only transport exports belong only in
// runtime/index.ts.

// sdk-runtime-public-surface-group: core-contract
...
// sdk-runtime-public-surface-group: local-runtime
...
// sdk-runtime-public-surface-group: agent-surfaces
export * from './runtime-agent-consumer-helpers.js';
export * from './runtime-agent-timeline-parsers.js';
...
// sdk-runtime-public-surface-group: route-scheduling
...
export * from './runtime-route-core.js';
export * from './runtime-route-binding.js';
export * from './runtime-route-parsers.js';
...
// sdk-runtime-public-surface-group: ai-model-media-contracts
export {
  Modal,
  ScenarioType,
  ExecutionMode,
...
// sdk-runtime-public-surface-group: connector-and-bridge-config
export {
...
// sdk-runtime-public-surface-group: agent-knowledge-memory-contracts
export {
...
// sdk-runtime-public-surface-group: audit-account-auth-contracts
export {
  RuntimeHealthStatus,
  UsageWindow,
...
// sdk-runtime-public-surface-group: workflow-recommendation-assets
...
export {
  ...
  type LocalRuntimeAssetDeclarationLike,
  ...
  type NormalizedLocalRuntimeAssetDeclaration,
...
// sdk-runtime-public-surface-group: runtime-client-codecs
...
// sdk-runtime-public-surface-group: runtime-extension-modules
export {
  fetchRealmGrant,
