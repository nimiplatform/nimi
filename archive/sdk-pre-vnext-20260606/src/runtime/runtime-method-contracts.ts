...
export type RuntimeUnaryMethodContractMap = {
  ...
  [RuntimeMethodIds.local.getRecommendationFeed]: RuntimeClientMethodContract<'local', 'getRecommendationFeed'>;
  ...
  [RuntimeMethodIds.local.prepareProfileRuntimeDescriptor]: RuntimeClientMethodContract<'local', 'prepareProfileRuntimeDescriptor'>;
  ...
  [RuntimeMethodIds.agent.listAgentConversationSummaries]: RuntimeClientMethodContract<'agent', 'listAgentConversationSummaries'>;
