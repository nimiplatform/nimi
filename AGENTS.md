...
- For UI/UX changes also read: `DESIGN.md`, `kit/DESIGN.md`, `kit/design_tokens.json`, `kit/design-projection.json`, `kit/tailwind-theme.css`, `kit/README.md`, `.nimi/spec/platform/kernel/tables/nimi-ui-*.yaml`, `.nimi/spec/platform/kernel/tables/nimi-kit-registry.yaml`.
