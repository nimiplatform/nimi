...
export const TAG_TO_SERVICE = Object.freeze({
  ...
  Me2fa: 'Me2FaService',
  Media: 'MediaService',
  'Narrative Spine': 'NarrativeSpineService',
  Notification: 'NotificationService',
  Post: 'PostService',
  'Relationships (Meta-Graph)': 'RelationshipsMetaGraphService',
  'Reviews (Economy/Trust)': 'ReviewsEconomyTrustService',
  'Satellite (Narrative)': 'SatelliteNarrativeService',
  Search: 'SearchService',
  'Social - Four-Dimensional Attributes': 'SocialFourDimensionalAttributesService',
  'Social - V1 Default Visibility': 'SocialV1DefaultVisibilityService',
  'Soul Evolution': 'SoulEvolutionService',
  'TimeGap (Narrative)': 'TimeGapNarrativeService',
