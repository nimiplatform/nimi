...
import { renderTypeHelpersFile } from './render-type-helpers-file.mjs';
...
export function writeOperationArtifacts(repoRoot, operations) {
  ...
  const typeHelpersFile = renderTypeHelpersFile();
  ...
  writeFileSync(path.join(generatedDir, 'type-helpers.ts'), typeHelpersFile, 'utf8');
