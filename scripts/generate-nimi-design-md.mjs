...
function renderRootDesign(frontMatter) {
  ...
  return [
    ...
    '> AUTO-GENERATED by `scripts/generate-nimi-design-md.mjs`. Do not edit directly.',
    '',
    'The compact UI/UX design projection for coding agents is [kit/DESIGN.md](kit/DESIGN.md); it intentionally summarizes rather than enumerates every token and component. The complete machine-readable token and component inventory is [kit/design-projection.json](kit/design-projection.json). Interoperability artifacts live beside it at [kit/design_tokens.json](kit/design_tokens.json) and [kit/tailwind-theme.css](kit/tailwind-theme.css).',
    '',
    ...
    "## Do's and Don'ts",
    '',
    '- Do read `kit/DESIGN.md` for the compact operational summary and `kit/design-projection.json` for the complete token and component inventory.',
