...
const realmServicesDir = path.join(repoRoot, 'sdk', 'packages', 'realm', 'src', 'services');
const outputPath = path.join(repoRoot, 'sdk', 'packages', 'sdk', 'src', 'scope', 'generated', 'catalog.ts');
