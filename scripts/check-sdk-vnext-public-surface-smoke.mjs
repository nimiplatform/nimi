...
const localAppStandardShell: NimiLocalAppStandardShell = {
  ...
  agents: {
    ...
    getIntroduction: unavailableCarrier,
  },
  agentWork: {
    listReferences: unavailableCarrier,
    start: unavailableCarrier,
    get: unavailableCarrier,
  ...
  integration: {
    listCatalog: unavailableCarrier,
    listConnections: unavailableCarrier,
    invoke: unavailableCarrier,
    getCall: unavailableCarrier,
    listCalls: unavailableCarrier,
    cancelCall: unavailableCarrier,
    registerProvider: unavailableCarrier,
    unregisterProvider: unavailableCarrier,
    pollProvider: unavailableCarrier,
    completeProvider: unavailableCarrier,
    getManagement: unavailableCarrier,
    putConnection: unavailableCarrier,
    removeConnection: unavailableCarrier,
    setPermission: unavailableCarrier,
  },
  conversation: {
