...
test('Windows custody binds local-user encryption to the fixed service host and exact restricted service SID', () => {
  ...
  assert.deepEqual(principals.windows_service_host, {
    ...
    process_token_dacl_scope: 'service_sid_full_authority_interactive_token_query_read_control_only',
    process_token_mandatory_label_scope: 'system_integrity_no_write_up_only_token_query_remains_available_for_mutual_verification',
  ...
  assert.deepEqual(principals.windows_principal_selection, {
    ...
    selected_fixture_result: 'elevated_installer_fixture_green_unelevated_process_security_green_token_query_blocked',
