...
const providerCatalogPath = path.join(repoRoot, 'config', 'runtime-provider-catalog.yaml');
const providerCapabilitiesPath = path.join(repoRoot, 'config', 'runtime-provider-capabilities.yaml');
