...
const outDir = path.join(repoRoot, '.nimi', 'spec', 'sdks', 'kernel', 'generated');

const specs = [
  { input: 'sdks-runtime-method-groups.yaml', output: 'runtime-method-groups.md', render: renderMethodGroups },
  { input: 'sdks-error-codes.yaml', output: 'sdk-error-codes.md', render: renderSdkErrorCodes },
  { input: 'sdks-runtime-agent-participation-methods.yaml', output: 'runtime-agent-participation-methods.md', render: renderRuntimeAgentParticipationMethods },
];
