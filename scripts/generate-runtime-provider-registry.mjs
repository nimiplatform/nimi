...
const supplementalProviders = [
  {
    ...
    supports: { text: true, embed: true, image: true, video: true, tts: true, stt: true, music: false, realtime: false, voiceReferenceAudio: false, voiceTextDescription: false },
  },
  {
  ...
  },
  {
    ...
    inventoryMode: 'static_source',
    dynamicInventory: null,
    supports: { text: false, embed: false, image: false, video: false, tts: true, stt: true, music: false, realtime: false, voiceReferenceAudio: false, voiceTextDescription: false },
  },
];
...
function capabilityFlags(sourceDoc) {
  ...
  return { text, embed, image, video, tts, stt, music, realtime, voiceReferenceAudio: false, voiceTextDescription: false };
}
