...
const requiredFiles = [
  ...
  `${kernelRoot}/nimi2d-backend-contract.md`,
  `${kernelRoot}/nimi2d-live-action-bench-contract.md`,
  ...
  `${tablesRoot}/nimi2d-backend-capability-profile.schema.yaml`,
  `${tablesRoot}/nimi2d-live-action-routes.yaml`,
