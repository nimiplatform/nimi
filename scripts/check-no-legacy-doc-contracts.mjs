...
const BANNED_PATTERNS = [
  ...
  { pattern: new RegExp(['NIMI', 'MODS', 'DIR'].join('_')), label: 'deprecated external workspace env alias' },
  { pattern: /desktop\/mods\b(?!-)/, label: 'legacy in-repo mods directory "desktop/mods"' },
  { pattern: new RegExp(`\\.\\.\\/\\.\\.\\/${['nimi', 'mods'].join('-')}`), label: 'legacy relative external workspace path' },
