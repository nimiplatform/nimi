...
export function createRuntimeClient(input: RuntimeClientConfig): RuntimeClient {
  ...
  return {
    ...
    local: {
      listLocalModels: unary(RuntimeMethodIds.local.listLocalModels),
      listLocalArtifacts: unary(RuntimeMethodIds.local.listLocalArtifacts),
      listVerifiedModels: unary(RuntimeMethodIds.local.listVerifiedModels),
      listVerifiedArtifacts: unary(RuntimeMethodIds.local.listVerifiedArtifacts),
      ...
      installLocalModel: unary(RuntimeMethodIds.local.installLocalModel),
      installVerifiedModel: unary(RuntimeMethodIds.local.installVerifiedModel),
      installVerifiedArtifact: unary(RuntimeMethodIds.local.installVerifiedArtifact),
      importLocalModel: unary(RuntimeMethodIds.local.importLocalModel),
      importLocalArtifact: unary(RuntimeMethodIds.local.importLocalArtifact),
      importLocalModelFile: unary(RuntimeMethodIds.local.importLocalModelFile),
      importLocalArtifactFile: unary(RuntimeMethodIds.local.importLocalArtifactFile),
      scanUnregisteredAssets: unary(RuntimeMethodIds.local.scanUnregisteredAssets),
      scaffoldOrphanModel: unary(RuntimeMethodIds.local.scaffoldOrphanModel),
      scaffoldOrphanArtifact: unary(RuntimeMethodIds.local.scaffoldOrphanArtifact),
      ...
      removeLocalModel: unary(RuntimeMethodIds.local.removeLocalModel),
      removeLocalArtifact: unary(RuntimeMethodIds.local.removeLocalArtifact),
      startLocalModel: unary(RuntimeMethodIds.local.startLocalModel),
      stopLocalModel: unary(RuntimeMethodIds.local.stopLocalModel),
      checkLocalModelHealth: unary(RuntimeMethodIds.local.checkLocalModelHealth),
      warmLocalModel: unary(RuntimeMethodIds.local.warmLocalModel),
