...
export function createRuntimeClient(input: RuntimeClientConfig): RuntimeClient {
  ...
  return {
    ...
    local: {
      ...
      resolveLocalRuntimeDependency: unary(RuntimeMethodIds.local.resolveLocalRuntimeDependency),
      startLocalRuntimeDependencySetup: unary(RuntimeMethodIds.local.startLocalRuntimeDependencySetup),
