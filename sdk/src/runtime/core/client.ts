...
export function createRuntimeClient(input: RuntimeClientConfig): RuntimeClient {
  ...
  return {
    ...
    agentCore: {
      initializeAgent: unary(RuntimeMethodIds.agentCore.initializeAgent),
      terminateAgent: unary(RuntimeMethodIds.agentCore.terminateAgent),
      getAgent: unary(RuntimeMethodIds.agentCore.getAgent),
      listAgents: unary(RuntimeMethodIds.agentCore.listAgents),
      getAgentState: unary(RuntimeMethodIds.agentCore.getAgentState),
      updateAgentState: unary(RuntimeMethodIds.agentCore.updateAgentState),
      enableAutonomy: unary(RuntimeMethodIds.agentCore.enableAutonomy),
      disableAutonomy: unary(RuntimeMethodIds.agentCore.disableAutonomy),
      setAutonomyConfig: unary(RuntimeMethodIds.agentCore.setAutonomyConfig),
      listPendingHooks: unary(RuntimeMethodIds.agentCore.listPendingHooks),
      cancelHook: unary(RuntimeMethodIds.agentCore.cancelHook),
      queryMemory: unary(RuntimeMethodIds.agentCore.queryMemory),
      writeMemory: unary(RuntimeMethodIds.agentCore.writeMemory),
      subscribeEvents: stream(RuntimeMethodIds.agentCore.subscribeEvents),
    },
    app: {
