...
export type RealmGeneratedModelMap = {
  ...
  WorldDraftAssetBindingsDraftDto: components['schemas']['WorldDraftAssetBindingsDraftDto'];
  ...
  WorldDraftWorkflowStateDto: components['schemas']['WorldDraftWorkflowStateDto'];
