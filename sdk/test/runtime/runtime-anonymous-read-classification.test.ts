...
test('RuntimeAnonymousReadMethodIds set has exactly 134 members (current spec shard size)', () => {
  ...
  assert.equal(distinct.size, 134, 'classifier set must contain exactly 134 method ids');
});
