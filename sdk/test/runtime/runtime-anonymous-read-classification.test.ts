...
test('RuntimeAnonymousReadMethodIds set has exactly 129 members (current spec shard size)', () => {
  ...
  assert.equal(distinct.size, 129, 'classifier set must contain exactly 129 method ids');
});
