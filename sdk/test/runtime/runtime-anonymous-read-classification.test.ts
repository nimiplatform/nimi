...
test('RuntimeAnonymousReadMethodIds set has exactly 144 members (current spec shard size)', () => {
  ...
  assert.equal(distinct.size, 144, 'classifier set must contain exactly 144 method ids');
});
