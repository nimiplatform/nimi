import { checkResolvedRouteHealth, getHookRuntimeFacade, resolveModRouteBinding, } from '../internal/runtime-access';
...
function routeRuntimePayload(route) {
...
export function createAiClient(modId) {
