import type { RuntimeWireMessage } from '../types';
...
export const RuntimeUnaryMethodCodecs: Record<string, RuntimeUnaryMethodCodec<any, any>> = {
...
export const RuntimeStreamMethodCodecs: Record<string, RuntimeStreamMethodCodec<any, any>> = {
