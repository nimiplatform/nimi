...
| world | loadWorlds, loadWorldDetailById, loadWorldAgents, loadWorldDetailWithAgents, loadWorldSemanticBundle, loadWorldEvents, loadWorldLorebooks, loadWorldMediaBindings, loadMainWorld, loadWorldLevelAudits | World listing, detail, semantic data |
...
| LOCAL_AI_IMPORT_MANIFEST_FILE_NAME_INVALID | local-ai | Only resolved manifest.json files under ~/.nimi/models/**/resolved/** may be imported |
...
| LOCAL_AI_FILE_IMPORT_MANIFEST_WRITE_FAILED | local-ai | Failed to write generated resolved manifest.json to disk |
