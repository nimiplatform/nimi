...
| stability | nimillm | 是 | 是 | explicit_required |
...
2. **Mod Nav**（sidebar puzzle icon）：mods（gated by `enableModUi`）— 点击直接进入 Mods Panel
3. **Detail Tab**：profile、agent-detail、world-detail、notification、privacy-policy、terms-of-service
4. **Embedded Route Alias**：marketplace（gated）— 不再作为独立 sidebar entry，对应 Mods Panel 内部的 Marketplace 视图

Feature flag 门控：
- `enableRuntimeTab` 控制 runtime tab 可见性。
- `enableMarketplaceTab` 控制 Mods Panel 内嵌 Marketplace 视图可用性。
...
- 面板默认展示已启用 mod 的 launcher grid；每个 tile 只显示 icon + name，hover tooltip 展示简介。
- 面板内部必须提供切换到 Marketplace 视图的入口；安装、启用、禁用、卸载、版本信息统一在内嵌 Marketplace 视图中处理。
- `marketplace` tab 仅作为兼容 alias 路由存在；命中时必须重定向或等价渲染为 `Mods Panel > Marketplace` 视图。
...
- `profile` → `ProfileView`
- `runtime` → `RuntimeView`
- `marketplace` → `ModsPanel(initialSection = 'marketplace')`
...
| runtime_mod_uninstall | Uninstall an installed runtime mod |
...
| runtime_local_pick_manifest_path | Pick a local AI model manifest file path under the runtime models root via native file dialog |
...
| runtime_local_dependencies_resolve | Resolve local runtime dependencies for a mod capability |
| runtime_local_device_profile_collect | Collect local device profile (CPU/GPU/NPU/disk/ports) |
| runtime_local_dependencies_apply | Apply resolved local runtime dependency plan |
...
| runtime_local_artifacts_scan_orphans | Scan for orphan companion files not managed by model.manifest.json or artifact.manifest.json |
| runtime_local_artifacts_scaffold_orphan | Scaffold an orphan companion file into artifact.manifest.json with user-selected kind and fixed localai engine |
...
| marketplace | Marketplace | embedded | enableMarketplaceTab |
...
| builtin | event.publish.*, event.subscribe.*, data.query.*, data.register.*, turn.register.*, ui.register.*, inter-mod.request.*, inter-mod.provide.*, runtime.ai.text.generate, runtime.ai.text.stream, runtime.ai.embedding.generate, runtime.media.image.generate, runtime.media.image.stream, runtime.media.video.generate, runtime.media.video.stream, runtime.media.tts.list.voices, runtime.media.tts.synthesize, runtime.media.tts.stream, runtime.media.stt.transcribe, runtime.media.jobs.submit, runtime.media.jobs.get, runtime.media.jobs.cancel, runtime.media.jobs.subscribe, runtime.media.jobs.get.artifacts, runtime.voice.get.asset, runtime.voice.list.assets, runtime.voice.delete.asset, runtime.voice.list.preset.voices, runtime.route.list.options, runtime.route.resolve, runtime.route.check.health, runtime.local.artifacts.list, runtime.profile.read.agent, action.discover.*, action.dry-run.*, action.verify.*, action.commit.*, audit.read.self, meta.read.self, meta.read.all | Default desktop mods loaded via manifest+sideload pipeline |
| injected | event.publish.*, event.subscribe.*, data.query.*, data.register.*, turn.register.pre-model, turn.register.post-state, ui.register.*, inter-mod.request.*, runtime.ai.text.generate, runtime.ai.text.stream, runtime.ai.embedding.generate, runtime.media.image.generate, runtime.media.image.stream, runtime.media.video.generate, runtime.media.video.stream, runtime.media.tts.list.voices, runtime.media.tts.synthesize, runtime.media.tts.stream, runtime.media.stt.transcribe, runtime.media.jobs.submit, runtime.media.jobs.get, runtime.media.jobs.cancel, runtime.media.jobs.subscribe, runtime.media.jobs.get.artifacts, runtime.voice.get.asset, runtime.voice.list.assets, runtime.voice.delete.asset, runtime.voice.list.preset.voices, runtime.route.list.options, runtime.route.resolve, runtime.route.check.health, runtime.local.artifacts.list, runtime.profile.read.agent, action.discover.*, action.dry-run.*, action.verify.*, action.commit.*, audit.read.self, meta.read.self | Third-party injected mods with restricted turn hook access |
| sideload | event.publish.*, data.query.*, ui.register.*, inter-mod.request.*, runtime.ai.text.generate, runtime.ai.text.stream, runtime.ai.embedding.generate, runtime.media.image.generate, runtime.media.image.stream, runtime.media.video.generate, runtime.media.video.stream, runtime.media.tts.list.voices, runtime.media.tts.synthesize, runtime.media.tts.stream, runtime.media.stt.transcribe, runtime.media.jobs.submit, runtime.media.jobs.get, runtime.media.jobs.cancel, runtime.media.jobs.subscribe, runtime.media.jobs.get.artifacts, runtime.voice.get.asset, runtime.voice.list.assets, runtime.voice.delete.asset, runtime.voice.list.preset.voices, runtime.route.list.options, runtime.route.resolve, runtime.route.check.health, runtime.local.artifacts.list, runtime.profile.read.agent, action.discover.*, action.dry-run.*, action.verify.*, action.commit.*, audit.read.self, meta.read.self | Locally sideloaded mods with no subscribe/register/provide access |
...
| enableMarketplaceTab | true | false | Enable Marketplace view inside Mods panel and marketplace route alias |
...
| LOCAL_AI_IMPORT_ARTIFACT_MANIFEST_FILE_NAME_INVALID | local-ai | Only artifact.manifest.json files may be imported |
| LOCAL_AI_ARTIFACT_ORPHAN_NOT_FOUND | local-ai | Selected companion orphan file does not exist |
| LOCAL_AI_ARTIFACT_ORPHAN_KIND_INVALID | local-ai | Companion orphan kind is invalid or unsupported |
| LOCAL_AI_ARTIFACT_ORPHAN_TARGET_EXISTS | local-ai | Target artifact directory or payload file already exists |
| LOCAL_AI_ARTIFACT_ORPHAN_DIR_FAILED | local-ai | Cannot create companion artifact directory |
| LOCAL_AI_ARTIFACT_ORPHAN_MOVE_FAILED | local-ai | Cannot move or copy companion artifact payload into runtime models root |
| LOCAL_AI_ARTIFACT_ORPHAN_SOURCE_CLEANUP_FAILED | local-ai | Source companion payload cleanup failed after copy fallback |
| LOCAL_AI_ARTIFACT_ORPHAN_MANIFEST_SERIALIZE_FAILED | local-ai | Failed to serialize generated companion artifact manifest JSON |
| LOCAL_AI_ARTIFACT_ORPHAN_MANIFEST_WRITE_FAILED | local-ai | Failed to write generated artifact.manifest.json to disk |
...
| LOCAL_AI_FILE_IMPORT_MANIFEST_SERIALIZE_FAILED | local-ai | Failed to serialize generated model manifest JSON |
| LOCAL_AI_FILE_IMPORT_MANIFEST_WRITE_FAILED | local-ai | Failed to write generated model.manifest.json to disk |
