...
- 应用层 Runtime 能力：AI 推理（StreamGenerate、SynthesizeSpeechStream）、Connector 管理（CreateConnector、ListConnectors 等）、Auth/Grant（RegisterApp、OpenSession 等）、媒体任务（SubmitMediaJob 等）
