...
- internal strategy outputs 例如 `deliveryStyle`、`relationshipBoundaryPreset`、`allowMultiReply`、`contentBoundary` 只能存在于 resolved policy，不得伪装成用户设置
...
- delivery policy（例如 compact vs natural、多 beat 是否允许）
