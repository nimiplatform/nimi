...
- `spec/desktop/kernel/ai-profile-config-contract.md` — D-AIPC-001~012
- `spec/platform/kernel/ai-scope-contract.md` — P-AISC-001~005
- `spec/runtime/kernel/ai-profile-execution-contract.md` — K-AIEXEC-001~005
- `spec/runtime/kernel/scheduling-contract.md` — K-SCHED-001~007
- `spec/sdk/kernel/runtime-route-contract.md` — S-RUNTIME-074~078
- `spec/sdk/kernel/surface-contract.md` — S-SURFACE-001~011
