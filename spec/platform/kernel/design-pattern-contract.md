...
- Cross-app design authority must live in `spec/platform/kernel/design-pattern-contract.md` and the structured fact sources under `spec/platform/kernel/tables/`.
