...
同构但不同源。OASIS World Engine 是物理引擎，Nimi World Engine 是社会引擎。平台互操作依赖六个固定原语接口（P-PROTO-100–105）：Timeflow、Social、Economy、Transit、Context、Presence。
...
| AI Agent | 自主参与者 | OpenClaw + nimi-runtime |
