...
- `kernel/multimodal-provider-contract.md`（canonical inputs：K-MMPROV-001~005；async/artifact/adapter/route：K-MMPROV-006~012；voice catalog 与 diagnostics：K-MMPROV-013~015；LocalAI/Nexa image 兼容：K-MMPROV-016~017；voice workflow：K-MMPROV-018~023；video：K-MMPROV-024~027；inclusion/deferred：K-MMPROV-028~029）
...
6. adapter obligations、cloud/local route、validation fail-close 与 LocalAI/Nexa image 兼容：`kernel/multimodal-provider-contract.md`（K-MMPROV-008~012, K-MMPROV-016~017）。
