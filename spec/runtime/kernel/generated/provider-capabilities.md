...
| `local` | `local` | `local-model` | `true` | `false` | `empty_string_only` | `audio.synthesize`, `audio.transcribe`, `image.generate`, `music.generate`, `text.embed`, `text.generate`, `video.generate` | `K-MCAT-027`, `K-LOCAL-001`, `K-LOCAL-002` |
