...
- `spec/desktop/kernel/ai-profile-config-contract.md` — D-AIPC-001~012 (desktop AI config authority)
- `spec/platform/kernel/ai-scope-contract.md` — P-AISC-001~005 (AIScopeRef)
