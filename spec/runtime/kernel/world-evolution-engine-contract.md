...
- `spec/platform/kernel/architecture-contract.md` — `P-ARCH-022` through `P-ARCH-028`
- `spec/realm/kernel/world-state-contract.md` — `R-WSTATE-001` through `R-WSTATE-006`
- `spec/realm/kernel/world-history-contract.md` — `R-WHIST-001` through `R-WHIST-006`
- `spec/realm/kernel/tables/commit-authorization-matrix.yaml`
