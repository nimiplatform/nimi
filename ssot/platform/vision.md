...
正在走的路：
- Runtime 从 Desktop 独立（执行合同已落地，→ ssot/platform/architecture.md / ssot/runtime/service-contract.md / ssot/runtime/proto-contract.md）
- SDK 对第三方开放（导入面与版本策略已收敛，→ ssot/sdk/design.md）
