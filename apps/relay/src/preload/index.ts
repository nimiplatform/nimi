...
const api: NimiRelayBridge = {
  ...
  local: {
    ...
    installModel: (input) => invoke('relay:local:models:install', input),
    installVerifiedModel: (input) => invoke('relay:local:models:install-verified', input),
    importModel: (input) => invoke('relay:local:models:import', input),
    removeModel: (input) => invoke('relay:local:models:remove', input),
    startModel: (input) => invoke('relay:local:models:start', input),
    stopModel: (input) => invoke('relay:local:models:stop', input),
    checkModelHealth: (input) => invoke('relay:local:models:health', input),
    warmModel: (input) => invoke('relay:local:models:warm', input),
