...
- App production code must use generated Realm services or typed data clients. Do not add `realm.raw.request`, ad hoc `/api/` fetches, or fake success stubs for missing backend contracts.
