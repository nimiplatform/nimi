...
"#;
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            desktop_agent_center_store::desktop_agent_center_avatar_package_pick_live2d_source,
            desktop_agent_center_store::desktop_agent_center_avatar_package_pick_vrm_source,
