...
fn build_desktop_app() -> Result<tauri::App<tauri::Wry>, tauri::Error> {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            local_runtime::commands::runtime_local_artifacts_list,
            ...
            local_runtime::commands::runtime_local_artifacts_install_verified,
            ...
            local_runtime::commands::runtime_local_artifacts_remove,
            ...
            local_runtime::commands::runtime_local_models_reveal_root_folder,
