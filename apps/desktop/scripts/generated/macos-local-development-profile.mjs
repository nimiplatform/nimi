...
export const MACOS_LOCAL_DEVELOPMENT_PROFILE = Object.freeze({
  ...
  "runtimeLegacyRepairFreshBootstrapAuthorityProof": "the_fresh_bootstrap_child_uses_only_journal-bound_in-process_Security.framework_open-vnode_public-profile_root-trust_OpenDirectory_and_reentrant-libc_proofs;_it_must_not_unlock_private_custody_or_invoke_source-helper-status_codesign_or_any_final-helper_command",
  ...
  "runtimeLegacyRepairCustodyProofInvalidation": "invocation-exit_crash_restart_helper-SHA256_CDHash_root-key_policy_mutation-lock-vnode_or-journal-binding-change_invalidates_the_parent_private-custody-proof;_it_is_never_persisted_in_the_v2_journal_or_returned_to_Node",
  ...
  "runtimeLegacyRepairSuccessReceiptSchemaVersion": "nimi.macos-local-development-partial-install-repair-receipt/v1",
  "runtimeLegacyRepairSuccessReceiptRequiredFields": [
    "schemaVersion",
    "status",
    "disposition",
    "serviceName",
    ...
    "sourceHelperDisposition",
    "installReadiness",
    "trustHelperRotationRequired",
    "nextPrivilegedAction"
  ],
  "runtimeLegacyRepairSuccessReceiptPreservedFields": [
    "local_CA",
    "signing_Keychain",
    "signing_profile",
    "final_helper"
  ],
  "runtimeLegacyRepairSuccessReceiptSourceHelperDisposition": "preserved",
  "runtimeLegacyRepairSuccessReceiptCurrentCarrierAction": "none",
  "runtimeLegacyRepairSuccessReceiptStaleCarrierAction": "separately_confirmed_trust_helper_rotation",
  ...
  "runtimePOSIXIdentityLookupAPI": "getpwnam_r_getpwuid_r_getgrnam_r_getgrgid_r",
  "runtimePOSIXIdentityLookupResultPolicy": "return_code_0_plus_result_nil_is_the_only_not-found_state;_ERANGE_retries_with_bounded_buffer_growth_to_1048576_bytes;_any_other_return_code_is_lookup-error_and_never_absence",
  "runtimePrincipalDeletionProjectionPolicy": "raw_OpenDirectory_name-and-identifier_absence_is_mutation_truth;_user-removed_group-present_is_proved_without_POSIX_positive_lookups;_group_deletion_commits_group-removed_before_cache-reset-or-POSIX-proof;_cache-reset_then_fresh-bootstrap_getpwnam_r_getpwuid_r_getgrnam_r_getgrgid_r_all-not-found_is_required_before_final-journal-removal_or_UID-GID-reuse",
  "runtimePrincipalDiagnosticFields": [
    "phase",
    "probe",
    "state",
    "return_code",
    "expected_identifier",
    "observed_identifier",
    "observed_primary_group_identifier",
    "observed_name_sha256",
    "projection_sha256",
    "attempt",
    "elapsed_ms",
    "verifier_pid",
  ...
  "runtimePrincipalDiagnosticReasonCodes": [
