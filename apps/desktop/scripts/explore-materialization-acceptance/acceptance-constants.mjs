import {
  FIXTURE_BOUND_ENTITY,
  FIXTURE_PERSONA_CHARACTER,
  FIXTURE_PERSONA_SOURCE_REF,
  FIXTURE_SOURCE_REF,
  FIXTURE_WORLD_CHARACTER,
  FIXTURE_WORLD_CORE,
} from '../../e2e/fixtures/source-materialization-packet-v3.mjs';
...
export const VALID_CHARACTER_ID = FIXTURE_SOURCE_REF.id;
...
export const VALID_WORLD_CHARACTER = FIXTURE_WORLD_CHARACTER;
export const VALID_PERSONA_CHARACTER = FIXTURE_PERSONA_CHARACTER;
export const VALID_WORLD_CORE = FIXTURE_WORLD_CORE;
export const VALID_BOUND_ENTITY = FIXTURE_BOUND_ENTITY;
