...
describe('settings.release-strip-and-preferences', () => {
  it('navigates from the runtime-unavailable strip into Support updates', async () => {
    ...
    await waitForTestId(E2E_IDS.panel('support'));
    await waitForTestId('support-nav:updates');
    await waitForTestId('support-section-updates');
  });
});
