...
describe('runtime.external-agent.panel-load', () => {
  it('opens the external agent runtime subpage', async () => {
    ...
    await clickByTestId(E2E_IDS.runtimeSidebarPage('environment'));
    await waitForTestId(E2E_IDS.runtimePageRoot('environment'));
    await waitForTestId(E2E_IDS.runtimeEnvironmentPane('dependencies'));
  });
});
