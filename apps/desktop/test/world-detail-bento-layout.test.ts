...
const worldDashboardSource = readFileSync(
  resolve(import.meta.dirname, '../src/shell/renderer/features/world/world-detail-dashboard-section.tsx'),
  'utf8',
);
...
const worldContentSource = [
  readFileSync(
    resolve(import.meta.dirname, '../src/shell/renderer/features/world/world-detail-content-sections.tsx'),
    'utf8',
  ),
  readFileSync(
    resolve(import.meta.dirname, '../src/shell/renderer/features/world/world-detail-timeline-section.tsx'),
    'utf8',
  ),
].join('\n');
