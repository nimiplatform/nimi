export const E2E_IDS = {
  ...
  testerCapabilityTab: (capabilityId: string) => `tester-capability-tab:${capabilityId}`,
  testerPanel: (capabilityId: string) => `tester-panel:${capabilityId}`,
  testerInput: (name: string) => `tester-input:${name}`,
