import { loadStorageJsonFrom, saveStorageJsonTo, loadRuntimeModSettingsMap, persistRuntimeModSettingsMap, type RuntimeModSettingsMap } from "@nimiplatform/sdk/mod";
