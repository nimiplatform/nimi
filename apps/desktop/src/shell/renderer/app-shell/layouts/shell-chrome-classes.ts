...
export const SHELL_CHROME_TOOLTIP_CLASS =
  'fixed z-[11020] whitespace-nowrap rounded-xl px-2.5 py-1.5 text-xs font-medium text-[var(--nimi-text-primary)] shadow-[var(--nimi-elevation-floating)] pointer-events-none';
