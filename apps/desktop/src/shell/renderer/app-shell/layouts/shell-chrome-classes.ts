...
export const SHELL_CHROME_METRIC_GROUP_CLASS =
  'flex h-9 items-center rounded-full border border-white/30 bg-white/50 px-1 backdrop-blur-[12px] shadow-[0_1px_2px_rgba(15,23,42,0.04)]';
...
export const SHELL_CHROME_ACTION_CELL_CLASS =
  'relative flex h-9 w-9 items-center justify-center rounded-full border border-white/30 bg-white/50 text-[var(--nimi-text-primary)] shadow-[0_1px_2px_rgba(15,23,42,0.04)] backdrop-blur-[12px] transition hover:bg-white/60';
