      ...
      <Card className="p-0">
        <div className="max-h-[calc(100vh-24rem)] overflow-y-auto">
          {filteredAudits.length === 0 ? (
            <p className="px-4 py-6 text-center text-sm text-gray-500">No audit events matching current filters.</p>
          ) : (
...
function AuditEventCard({ event }: { event: LocalAiAuditEvent }) {
