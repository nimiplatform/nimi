...
import { RUNTIME_CONFIG_STORAGE_KEY_V11, createDefaultStateV11, type RuntimeConfigSeedV11, type StoredStateV11, } from './runtime-config-storage-defaults';
...
export function persistRuntimeConfigStateV11(state: RuntimeConfigStateV11): void {
    ...
    saveStorageJsonTo(typeof globalThis !== 'undefined' ? (globalThis.localStorage as Storage | undefined) : undefined, RUNTIME_CONFIG_STORAGE_KEY_V11, payload);
}
