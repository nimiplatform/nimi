...
function createEmptyWorkflowRow(now: () => number): WorkflowRow {
  return { workflowModelId: '', workflowType: 'reference_audio', inputContractRef: '', outputPersistence: '', targetModelRefs: '', langs: '', sourceUrl: '', sourceRetrievedAt: todayDate(now), sourceNote: '' };
}
