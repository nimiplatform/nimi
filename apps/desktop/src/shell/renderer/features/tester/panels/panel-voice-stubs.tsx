...
import { ScrollArea, TextareaField, TextField } from '@nimiplatform/kit/ui';
...
export function VoiceClonePanel(props: VoiceClonePanelProps) {
  ...
  return (
    <div data-testid={E2E_IDS.testerPanel('voice_workflow.voice_clone')} className="flex flex-col gap-3">
...
export function VoiceDesignPanel(props: VoiceDesignPanelProps) {
  ...
  return (
    <div data-testid={E2E_IDS.testerPanel('voice_workflow.voice_design')} className="flex flex-col gap-3">
      <div className="flex flex-col rounded-[var(--nimi-radius-lg)] border border-[var(--nimi-border-subtle)] bg-[var(--nimi-surface-card)] px-3 pb-2 pt-3 transition-colors">
...
export { VoiceAssetPanel } from './panel-voice-asset.js';
export type { VoiceAssetMode } from './panel-voice-asset.js';
