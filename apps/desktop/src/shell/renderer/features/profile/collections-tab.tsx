...
export function CollectionsTab({ layout = 'grid' }: CollectionsTabProps) {
  ...
  return (
    <div className={`${layoutClass} items-start gap-6`}>
      <AppCardSurface kind="promoted-glass" as="div" className="rounded-[24px] p-8 text-center text-sm text-[var(--nimi-text-secondary)]">
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-[var(--nimi-surface-active)] text-[var(--nimi-text-muted)]">
