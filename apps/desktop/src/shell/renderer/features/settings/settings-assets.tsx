...
const BASE_MENU_SECTIONS: SettingsMenuSection[] = [
  {
    label: 'Account',
    items: [
      { id: 'profile', icon: ICON_USER, title: 'Profile' },
      { id: 'appearance', icon: ICON_MONITOR, title: 'Appearance & Language' },
    ],
  },
  {
