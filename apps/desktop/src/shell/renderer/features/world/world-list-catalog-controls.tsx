...
import { SegmentedControl, SelectField } from '@nimiplatform/kit/ui';
    ...
    >
      ...
      <div className="ml-0 flex w-full min-w-0 items-center gap-2 min-[640px]:ml-auto min-[640px]:w-auto min-[640px]:shrink-0">
        <SegmentedControl
          ...
          className="shrink-0 rounded-full border-white/80 bg-white/70 backdrop-blur-sm [&_.nimi-segmented-control__item]:aspect-square [&_.nimi-segmented-control__item]:rounded-full [&_.nimi-segmented-control__item]:px-2 [&_.nimi-segmented-control__item]:text-[var(--world-explorer-text-secondary)] [&_.nimi-segmented-control__item--selected]:bg-[var(--world-explorer-brand-soft)] [&_.nimi-segmented-control__item--selected]:text-[var(--world-explorer-brand)]"
          items={[
        ...
        <SelectField
          ...
          className="min-w-0 flex-1 rounded-full border-white/80 bg-white/70 text-[var(--world-explorer-text)] backdrop-blur-sm min-[640px]:w-[124px] min-[640px]:max-w-[124px] min-[640px]:flex-none"
          options={[
