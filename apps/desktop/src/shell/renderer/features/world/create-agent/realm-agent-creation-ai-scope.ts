/**
 * NimiAIScopeRef identity for lightweight RealmAgent creation (D-EXPL-008,
 * P-AISC-001 / P-AISC-004).
 *
 * AI-assisted generation is an AI execution path, so it must carry an explicit
 * `NimiAIScopeRef`. This is the canonical app-scoped ref for the Explore -> World
...
export const REALM_AGENT_CREATION_AI_SCOPE_REF: NimiAIScopeRef = {
  kind: 'app',
