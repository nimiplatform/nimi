...
export function XianxiaWorldTemplate(props: XianxiaWorldTemplateProps) {
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen overflow-x-hidden bg-[#0a0f0c] font-sans text-[#e8f5ee]" data-testid="world-detail-root">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-[1400px] flex-col gap-5 px-5 py-6">
          ...
          <div className="flex flex-wrap gap-2" data-testid="world-detail-quick-nav">
            {([
              ['world-detail-rules', t('WorldDetail.xianxia.v2.quickNav.rules')],
              ['world-detail-recommended', t('WorldDetail.xianxia.v2.quickNav.characters')],
              ['world-detail-scenes', t('WorldDetail.xianxia.v2.quickNav.scenes')],
              ['world-detail-timeline', t('WorldDetail.xianxia.v2.quickNav.timeline')],
              ['world-detail-agents', t('WorldDetail.xianxia.v2.quickNav.roster')],
              ['world-detail-governance-card', t('WorldDetail.xianxia.v2.quickNav.governance')],
            ] as const).map(([id, label]) => (
              <button
                key={id}
                type="button"
                onClick={() => scrollToSection(id)}
                className="rounded-full border border-[#4ECCA3]/16 bg-[#4ECCA3]/10 px-3 py-1.5 text-xs text-[#dffdf2] transition-colors hover:bg-[#4ECCA3]/16"
              >
                {label}
              </button>
            ))}
          ...
          <WorldDashboardSection world={world} />

          {props.semantic.hasContent ? (
            <div id="world-detail-rules">
              <WorldCoreRulesSection semantic={props.semantic} />
            </div>
          ) : null}

          <div id="world-detail-recommended">
            <WorldRecommendedEntrySection world={world} onSelectAgent={setSelectedAgentId} />
          </div>

          <div id="world-detail-scenes">
            <WorldScenesSection
          ...
          <WorldRuntimeFactsSection world={world} publicAssets={props.publicAssets} />

          <WorldLanguageFactsSection world={world} />

          <div id="world-detail-governance-card">
      ...
      {selectedAgent ? (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/55 px-5 backdrop-blur-sm">
          <button
            type="button"
          ...
          />
          <section className="relative z-10 w-full max-w-[620px] overflow-hidden rounded-[28px] border border-[#4ECCA3]/20 bg-[#0d1511]/96 shadow-[0_24px_80px_rgba(0,0,0,0.55)]">
      ...
      {selectedScene ? (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/55 px-5 backdrop-blur-sm">
          ...
          />
          <section className="relative z-10 w-full max-w-[760px] overflow-hidden rounded-[28px] border border-[#4ECCA3]/20 bg-[#0d1511]/96 shadow-[0_24px_80px_rgba(0,0,0,0.55)]">
            <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[#4ECCA3]/50 to-transparent" />
            <div className="px-6 pb-6 pt-5">
              <div className="mb-5 flex items-start justify-between gap-4">
                <div>
