...
export type ContactsViewProps = {
  ...
  onAcceptRequest: (request: ContactRequestRecord) => Promise<void> | void;
  onRejectRequest: (request: ContactRequestRecord) => Promise<void> | void;
  onCancelRequest: (request: ContactRequestRecord) => Promise<void> | void;
  onRemoveFriend: (contact: ContactRecord) => Promise<void> | void;
