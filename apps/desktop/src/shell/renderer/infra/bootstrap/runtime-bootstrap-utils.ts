...
export const WORLD_DATA_API_CAPABILITIES = {
  ...
  resourceBindingsList: 'data-api.world.resource-bindings.list',
  resourceBindingsBatchUpsert: 'data-api.world.resource-bindings.batch-upsert',
  resourceBindingsDelete: 'data-api.world.resource-bindings.delete',
