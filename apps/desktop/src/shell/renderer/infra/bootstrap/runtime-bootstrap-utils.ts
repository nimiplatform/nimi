...
export const WORLD_DATA_API_CAPABILITIES = {
  ...
  visualBindingsList: 'data-api.world.visual-bindings.list',
  visualBindingsBatchUpsert: 'data-api.world.visual-bindings.batch-upsert',
  visualBindingsDelete: 'data-api.world.visual-bindings.delete',
