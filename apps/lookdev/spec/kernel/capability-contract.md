...
- structured text generation or equivalent typed reasoning capability for style-pack and portrait-brief compilation
...
## LD-CAP-005 — Shared Capture Logic Reuse
...
## LD-CAP-006 — No Silent Contract Rescue
...
## LD-CAP-007 — Realm Boundary Preservation
