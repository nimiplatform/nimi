...
- **World Data Fusion** — Intelligently compose rich 3D generation prompts from nimi's structured world data (worldview physics, lorebook entries, resource bindings, visual assets)
