...
- Product-facing expansion ideas belong here; execution evidence and delivery plans belong in local execution workspaces such as `nimi-coding/.local/**`, not in the spec tree.
