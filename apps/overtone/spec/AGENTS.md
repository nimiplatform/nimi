...
- Product-facing expansion ideas belong here; execution evidence and delivery plans belong in local execution workspaces such as `.local/**`, not in the spec tree.
