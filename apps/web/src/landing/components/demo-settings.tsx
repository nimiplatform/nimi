...
export function DemoSettingsSurface({ settings }: { settings: HeroDemo['settings'] }) {
  return (
    <div className="h-full min-h-0 overflow-y-auto px-1 py-1">
      <p className="text-sm font-semibold tracking-tight text-[var(--nimi-text-primary)]">{settings.title}</p>
