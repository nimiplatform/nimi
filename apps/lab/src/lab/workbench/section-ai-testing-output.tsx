...
import { nonSuccessReasonTitle } from '../lab-non-success.js';
import {
...
export function formatTypedOutput(result: LabCapabilityRunResult & { ok: true }): string {
...
export function formatNonSuccessOutput(result: LabCapabilityRunResult & { ok: false }): string {
  return [
...
// success state.
export function resultPlainText(result: LabCapabilityRunResult): string {
...
export async function downloadTextFile(
  commands: LabRendererCommandPort,
  filename: string,
  body: string,
) {
