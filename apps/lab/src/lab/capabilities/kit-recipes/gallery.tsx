...
export function KitRecipesGallery({ copyText }: { copyText: KitRecipesCopyText }) {
  ...
  return (
    <div className="kit-doc grid h-full min-h-0 min-w-0 grid-cols-[260px_minmax(0,1fr)] items-stretch gap-4 overflow-x-hidden overflow-y-auto p-4 max-[880px]:grid-cols-1" data-testid="nimi-lab-ui-recipes">
      ...
      <section className="kit-doc__main grid min-w-0 content-start gap-4">
        ...
        <div className="kit-doc__canvas min-w-0">
          {category === 'foundations' ? (
            ...
            <RecipeWorkspace recipes={recipesInCategory} copyText={copyText} />
          )}
        </div>
      </section>
    </div>
