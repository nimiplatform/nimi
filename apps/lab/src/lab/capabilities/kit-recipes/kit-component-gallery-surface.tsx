  ...
  return (
    <div ref={panelRef} className="min-w-0">
      ...
      >
        ...
        <Button tone="primary" fullWidth leadingIcon={<Copy size={15} aria-hidden="true" />} onClick={() => void copyText(recipeCopyText(recipe))}>
...
export function RecipeWorkspace({ recipes, copyText }: { recipes: Recipe[]; copyText: KitRecipesCopyText }) {
