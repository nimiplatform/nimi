...
|----------|----------|-------|
| [app-shell-contract.md](kernel/app-shell-contract.md) | SJ-SHELL-001 ~ 006 | App Shell + Bootstrap + Auth |
| [explore-contract.md](kernel/explore-contract.md) | SJ-EXPL-001 ~ 009 | 时间长河浏览 + 人物选择 |
| [map-contract.md](kernel/map-contract.md) | SJ-MAP-001 ~ 005 | 历史地图视图 + 时空联动 |
| [dialogue-contract.md](kernel/dialogue-contract.md) | SJ-DIAL-001 ~ 016 | 对话引擎管线 + 内容真值边界 + learner 适配 |
| [knowledge-contract.md](kernel/knowledge-contract.md) | SJ-KNOW-001 ~ 007 | 知识脚手架 + 类型化追踪 |
