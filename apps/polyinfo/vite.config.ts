  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        '@nimiplatform/kit/features/chat': path.resolve(__dirname, '../../kit/features/chat/src'),
        '@nimiplatform/kit/core': path.resolve(__dirname, '../../kit/core/src'),
        '@nimiplatform/kit/auth': path.resolve(__dirname, '../../kit/auth/src'),
        '@nimiplatform/kit/shell/renderer/bridge': path.resolve(__dirname, '../../kit/shell/renderer/src/bridge'),
      },
    },
