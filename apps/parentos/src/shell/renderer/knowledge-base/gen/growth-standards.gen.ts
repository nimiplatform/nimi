...
export type GrowthTypeId = 'height' | 'weight' | 'head-circumference' | 'bmi' | 'vision-left' | 'vision-right' | 'hyperopia-reserve' | 'bone-age' | 'corrected-vision-left' | 'corrected-vision-right' | 'refraction-sph-left' | 'refraction-sph-right' | 'refraction-cyl-left' | 'refraction-cyl-right' | 'refraction-axis-left' | 'refraction-axis-right' | 'axial-length-left' | 'axial-length-right' | 'corneal-curvature-left' | 'corneal-curvature-right' | 'body-fat-percentage' | 'scoliosis-cobb-angle' | 'lab-vitamin-d' | 'lab-ferritin' | 'lab-hemoglobin' | 'lab-calcium' | 'lab-zinc';
