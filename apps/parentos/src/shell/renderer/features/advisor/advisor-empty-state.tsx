  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-6">
      <div className={`${ADVISOR_EMPTY_GRADIENT} w-full max-w-md rounded-[30px] border border-white/80 px-8 py-10 text-center shadow-[0_20px_52px_rgba(15,23,42,0.08)]`}>
        <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-emerald-700/70">
          AI 顾问
        </p>
        <h2 className="mb-3 text-[26px] font-black leading-tight tracking-tight text-slate-950">
          选择或创建一个对话
        </h2>
        ...
        {runtimeAvailable === false && (
          <div className="mt-4 rounded-2xl border border-amber-200/80 bg-amber-50/90 px-4 py-2 text-[12px] text-amber-800">
