    ...
    >
      ...
      >
        ...
        <div className="px-6 pb-2 space-y-4 flex-1">
          ...
          <div>
            <label className="text-[13px] mb-1 block font-medium" style={{ color: S.sub }}>照片</label>
            <input
              ref={photoRef}
              type="file"
              accept="image/*"
        ...
        <div className="px-6 pt-3 pb-5 mt-1">
          <div className="flex items-center justify-end gap-2">
            ...
            <button
              onClick={onSave}
              className={`px-5 py-2 text-[14px] font-medium text-white ${S.radiusSm} transition-colors hover:brightness-110`}
