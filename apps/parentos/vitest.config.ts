...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: '@nimiplatform/kit/features/chat/ui', replacement: path.resolve(__dirname, '../../kit/features/chat/src/ui.ts') },
      { find: '@nimiplatform/kit/features/chat', replacement: path.resolve(__dirname, '../../kit/features/chat/src/index.ts') },
      { find: '@nimiplatform/kit/core/oauth', replacement: path.resolve(__dirname, '../../kit/core/src/oauth/index.ts') },
