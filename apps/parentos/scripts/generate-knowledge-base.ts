...
function generateMilestoneCatalog() {
  const data = readKnowledgeJson('milestone-catalog.json') as {
    milestones: Array<{
      milestoneId: string;
      domain: string;
      title: string;
...
function generateSensitivePeriods() {
  const data = readKnowledgeJson('sensitive-periods.json') as {
    periods: Array<{
      periodId: string;
      title: string;
      description: string;
...
function generateObservationFramework() {
  const data = readKnowledgeJson('observation-framework.json') as {
...
function generateGrowthStandards() {
  const data = readKnowledgeJson('growth-standards.json') as {
