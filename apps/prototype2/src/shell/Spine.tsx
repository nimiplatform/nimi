...
/** The spine — bottom floating dock. Agent, world, background controls,
 * interaction ledger, and carry state.
 * App launch/running icons live in the left app rail instead. */
export function Spine({ onOpenSkyPanel, skyPanelOpen }: SpineProps) {
  const { state, openApp, goHome, toggleLedger } = useSim();
