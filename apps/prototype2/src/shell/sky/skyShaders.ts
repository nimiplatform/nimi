...
/**
 * Layered composition over the night-scape photo:
 *  - photo layer (terrain + night sky) retained at night, graded by time
...
void main() {
  // cover-fit the photo onto the canvas
  ...
  // how much the procedural sky replaces the photo sky;
  // dark ridge pixels just above the horizon keep the photo (mountain silhouettes)
