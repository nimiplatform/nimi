...
export type ZhiyuProductStory = {
  ...
  readonly primarySurface: 'home-shell' | 'model-config' | 'developer-backstage';
...
export const ZHIYU_PRODUCT_STORIES: readonly ZhiyuProductStory[] = [
  {
    ...
    primarySurface: 'home-shell',
    acceptanceSignal: 'offline shell has one clear recovery path and no engineering queue as the home page.',
  },
  {
    id: 'no-local-partner',
    userGoal: '从 Realm 角色资料创建或选择一个本地伙伴。',
    productPromise: '织羽是 home shell；当前伙伴来自真实 materialization。',
    primarySurface: 'home-shell',
    acceptanceSignal: 'home shell asks for a local partner and does not claim the app brand is the partner.',
  },
  {
    id: 'partner-ready',
  ...
  },
  {
    ...
    acceptanceSignal: 'model drawer is reachable from home shell and route state updates through SDK/Kit.',
  },
  {
  ...
  {
    id: 'developer-backstage',
    userGoal: '验收者查看链路、状态、能力消费和失败原因。',
    productPromise: '开发者后台承载诊断和能力探针，不能污染主产品层。',
    primarySurface: 'developer-backstage',
    acceptanceSignal: 'diagnostics drawer exposes capability, image, speech, projection, and fail-closed data.',
  },
  {
  ...
  },
  {
    ...
    primarySurface: 'developer-backstage',
    acceptanceSignal: 'developer backstage can dispatch audio.synthesize through shared Kit/SDK surfaces.',
  },
];
