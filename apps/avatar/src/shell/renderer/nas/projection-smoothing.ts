...
export type ProjectionSmoothingHandle = {
...
export type CreateSmoothedProjectionInput = {
  projection: EmbodimentProjectionApi;
...
export function createSmoothedProjection(input: CreateSmoothedProjectionInput): ProjectionSmoothingHandle {
