...
import {
  ...
  type StorybookRuntimePlatformProjection,
...
type GateState =
  | { kind: 'checking' }
  | { kind: 'ready'; projection: Extract<StorybookRuntimePlatformProjection, { status: 'ready' }> }
  | { kind: 'login-required'; message?: string }
  | { kind: 'blocked'; projection?: Exclude<StorybookRuntimePlatformProjection, { status: 'ready' }>; message?: string };
