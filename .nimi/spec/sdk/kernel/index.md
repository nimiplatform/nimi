...
| `runtime-avatar-control-client-contract.md` | `S-RUNTIME-*` | SDK typed client boundary for Desktop Avatar configuration, Runtime-owned Avatar debug probe/replay methods, Runtime Avatar package launch projection method shape, Asset Market Avatar package refs, package-kind-aware acquisition/import projections, readiness decoding, and no package lifecycle authority |
