...
| --- | --- | --- |
| real runtime path | Desktop-selected launch context + Runtime/SDK-authorized opaque visual package ref + local materialization resolver + runtime IPC bridge + SDK driver + Avatar carrier | Yes |
