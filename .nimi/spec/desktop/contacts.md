...
This guide points to the desktop authority surfaces for contacts. It does not define product rules.

## Reading Path

- `.nimi/spec/desktop/kernel/index.md`
- `.nimi/spec/desktop/kernel/contacts-surface-contract.md`
...
- `.nimi/spec/desktop/kernel/tables/contacts-categories.yaml`
- `.nimi/spec/desktop/kernel/tables/contacts-friend-request-states.yaml`
