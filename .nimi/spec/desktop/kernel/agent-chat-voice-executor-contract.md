...
（`D-LLM-005`）继续拥有 runtime-aligned TTS route/API surface；`.nimi/spec/runtime/kernel/voice-contract.md`
...
- `.nimi/spec/desktop/kernel/llm-adapter-contract.md` — runtime-aligned
