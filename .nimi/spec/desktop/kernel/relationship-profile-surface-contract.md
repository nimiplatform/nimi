...
Explore, Profile, notification, and source-admission flows; it is not a
...
truth, source admission truth, RuntimeSourceSnapshot materialization, or
LocalAgent Chat identity.
...
friend request, and source-admission handoff must use admitted Realm social/core
and Runtime paths. Desktop must not create renderer-local social truth,
pseudo-success, REST bypass, or bare source direct chat.

`MUST`: Source-admission pending, unavailable, or unsupported states must fail
closed or route to an admitted in-context management action. They must not
...
- `.nimi/spec/realm/kernel/social-contract.md` and `.nimi/spec/realm/kernel/core-contract.md` — Friendship and source admission truth.
- `.nimi/spec/runtime/kernel/runtime-agent-service-contract.md` — RuntimeSourceSnapshot materialization and LocalAgent lifecycle.
