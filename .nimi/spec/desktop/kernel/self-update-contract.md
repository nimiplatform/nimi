...
Desktop 自更新与 bundled runtime 发布契约。该契约是 `D-BOOT-001`、`D-IPC-002`、`D-IPC-014`、`D-IPC-015` 在“packaged desktop 壳 + bundled runtime”场景下的强约束收口。

## Atomic Desktop Release Unit (D-BOOT-001, D-IPC-014)
