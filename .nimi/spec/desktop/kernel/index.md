...
| `agent-chat-message-action-contract.md` | `D-LLM-*` | Agent chat single-message / unified action envelope authority、model-generated modality prompt semantics、immediate post-turn action semantics、deferred continuation handoff boundary |
