...
| desktop_agent_avatar_resource_import_vrm | Import a VRM avatar file into desktop-local avatar resource storage under nimi_data |
| desktop_agent_avatar_resource_pick_vrm | Open a desktop-native file picker constrained for selecting a VRM avatar source file |
| desktop_agent_avatar_resource_pick_live2d | Open a desktop-native folder picker for selecting a Live2D runtime directory |
| desktop_agent_avatar_resource_import_live2d | Import a Live2D runtime directory or manifest root into desktop-local avatar resource storage under nimi_data |
| desktop_agent_avatar_resource_list | List desktop-local avatar resource records available for per-agent binding |
| desktop_agent_avatar_resource_delete | Delete a desktop-local avatar resource record and its managed imported assets |
| desktop_agent_avatar_resource_read_asset | Read a desktop-local avatar resource entry as binary payload for renderer-local live avatar loading |
| desktop_agent_avatar_binding_get | Read the desktop-local avatar binding for a specific agentId |
| desktop_agent_avatar_binding_set | Bind a desktop-local avatar resource record to a specific agentId |
| desktop_agent_avatar_binding_clear | Clear the desktop-local avatar binding for a specific agentId |
