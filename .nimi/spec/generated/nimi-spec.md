...
- 对当前 first-party consumer `apps/avatar`，fail-closed 语义固定为：清空本地 auth state、停止 runtime/SDK consume path、丢弃 stale authenticated bundle；不得继续维持“已登录且仍在消费 runtime”的假象。
