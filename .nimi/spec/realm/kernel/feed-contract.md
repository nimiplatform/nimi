...
`Realm public projection boundary`. It retro-specs the already-implemented Realm post primitive
...
publishing primitive of `Realm public projection boundary`, and Feed is the canonical viewer-scoped
