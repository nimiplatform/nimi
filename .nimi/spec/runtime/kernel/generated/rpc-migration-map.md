...
| `RuntimeKnowledgeService` | `RuntimeKnowledgeService` | `aligned` | `phase2` | `K-RPC-004c` |
| `RuntimeAppService` | `RuntimeAppService` | `aligned` | `phase2` | `K-APP-001` |
| `RuntimeMemoryService` | `RuntimeMemoryService` | `aligned` | `phase2` | `K-RPC-004a` |
...
| `RuntimeKnowledgeService` | `CreateKnowledgeBank` | `RuntimeKnowledgeService` | `CreateKnowledgeBank` | `aligned` |
| `RuntimeKnowledgeService` | `GetKnowledgeBank` | `RuntimeKnowledgeService` | `GetKnowledgeBank` | `aligned` |
| `RuntimeKnowledgeService` | `ListKnowledgeBanks` | `RuntimeKnowledgeService` | `ListKnowledgeBanks` | `aligned` |
| `RuntimeKnowledgeService` | `DeleteKnowledgeBank` | `RuntimeKnowledgeService` | `DeleteKnowledgeBank` | `aligned` |
| `RuntimeKnowledgeService` | `PutPage` | `RuntimeKnowledgeService` | `PutPage` | `aligned` |
| `RuntimeKnowledgeService` | `GetPage` | `RuntimeKnowledgeService` | `GetPage` | `aligned` |
| `RuntimeKnowledgeService` | `ListPages` | `RuntimeKnowledgeService` | `ListPages` | `aligned` |
| `RuntimeKnowledgeService` | `DeletePage` | `RuntimeKnowledgeService` | `DeletePage` | `aligned` |
| `RuntimeKnowledgeService` | `SearchKeyword` | `RuntimeKnowledgeService` | `SearchKeyword` | `aligned` |
| `RuntimeKnowledgeService` | `SearchHybrid` | `RuntimeKnowledgeService` | `SearchHybrid` | `aligned` |
| `RuntimeKnowledgeService` | `AddLink` | `RuntimeKnowledgeService` | `AddLink` | `aligned` |
| `RuntimeKnowledgeService` | `RemoveLink` | `RuntimeKnowledgeService` | `RemoveLink` | `aligned` |
| `RuntimeKnowledgeService` | `ListLinks` | `RuntimeKnowledgeService` | `ListLinks` | `aligned` |
| `RuntimeKnowledgeService` | `ListBacklinks` | `RuntimeKnowledgeService` | `ListBacklinks` | `aligned` |
| `RuntimeKnowledgeService` | `TraverseGraph` | `RuntimeKnowledgeService` | `TraverseGraph` | `aligned` |
| `RuntimeKnowledgeService` | `IngestDocument` | `RuntimeKnowledgeService` | `IngestDocument` | `aligned` |
| `RuntimeKnowledgeService` | `GetIngestTask` | `RuntimeKnowledgeService` | `GetIngestTask` | `aligned` |
...
| `RuntimeMemoryService` | `CreateBank` | `RuntimeMemoryService` | `CreateBank` | `aligned` |
| `RuntimeMemoryService` | `GetBank` | `RuntimeMemoryService` | `GetBank` | `aligned` |
| `RuntimeMemoryService` | `ListBanks` | `RuntimeMemoryService` | `ListBanks` | `aligned` |
| `RuntimeMemoryService` | `DeleteBank` | `RuntimeMemoryService` | `DeleteBank` | `aligned` |
| `RuntimeMemoryService` | `Retain` | `RuntimeMemoryService` | `Retain` | `aligned` |
| `RuntimeMemoryService` | `Recall` | `RuntimeMemoryService` | `Recall` | `aligned` |
| `RuntimeMemoryService` | `History` | `RuntimeMemoryService` | `History` | `aligned` |
| `RuntimeMemoryService` | `Reflect` | `RuntimeMemoryService` | `Reflect` | `aligned` |
| `RuntimeMemoryService` | `DeleteMemory` | `RuntimeMemoryService` | `DeleteMemory` | `aligned` |
| `RuntimeMemoryService` | `SubscribeMemoryEvents` | `RuntimeMemoryService` | `SubscribeMemoryEvents` | `aligned` |
