...
> Source: `.nimi/spec/runtime/kernel/tables/rpc-migration-map.yaml`
## Service Mapping
...
| `RuntimeLocalService` | `ResolveLocalEnvironmentPlan` | `RuntimeLocalService` | `ResolveLocalEnvironmentPlan` | `aligned` |
| `RuntimeLocalService` | `ListLocalEnvironmentSelectedSources` | `RuntimeLocalService` | `ListLocalEnvironmentSelectedSources` | `aligned` |
| `RuntimeLocalService` | `ListLocalEnvironmentDependencyJobs` | `RuntimeLocalService` | `ListLocalEnvironmentDependencyJobs` | `aligned` |
| `RuntimeLocalService` | `ResolveLocalEnvironmentActivationGate` | `RuntimeLocalService` | `ResolveLocalEnvironmentActivationGate` | `aligned` |
| `RuntimeLocalService` | `StartLocalEnvironmentDependencyJob` | `RuntimeLocalService` | `StartLocalEnvironmentDependencyJob` | `aligned` |
| `RuntimeLocalService` | `CancelLocalEnvironmentDependencyJob` | `RuntimeLocalService` | `CancelLocalEnvironmentDependencyJob` | `aligned` |
| `RuntimeLocalService` | `RetryLocalEnvironmentDependencyJob` | `RuntimeLocalService` | `RetryLocalEnvironmentDependencyJob` | `aligned` |
| `RuntimeLocalService` | `RepairLocalEnvironmentDependency` | `RuntimeLocalService` | `RepairLocalEnvironmentDependency` | `aligned` |
| `RuntimeLocalService` | `ResolveLocalStateReconciliation` | `RuntimeLocalService` | `ResolveLocalStateReconciliation` | `aligned` |
| `RuntimeLocalService` | `ExecuteLocalStateCutover` | `RuntimeLocalService` | `ExecuteLocalStateCutover` | `aligned` |
...
| `RuntimeCognitionService` | `CreateKnowledgeBank` | `RuntimeCognitionService` | `CreateKnowledgeBank` | `aligned` |
| `RuntimeCognitionService` | `GetKnowledgeBank` | `RuntimeCognitionService` | `GetKnowledgeBank` | `aligned` |
| `RuntimeCognitionService` | `ListKnowledgeBanks` | `RuntimeCognitionService` | `ListKnowledgeBanks` | `aligned` |
| `RuntimeCognitionService` | `DeleteKnowledgeBank` | `RuntimeCognitionService` | `DeleteKnowledgeBank` | `aligned` |
| `RuntimeCognitionService` | `PutPage` | `RuntimeCognitionService` | `PutPage` | `aligned` |
| `RuntimeCognitionService` | `GetPage` | `RuntimeCognitionService` | `GetPage` | `aligned` |
| `RuntimeCognitionService` | `ListPages` | `RuntimeCognitionService` | `ListPages` | `aligned` |
| `RuntimeCognitionService` | `DeletePage` | `RuntimeCognitionService` | `DeletePage` | `aligned` |
| `RuntimeCognitionService` | `SearchKeyword` | `RuntimeCognitionService` | `SearchKeyword` | `aligned` |
| `RuntimeCognitionService` | `SearchHybrid` | `RuntimeCognitionService` | `SearchHybrid` | `aligned` |
| `RuntimeCognitionService` | `AddLink` | `RuntimeCognitionService` | `AddLink` | `aligned` |
| `RuntimeCognitionService` | `RemoveLink` | `RuntimeCognitionService` | `RemoveLink` | `aligned` |
| `RuntimeCognitionService` | `ListLinks` | `RuntimeCognitionService` | `ListLinks` | `aligned` |
| `RuntimeCognitionService` | `ListBacklinks` | `RuntimeCognitionService` | `ListBacklinks` | `aligned` |
| `RuntimeCognitionService` | `TraverseGraph` | `RuntimeCognitionService` | `TraverseGraph` | `aligned` |
| `RuntimeCognitionService` | `IngestDocument` | `RuntimeCognitionService` | `IngestDocument` | `aligned` |
| `RuntimeCognitionService` | `GetIngestTask` | `RuntimeCognitionService` | `GetIngestTask` | `aligned` |
...
| `RuntimeCognitionService` | `CreateBank` | `RuntimeCognitionService` | `CreateBank` | `aligned` |
| `RuntimeCognitionService` | `GetBank` | `RuntimeCognitionService` | `GetBank` | `aligned` |
| `RuntimeCognitionService` | `ListBanks` | `RuntimeCognitionService` | `ListBanks` | `aligned` |
| `RuntimeCognitionService` | `DeleteBank` | `RuntimeCognitionService` | `DeleteBank` | `aligned` |
| `RuntimeCognitionService` | `Retain` | `RuntimeCognitionService` | `Retain` | `aligned` |
| `RuntimeCognitionService` | `Recall` | `RuntimeCognitionService` | `Recall` | `aligned` |
