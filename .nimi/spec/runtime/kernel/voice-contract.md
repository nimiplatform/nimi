...
- target synthesis family 绑定到 `speech/voxcpm2`
...
- `voxcpm` 的 admitted success 不得被解释为 generic `local` workflow success
- `omnivoice` 不在首轮 admitted 范围内，必须继续 fail-close，直到后续独立 admission
