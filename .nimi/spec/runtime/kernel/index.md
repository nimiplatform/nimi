...
| `avatar-package-projection-contract.md` | `K-AGCORE-*` | Runtime-owned launch-time Avatar package projection, `runtime.avatarPackage.resolveLaunchProjection` method shape, Asset Market package handoff gate, and Agent Center non-authority |
