...
|---|---|---|---|---|
| `nimi-light` | `foundation` | 148 | `desktop`, `forge`, `relay`, `overtone`, `parentos` | `P-DESIGN-002` |
| `nimi-dark` | `foundation` | 148 | `desktop`, `forge`, `relay`, `overtone`, `parentos` | `P-DESIGN-002` |
