...
| `nimi-app-admission-contract.md` | `P-NAPP-*` | Nimi App admission authority, `app_id` display/routing identity, random Runtime local-app principal relationship, closed verified/user_imported/local_development provenance, bundled exclusion, opaque immutable package seam, production Developer Mode, principal-keyed storage/audience, and protected local-app launch boundary |
