...
| `macos-protected-local-admission-contract.md` | `P-NAPP-037` | Conjunctive independent macOS Runtime service, protected transport, mutual code/process trust, custody, signed host, Electron/Tauri and live-machine admission authority |
