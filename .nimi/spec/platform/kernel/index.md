...
| `test-governance-contract.md` | `P-TEST-*` | Cross-domain test classification vocabulary, census authority, fail-closed inventory ratchet, per-domain non-authoritative support inventories, and trust-gate eligibility hard blocks |
...
| `tables/test-governance-policy.yaml` | `test-governance-contract.md` | Closed cross-domain test classification vocabulary, gate-eligibility enum, hard blocks, reproducible census, and module owner map. |
