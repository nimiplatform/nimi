...
| `.nimi/spec/runtime/kernel/auth-service.md` | K-AUTHSVC-001–013 |
| `.nimi/spec/runtime/kernel/grant-service.md` | K-GRANT-001–013 |
| `.nimi/spec/runtime/kernel/connector-contract.md` | K-CONN-001–015 |
| `.nimi/spec/runtime/kernel/pagination-filtering.md` | K-PAGE-001–006 |
| `.nimi/spec/runtime/kernel/audit-contract.md` | K-AUDIT-001–018 |
| `.nimi/spec/runtime/kernel/error-model.md` | K-ERR-001–010 |
| `.nimi/spec/runtime/kernel/local-category-capability.md` | K-LOCAL-029, K-LOCAL-030 |
| `.nimi/spec/desktop/kernel/security-contract.md` | D-SEC-005, D-SEC-007, D-SEC-009 |
| `.nimi/spec/desktop/kernel/hook-capability-contract.md` | D-HOOK-006–010 |
| `.nimi/spec/desktop/kernel/mod-governance-contract.md` | D-MOD-005, D-MOD-008 |
| `.nimi/spec/desktop/kernel/bridge-ipc-contract.md` | D-IPC-008 |
...
2. 再读 Runtime 安全执行链：`.nimi/spec/runtime/kernel/auth-service.md`、`.nimi/spec/runtime/kernel/grant-service.md`、`.nimi/spec/runtime/kernel/connector-contract.md`、`.nimi/spec/runtime/kernel/pagination-filtering.md`、`.nimi/spec/runtime/kernel/audit-contract.md`、`.nimi/spec/runtime/kernel/error-model.md`。
3. 最后读 Desktop 沙盒边界：`.nimi/spec/desktop/kernel/security-contract.md`、`.nimi/spec/desktop/kernel/hook-capability-contract.md`、`.nimi/spec/desktop/kernel/mod-governance-contract.md`、`.nimi/spec/desktop/kernel/bridge-ipc-contract.md`。
