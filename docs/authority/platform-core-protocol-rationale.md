...
<!-- source: .nimi/spec/platform/vision.md -->
...
This guide points to the Platform authority surfaces for vision. It does not define product rules.
...
This guide points to the Platform authority surfaces for architecture. It does not define product rules.
...
<!-- source: .nimi/spec/platform/protocol.md -->
...
This guide points to the Platform authority surfaces for protocol. It does not define product rules.
...
This guide points to the Platform authority surfaces for ai-last-mile. It does not define product rules.
...
This guide points to the Platform authority surfaces for ai-agent-security-interface. It does not define product rules.
...
<!-- source: .nimi/spec/platform/kernel/protocol-contract.md -->
...
<!-- source: .nimi/spec/platform/kernel/ai-scope-contract.md -->
...
<!-- source: .nimi/spec/platform/kernel/ai-profile-selection-policy-contract.md -->
...
（`P-AIPS-001..P-AIPS-013`）独立拥有；`P-ARCH-*` 不重新解释 provider / model /
