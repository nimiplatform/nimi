...
| Realm access rules and cloud audit | AI implementation selection, budget, credentials, and App authorization |
...
World state. Realm does not execute LocalAgent turns or choose Runtime implementations.
