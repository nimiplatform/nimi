...
- [`.nimi/spec/sdks/kernel/local-environment-projection-contract.md`](https://github.com/nimiplatform/nimi/blob/main/.nimi/spec/sdks/kernel/local-environment-projection-contract.md)
