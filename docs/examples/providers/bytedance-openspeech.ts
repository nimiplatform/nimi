 ...
 *    cd runtime
 *    NIMI_RUNTIME_CLOUD_ADAPTER_BYTEDANCE_OPENSPEECH_BASE_URL=https://your-openspeech-endpoint \
 *    NIMI_RUNTIME_CLOUD_ADAPTER_BYTEDANCE_OPENSPEECH_API_KEY=xxx \
 ...
 *    export NIMI_BYTEDANCE_TTS_MODEL=bytedance/tts-1
 *    export NIMI_BYTEDANCE_STT_MODEL=bytedance/stt-1
...
async function run(): Promise<void> {
  ...
  const ttsModel = env('NIMI_BYTEDANCE_TTS_MODEL', 'bytedance/tts-1');
  const sttModel = env('NIMI_BYTEDANCE_STT_MODEL', 'bytedance/stt-1');
