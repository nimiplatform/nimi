...
This page maps developer-facing topics to normative spec sources.

## Primary entries

- Spec index: [`spec/INDEX.md`](https://github.com/nimiplatform/nimi/blob/main/spec/INDEX.md)
- Human-readable generated spec: [`spec/generated/nimi-spec.md`](https://github.com/nimiplatform/nimi/blob/main/spec/generated/nimi-spec.md)
...
- Realm interconnect thin mapping: [`spec/realm/app-interconnect-model.md`](https://github.com/nimiplatform/nimi/blob/main/spec/realm/app-interconnect-model.md)
...
- Runtime: [`spec/runtime`](https://github.com/nimiplatform/nimi/blob/main/spec/runtime/index.md)
- SDK: [`spec/sdk`](https://github.com/nimiplatform/nimi/blob/main/spec/sdk/index.md)
...
- `spec/` defines normative contract rules.
- `docs/` explains how developers integrate and operate against those rules.
