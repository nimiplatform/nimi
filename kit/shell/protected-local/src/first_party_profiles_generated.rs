...
#[rustfmt::skip]
pub const DESKTOP_PRODUCT_CONTROL_V1_METHODS: &[DesktopProductControlMethod] = &[DesktopProductControlMethod::CollectDeviceProfile, DesktopProductControlMethod::ResolveLocalEnvironmentPlan, DesktopProductControlMethod::ListLocalEnvironmentDependencyJobs, DesktopProductControlMethod::StartLocalEnvironmentDependencyJob, DesktopProductControlMethod::CancelLocalEnvironmentDependencyJob, DesktopProductControlMethod::RetryLocalEnvironmentDependencyJob, DesktopProductControlMethod::RepairLocalEnvironmentDependency, DesktopProductControlMethod::ResolveRuntimeBaselineReadiness, DesktopProductControlMethod::MintRuntimeBaselineReadiness, DesktopProductControlMethod::ResolveFirstRunExecutionEvidence, DesktopProductControlMethod::MintFirstRunExecutionEvidence, DesktopProductControlMethod::GetProductControlRecord, DesktopProductControlMethod::GetProductControlSelectedDataRoot, DesktopProductControlMethod::EnsureProductControlRecordCreated, DesktopProductControlMethod::SelectProductControlDataRoot, DesktopProductControlMethod::SetProductControlFirstRunInstallLevel, DesktopProductControlMethod::CompleteProductControlFirstRunDeviceEnvironmentScan, DesktopProductControlMethod::AdmitProductControlReadyForUse, DesktopProductControlMethod::RecordProductControlAccountDefaultProfileEvidence, DesktopProductControlMethod::RecordProductControlFirstRunLocalAiReadyEvidence, DesktopProductControlMethod::ReconcileProductControlFirstRunSetupState];

#[rustfmt::skip]
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum DesktopRuntimeConsumerMethod { ListLocalAssets, ListNodeCatalog, CheckLocalAssetHealth, ListConnectors, GetRuntimeHealth, ListAiProviderHealth, ListDesktopAuditEvents, ListUsageStats, PeekScheduling, ExecuteScenario, ListAgents }
...
#[rustfmt::skip]
pub const ORDINARY_DESKTOP_RUNTIME_CONSUMER_V1_METHODS: &[DesktopRuntimeConsumerMethod] = &[DesktopRuntimeConsumerMethod::ListLocalAssets, DesktopRuntimeConsumerMethod::ListNodeCatalog, DesktopRuntimeConsumerMethod::CheckLocalAssetHealth, DesktopRuntimeConsumerMethod::ListConnectors, DesktopRuntimeConsumerMethod::GetRuntimeHealth, DesktopRuntimeConsumerMethod::ListAiProviderHealth, DesktopRuntimeConsumerMethod::ListDesktopAuditEvents, DesktopRuntimeConsumerMethod::ListUsageStats, DesktopRuntimeConsumerMethod::PeekScheduling, DesktopRuntimeConsumerMethod::ExecuteScenario, DesktopRuntimeConsumerMethod::ListAgents];
    ...
    pub fn from_method_id(method_id: &str) -> Option<Self> {
        Some(match method_id {
            ...
            "/nimi.runtime.v1.RuntimeAgentService/UpsertDelegatedProviderProfile" => {
                Self::UpsertDelegatedProviderProfile
            }
            "/nimi.runtime.v1.RuntimeAgentService/SetDelegatedProviderState" => {
                Self::SetDelegatedProviderState
            }
...
#[rustfmt::skip]
pub const DESKTOP_ACCOUNT_PRODUCT_STREAM_METHODS: &[DesktopAccountProductStreamMethod] = &[DesktopAccountProductStreamMethod::SubscribeRuntimeAgentAiConfigReadiness, DesktopAccountProductStreamMethod::SubscribeAppMessages, DesktopAccountProductStreamMethod::SubscribeAgentEvents];
