...
impl DesktopMachineProductUnaryMethod {
    pub fn from_method_id(method_id: &str) -> Option<Self> {
        Some(match method_id {
            ...
            "/nimi.runtime.v1.RuntimeAppPackageService/PrepareLocalAppPackage" => Self::PrepareLocalAppPackage,
            "/nimi.runtime.v1.RuntimeAppPackageService/DiscardLocalAppPackage" => Self::DiscardLocalAppPackage,
            "/nimi.runtime.v1.RuntimeAppPackageService/StartLocalAppPackageInstall" => Self::StartLocalAppPackageInstall,
            "/nimi.runtime.v1.RuntimeAppPackageService/StartLocalAppPackageUpdate" => Self::StartLocalAppPackageUpdate,
            "/nimi.runtime.v1.RuntimeAppPackageService/StartAppPackageUpdate" => Self::StartAppPackageUpdate,
            ...
            "/nimi.runtime.v1.RuntimeAppPackageService/GetAppPackageInfo" => Self::GetAppPackageInfo,
            ...
            "/nimi.runtime.v1.RuntimeAppPackageService/PauseAppPackageJob" => Self::PauseAppPackageJob,
            "/nimi.runtime.v1.RuntimeAppPackageService/ResumeAppPackageJob" => Self::ResumeAppPackageJob,
            "/nimi.runtime.v1.RuntimeAppPackageService/ReorderAppPackageJob" => Self::ReorderAppPackageJob,
            _ => return None,
        })
    }
    ...
    pub const fn method_id(self) -> &'static str {
        match self {
            ...
            Self::PrepareLocalAppPackage => "/nimi.runtime.v1.RuntimeAppPackageService/PrepareLocalAppPackage",
            Self::DiscardLocalAppPackage => "/nimi.runtime.v1.RuntimeAppPackageService/DiscardLocalAppPackage",
            Self::StartLocalAppPackageInstall => "/nimi.runtime.v1.RuntimeAppPackageService/StartLocalAppPackageInstall",
            Self::StartLocalAppPackageUpdate => "/nimi.runtime.v1.RuntimeAppPackageService/StartLocalAppPackageUpdate",
            Self::StartAppPackageUpdate => "/nimi.runtime.v1.RuntimeAppPackageService/StartAppPackageUpdate",
            ...
            Self::GetAppPackageInfo => "/nimi.runtime.v1.RuntimeAppPackageService/GetAppPackageInfo",
...
impl DesktopAccountProductUnaryMethod {
    pub fn from_method_id(method_id: &str) -> Option<Self> {
        Some(match method_id {
            ...
            "/nimi.runtime.v1.RuntimeAgentService/ResolveDesktopAgentReference" => {
                Self::ResolveDesktopAgentReference
            }
    ...
    pub const fn method_id(self) -> &'static str {
        match self {
            ...
            Self::PutAppActivity => "/nimi.runtime.v1.RuntimeAppActivityService/PutAppActivity",
            Self::ListAppActivities => {
                "/nimi.runtime.v1.RuntimeAppActivityService/ListAppActivities"
            }
            Self::MarkAppActivityRead => {
...
#[rustfmt::skip]
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum DesktopAccountProductStreamMethod { StreamScenario, SubscribeAppMessages, WriteLocalAppAsset, ReadLocalAppAsset, StreamLocalAppTextTurn, SubscribeLocalAppScenarioJobEvents, SubscribeRealmRealtimeEvents, ReadRealtimeEvents, SubscribeLocalAppAgentRealtimeEvents, SubscribeLocalAppConversationEvents, SubscribeLocalAppEmbodimentEvents, SubscribeAppActivityChanges, OpenAppActivity, SubscribeAppActivityOpenRequests }
...
impl DesktopAccountProductStreamMethod {
    pub fn from_method_id(method_id: &str) -> Option<Self> {
        Some(match method_id {
            ...
            "/nimi.runtime.v1.RuntimeAppActivityService/SubscribeAppActivityChanges" => {
                Self::SubscribeAppActivityChanges
            }
            "/nimi.runtime.v1.RuntimeAppActivityService/OpenAppActivity" => Self::OpenAppActivity,
            "/nimi.runtime.v1.RuntimeAppActivityService/SubscribeAppActivityOpenRequests" => {
                Self::SubscribeAppActivityOpenRequests
            }
            _ => return None,
        })
    }
    ...
    pub const fn method_id(self) -> &'static str {
        match self {
            ...
            Self::OpenAppActivity => "/nimi.runtime.v1.RuntimeAppActivityService/OpenAppActivity",
            Self::SubscribeAppActivityOpenRequests => {
                "/nimi.runtime.v1.RuntimeAppActivityService/SubscribeAppActivityOpenRequests"
            }
        }
...
pub fn bundled_avatar_method_profile(method_id: &str) -> Option<BundledAvatarMethodProfile> {
    match method_id {
        ...
        "/nimi.runtime.v1.RuntimeAiVideoSessionService/OpenVideoSession" => Some(BundledAvatarMethodProfile { method_id: "/nimi.runtime.v1.RuntimeAiVideoSessionService/OpenVideoSession", kind: BundledAvatarMethodKind::Unary, capability: "runtime.consume" }),
        "/nimi.runtime.v1.RuntimeAiVideoSessionService/SubmitVideoSessionFrame" => Some(BundledAvatarMethodProfile { method_id: "/nimi.runtime.v1.RuntimeAiVideoSessionService/SubmitVideoSessionFrame", kind: BundledAvatarMethodKind::Unary, capability: "runtime.consume" }),
        "/nimi.runtime.v1.RuntimeAiVideoSessionService/ReadVideoSessionResult" => Some(BundledAvatarMethodProfile { method_id: "/nimi.runtime.v1.RuntimeAiVideoSessionService/ReadVideoSessionResult", kind: BundledAvatarMethodKind::Unary, capability: "runtime.consume" }),
        "/nimi.runtime.v1.RuntimeAiVideoSessionService/CloseVideoSession" => Some(BundledAvatarMethodProfile { method_id: "/nimi.runtime.v1.RuntimeAiVideoSessionService/CloseVideoSession", kind: BundledAvatarMethodKind::Unary, capability: "runtime.consume" }),
