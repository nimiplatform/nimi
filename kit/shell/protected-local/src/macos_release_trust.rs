...
use crate::macos_profile::{
    ...
    IDENTITY_CLASS, RECORD_ROOT, RECORD_SCHEMA_VERSION, REQUIRED_ARCHITECTURE,
    REQUIRE_NOTARIZATION, REQUIRE_TRUSTED_ANCHOR, ROOT_KEY_ID, ROOT_PUBLIC_KEY_B64URL,
    RUNTIME_SERVICE_PRINCIPAL, RUNTIME_SIGNING_IDENTIFIER, RUNTIME_TRUST_SET_ID,
    SIGNATURE_ALGORITHM, SIGNER_POLICY_ID,
};
