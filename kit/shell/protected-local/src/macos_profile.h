...
#define NIMI_MACOS_RUNTIME_ACCOUNT ""
#define NIMI_MACOS_RUNTIME_SOCKET_DIRECTORY ""
#define NIMI_MACOS_RUNTIME_SOCKET ""
#define NIMI_MACOS_LOCAL_APP_SOCKET ""
#define NIMI_MACOS_RUNTIME_EXECUTABLE ""
#define NIMI_MACOS_DESKTOP_APPLICATION ""
#define NIMI_MACOS_LOCAL_APP_HOST ""
#define NIMI_MACOS_LAUNCHD_PLIST ""
#define NIMI_MACOS_SMAPP_PLIST ""
#elif defined(NIMI_MACOS_LOCAL_DEVELOPMENT)
