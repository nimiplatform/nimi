...
export const TAURI_STANDARD_COMMAND_ALIASES: Readonly<Record<string, string>> = {
  ...
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldCreationEligibilityGet']]: 'local_app_realm_world_creation_eligibility_get',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldCoreGet']]: 'local_app_realm_world_core_get',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldCoreReplace']]: 'local_app_realm_world_core_replace',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldCharacterList']]: 'local_app_realm_world_character_list',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldCharacterGet']]: 'local_app_realm_world_character_get',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldCharacterCreate']]: 'local_app_realm_world_character_create',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldCharacterReplace']]: 'local_app_realm_world_character_replace',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldEntityList']]: 'local_app_realm_world_entity_list',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldEntityGet']]: 'local_app_realm_world_entity_get',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldEntityCreate']]: 'local_app_realm_world_entity_create',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldRelationshipList']]: 'local_app_realm_world_relationship_list',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.realmWorldRelationshipGet']]: 'local_app_realm_world_relationship_get',
  ...
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.agentManagerSnapshot']]: 'local_app_agent_manager_snapshot',
  ...
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.agentMemoryForget']]: 'local_app_agent_memory_forget',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.agentMemorySwitch']]: 'local_app_agent_memory_switch',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.agentMemoryDelete']]: 'local_app_agent_memory_delete',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.embodimentSnapshot']]: 'local_app_embodiment_snapshot',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.embodimentSubscribe']]: 'local_app_embodiment_subscribe',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.activityPut']]: 'local_app_activity_put',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.activityList']]: 'local_app_activity_list',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.activitySubscribe']]: 'local_app_activity_subscribe',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.activityMarkRead']]: 'local_app_activity_mark_read',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.activityOpen']]: 'local_app_activity_open',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.activityOpenRequestsSubscribe']]: 'local_app_activity_open_requests_subscribe',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.activityOpenRequestComplete']]: 'local_app_activity_open_request_complete',
