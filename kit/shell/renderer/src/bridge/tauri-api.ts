...
export const TAURI_STANDARD_COMMAND_ALIASES: Readonly<Record<string, string>> = {
  ...
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.sharedAgentAIProfilePreview']]: 'local_app_shared_agent_ai_profile_preview',
  [NIMI_STANDARD_SHELL_COMMANDS['local-app.sharedAgentAIProfileApply']]: 'local_app_shared_agent_ai_profile_apply',
