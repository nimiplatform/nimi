...
use nimi_shell_protected_local::{
    ...
    LocalAppAgentHandleRequest, LocalAppAgentRealtimeAppendInputRequest,
    ...
    LocalAppScenarioSubmitRequest, LocalAppScenarioUploadArtifactRequest, LocalAppSessionStatus,
