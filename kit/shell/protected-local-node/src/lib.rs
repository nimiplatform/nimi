...
use nimi_shell_protected_local::{
    ...
    LocalAppAgentMemoryForgetRequest, LocalAppAgentMemorySwitchRequest,
    ...
    LocalAppAssetStatRequest, LocalAppAssetWriteRequest, LocalAppConversationArtifactReadRequest,
