...
export const NIMI_STANDARD_SHELL_CAPABILITIES = [
  ...
  },
  {
    ...
    operations: [
      ...
      { id: 'agentConfigurationSnapshot', command: 'nimi.shell.localApp.agentConfigurationSnapshot', negativeStates: ['protected-carrier-required', 'runtime-service-unavailable', 'runtime-service-untrusted', 'runtime-service-error-unclassified', 'runtime-unauthenticated', 'process-replaced', 'account-changed', 'runtime-restarted', 'permission-unavailable', 'permission-denied', 'permission-revoked', 'invalid-payload'] },
      { id: 'agentUpdateConfiguration', command: 'nimi.shell.localApp.agentUpdateConfiguration', negativeStates: ['protected-carrier-required', 'runtime-service-unavailable', 'runtime-service-untrusted', 'runtime-service-error-unclassified', 'runtime-unauthenticated', 'process-replaced', 'account-changed', 'runtime-restarted', 'permission-unavailable', 'permission-denied', 'permission-revoked', 'invalid-payload'] },
      { id: 'agentReadinessSnapshot', command: 'nimi.shell.localApp.agentReadinessSnapshot', negativeStates: ['protected-carrier-required', 'runtime-service-unavailable', 'runtime-service-untrusted', 'runtime-service-error-unclassified', 'runtime-unauthenticated', 'process-replaced', 'account-changed', 'runtime-restarted', 'permission-unavailable', 'permission-denied', 'permission-revoked', 'invalid-payload'] },
      { id: 'agentAIProfilePreview', command: 'nimi.shell.localApp.agentAIProfilePreview', negativeStates: ['protected-carrier-required', 'runtime-service-unavailable', 'runtime-service-untrusted', 'runtime-service-error-unclassified', 'runtime-unauthenticated', 'process-replaced', 'account-changed', 'runtime-restarted', 'permission-unavailable', 'permission-denied', 'permission-revoked', 'invalid-payload'] },
      { id: 'agentAIProfileApply', command: 'nimi.shell.localApp.agentAIProfileApply', negativeStates: ['protected-carrier-required', 'runtime-service-unavailable', 'runtime-service-untrusted', 'runtime-service-error-unclassified', 'runtime-unauthenticated', 'process-replaced', 'account-changed', 'runtime-restarted', 'permission-unavailable', 'permission-denied', 'permission-revoked', 'invalid-payload'] },
