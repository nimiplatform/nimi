...
export const NIMI_STANDARD_SHELL_CAPABILITIES = [
  ...
  },
  {
    ...
    operations: [
      ...
      { id: 'conversationToolCallsList', command: 'nimi.shell.localApp.conversationToolCallsList', negativeStates: ['protected-carrier-required', 'runtime-service-unavailable', 'runtime-service-untrusted', 'runtime-service-error-unclassified', 'runtime-unauthenticated', 'process-replaced', 'account-changed', 'runtime-restarted', 'invalid-payload', 'resource-exhausted', 'host-internal-error'] },
      { id: 'conversationToolResultSubmit', command: 'nimi.shell.localApp.conversationToolResultSubmit', negativeStates: ['protected-carrier-required', 'runtime-service-unavailable', 'runtime-service-untrusted', 'runtime-service-error-unclassified', 'runtime-unauthenticated', 'process-replaced', 'account-changed', 'runtime-restarted', 'invalid-payload', 'resource-exhausted', 'host-internal-error'] },
