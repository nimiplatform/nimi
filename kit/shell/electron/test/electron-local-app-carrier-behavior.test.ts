...
const FINAL_LOCAL_APP_COMMANDS = [
  ...
  'nimi.shell.localApp.agentWorkGet',
  'nimi.shell.localApp.agentWorkStatus',
  'nimi.shell.localApp.agentWorkToolCallsList',
  'nimi.shell.localApp.agentWorkToolResultSubmit',
  'nimi.shell.localApp.agentWorkCancel',
  'nimi.shell.localApp.agentWorkSubscribe',
  'nimi.shell.localApp.integrationListCatalog',
  'nimi.shell.localApp.integrationListConnections',
  'nimi.shell.localApp.integrationInvoke',
  'nimi.shell.localApp.integrationGetCall',
  'nimi.shell.localApp.integrationListCalls',
  'nimi.shell.localApp.integrationCancelCall',
  'nimi.shell.localApp.integrationRegisterProvider',
  'nimi.shell.localApp.integrationUnregisterProvider',
  'nimi.shell.localApp.integrationPollProvider',
  'nimi.shell.localApp.integrationCompleteProvider',
  'nimi.shell.localApp.integrationGetManagement',
  'nimi.shell.localApp.integrationPutConnection',
  'nimi.shell.localApp.integrationRemoveConnection',
  'nimi.shell.localApp.integrationSetPermission',
