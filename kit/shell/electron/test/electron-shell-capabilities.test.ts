...
describe('Electron standard shell capability catalog', () => {
  ...
  it('admits the exact final local-app command set', () => {
    ...
    expect(localAppSet?.allowedCommands).toEqual([
      ...
      'nimi.shell.localApp.conversationVoiceRender',
      ...
      'nimi.shell.localApp.videoSessionOpen',
      'nimi.shell.localApp.videoSessionSubmit',
      'nimi.shell.localApp.videoSessionRead',
      'nimi.shell.localApp.videoSessionClose',
      'nimi.shell.localApp.aiRealtimeAppendInput',
      'nimi.shell.localApp.aiRealtimeSubmitOwnerControl',
      'nimi.shell.localApp.aiRealtimeSubscribe',
      'nimi.shell.localApp.aiRealtimeInterruptOutput',
      'nimi.shell.localApp.aiRealtimeClose',
      'nimi.shell.localApp.agentRealtimeOpen',
      'nimi.shell.localApp.agentRealtimeAppendInput',
      'nimi.shell.localApp.agentRealtimeSubscribe',
      'nimi.shell.localApp.agentRealtimeStatus',
      'nimi.shell.localApp.agentRealtimeInterruptOutput',
      'nimi.shell.localApp.agentRealtimeClose',
      'nimi.shell.localApp.activityPut',
      'nimi.shell.localApp.activityList',
      'nimi.shell.localApp.activitySubscribe',
      'nimi.shell.localApp.activityMarkRead',
      'nimi.shell.localApp.activityOpen',
      'nimi.shell.localApp.activityOpenRequestsSubscribe',
      'nimi.shell.localApp.activityOpenRequestComplete',
      ...
      'nimi.shell.localApp.agentPresentationReadAsset',
      ...
      'nimi.shell.localApp.realmWorldCreationEligibilityGet',
      'nimi.shell.localApp.realmWorldCoreGet',
      'nimi.shell.localApp.realmWorldCoreReplace',
      'nimi.shell.localApp.realmWorldCharacterList',
      'nimi.shell.localApp.realmWorldCharacterGet',
      'nimi.shell.localApp.realmWorldCharacterCreate',
      'nimi.shell.localApp.realmWorldCharacterReplace',
      'nimi.shell.localApp.realmWorldEntityList',
      'nimi.shell.localApp.realmWorldEntityGet',
      'nimi.shell.localApp.realmWorldEntityCreate',
      'nimi.shell.localApp.realmWorldRelationshipList',
      'nimi.shell.localApp.realmWorldRelationshipGet',
      ...
      'nimi.shell.localApp.realmChatList',
      'nimi.shell.localApp.realmRealtimeOpen',
      'nimi.shell.localApp.realmRealtimeSubscribe',
      'nimi.shell.localApp.realmRealtimeAck',
      'nimi.shell.localApp.realmRealtimeSubscriptionClose',
      'nimi.shell.localApp.realmRealtimeChannelClose',
