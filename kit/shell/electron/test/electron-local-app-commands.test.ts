...
function localAppHost(calls: unknown[]) {
  return {
    ...
    agentWorkReferenceList: async () => ({}),
    agentWorkStart: async () => ({}),
    agentWorkGet: async () => ({}),
    agentWorkStatus: async () => ({}),
    agentWorkToolCallsList: async () => ({}),
    agentWorkToolResultSubmit: async () => ({}),
    agentWorkCancel: async () => ({}),
    agentWorkSubscribe: async () => ({}),
    integrationListCatalog: async () => ({}),
    integrationListConnections: async () => ({}),
    integrationInvoke: async () => ({}),
    integrationGetCall: async () => ({}),
    integrationListCalls: async () => ({}),
    integrationCancelCall: async () => ({}),
    integrationRegisterProvider: async () => ({}),
    integrationUnregisterProvider: async () => ({}),
    integrationPollProvider: async () => ({}),
    integrationCompleteProvider: async () => ({}),
    integrationGetManagement: async () => ({}),
