    ...
    fn local_app_carrier_behavior() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "local_app_realm_world_core_get",
                "local_app_realm_world_core_replace",
                "local_app_realm_world_character_list",
                "local_app_realm_world_character_get",
                "local_app_realm_world_character_create",
                "local_app_realm_world_character_replace",
                "local_app_realm_world_entity_list",
                "local_app_realm_world_entity_get",
                "local_app_realm_world_entity_create",
                "local_app_realm_world_relationship_list",
                "local_app_realm_world_relationship_get",
                ...
                "local_app_activity_put",
                "local_app_activity_list",
                "local_app_activity_subscribe",
                "local_app_activity_mark_read",
                "local_app_activity_open",
                "local_app_activity_open_requests_subscribe",
                "local_app_activity_open_request_complete",
                "local_app_agent_autonomy_snapshot",
                "local_app_agent_update_autonomy",
                "local_app_agent_presentation_snapshot",
                "local_app_agent_presentation_read_asset",
