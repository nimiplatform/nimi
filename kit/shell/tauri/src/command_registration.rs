...
pub const LOCAL_APP_COMMANDS: &[ShellCommandDescriptor] = &[
    ...
    ShellCommandDescriptor { command_name: "local_app_realm_world_creation_eligibility_get", rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_creation_eligibility_get", boundary: ShellCommandBoundary::LocalApp },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_core_get",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_core_get",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_core_replace",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_core_replace",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_character_list",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_character_list",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_character_get",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_character_get",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_character_create",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_character_create",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_character_replace",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_character_replace",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_entity_list",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_entity_list",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_entity_get",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_entity_get",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_entity_create",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_entity_create",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_relationship_list",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_relationship_list",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_realm_world_relationship_get",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_realm_world_relationship_get",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
    ...
    ShellCommandDescriptor {
        command_name: "local_app_agent_update_autonomy",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_agent_update_autonomy",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_agent_presentation_snapshot",
        rust_path:
            "nimi_shell_tauri::capabilities::local_app::local_app_agent_presentation_snapshot",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
    ...
    ShellCommandDescriptor {
        command_name: "local_app_artifact_upload",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_artifact_upload",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_stat",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_stat",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_list",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_list",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_write_open",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_write_open",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_write_chunk",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_write_chunk",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_write_commit",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_write_commit",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_write_abort",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_write_abort",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_read_open",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_read_open",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_read_next",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_read_next",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_read_close",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_read_close",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_remove",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_remove",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
        command_name: "local_app_asset_move",
        rust_path: "nimi_shell_tauri::capabilities::local_app::local_app_asset_move",
        boundary: ShellCommandBoundary::LocalApp,
    },
    ShellCommandDescriptor {
...
macro_rules! nimi_shell_tauri_local_app_standard_shell_handler {
    ($($app_command:path),* $(,)?) => {
        tauri::generate_handler![
            ...
            $crate::capabilities::local_app::local_app_realm_world_creation_eligibility_get,
            $crate::capabilities::local_app::local_app_realm_world_core_get,
            $crate::capabilities::local_app::local_app_realm_world_core_replace,
            $crate::capabilities::local_app::local_app_realm_world_character_list,
            $crate::capabilities::local_app::local_app_realm_world_character_get,
            $crate::capabilities::local_app::local_app_realm_world_character_create,
            $crate::capabilities::local_app::local_app_realm_world_character_replace,
            $crate::capabilities::local_app::local_app_realm_world_entity_list,
            $crate::capabilities::local_app::local_app_realm_world_entity_get,
            $crate::capabilities::local_app::local_app_realm_world_entity_create,
            $crate::capabilities::local_app::local_app_realm_world_relationship_list,
            $crate::capabilities::local_app::local_app_realm_world_relationship_get,
            ...
            $crate::capabilities::local_app::local_app_asset_list,
            $crate::capabilities::local_app::local_app_asset_write_open,
            $crate::capabilities::local_app::local_app_asset_write_chunk,
            $crate::capabilities::local_app::local_app_asset_write_commit,
            $crate::capabilities::local_app::local_app_asset_write_abort,
            $crate::capabilities::local_app::local_app_asset_read_open,
            $crate::capabilities::local_app::local_app_asset_read_next,
