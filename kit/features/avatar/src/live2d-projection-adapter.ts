...
//   - .nimi/spec/avatar/embodiment-surface.authority.yaml (re-anchor)
...
import { activityIdToMotionGroup } from './avatar-activity-naming.js';
import type { BackendProjection } from './backend-branch.js';
...
function emitMotion(
  ...
  const event: Live2DProjectionCommandEvent = {
    kind: 'motion',
    group,
    options: { priority },
  };
