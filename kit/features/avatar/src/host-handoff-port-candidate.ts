...
function parseTarget(value: unknown): AvatarHostHandoffTarget {
  ...
  return Object.freeze({
    agentHandle,
    conversationAnchorId: requiredText(target.conversationAnchorId, 'conversationAnchorId'),
...
// Candidate stays internal until the WP6 replacement-first handoff cut.
