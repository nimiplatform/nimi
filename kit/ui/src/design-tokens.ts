...
export type NimiAccentPack = 'desktop-accent' | 'forge-accent' | 'relay-accent' | 'overtone-accent' | 'video-food-map-accent';
...
export const NIMI_ACCENT_PACKS = ['desktop-accent', 'forge-accent', 'relay-accent', 'overtone-accent', 'video-food-map-accent'] as const;
