...
16. `nimi-mods/narrative-engine/spec/INDEX.md`（UPDATE）
...
1. `nimi-mods/narrative-engine/spec/kernel/run-orchestration-contract.md`
2. `nimi-mods/narrative-engine/spec/kernel/tables/run-states.yaml`
3. `nimi-mods/narrative-engine/spec/kernel/tables/reason-codes.yaml`
4. `nimi-mods/narrative-engine/spec/kernel/tables/acceptance-cases.yaml`
