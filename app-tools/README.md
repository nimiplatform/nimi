...
The publisher GitHub Release stage is available for configured repositories.
Registry review, Runtime installation, and Desktop launch are separate owner
stages:
