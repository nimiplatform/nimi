...
export const APP_SCAFFOLD_MODULE_REGISTRY = Object.freeze({
  ...
  'studio-media': frozenModule({
    ...
    appAccessItems: ['runtime.consume'],
    capabilityContractRefs: ['image.generate', 'video.generate', 'music.generate', 'music.transcribe'],
    requiredStandardizedFeatureRefs: [],
    npmDependencies: {},
    cargoDependencies: {},
    hostAdapterContract: 'ai-studio-host-v1',
    views: ['image.generate', 'video.generate', 'music.generate', 'music.transcribe'],
    navigation: ['image.generate', 'video.generate', 'music.generate', 'music.transcribe'],
    styles: [],
    assets: [],
    productEntry: Object.freeze({
      kind: 'ai-studio-module',
