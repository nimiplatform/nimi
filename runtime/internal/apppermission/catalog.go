...
var operationPermissions = map[string]string{
	...
	"runtime_agent.shared_ai_config.get":        "agents.configure",
	"runtime_agent.shared_ai_config.overwrite":  "agents.configure",
	"runtime_agent.shared_ai_profile.preview":   "agents.configure",
	"runtime_agent.shared_ai_profile.apply":     "agents.configure",
