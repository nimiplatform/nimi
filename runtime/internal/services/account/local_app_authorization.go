...
const (
	...
	LocalAppOperationRealmWorldCreationEligibilityGet = localappop.OperationRealmWorldCreationEligibilityGet
	LocalAppOperationRealmWorldCoreGet                = localappop.OperationRealmWorldCoreGet
	LocalAppOperationRealmWorldCoreReplace            = localappop.OperationRealmWorldCoreReplace
	LocalAppOperationRealmWorldCharacterList          = localappop.OperationRealmWorldCharacterList
	LocalAppOperationRealmWorldCharacterGet           = localappop.OperationRealmWorldCharacterGet
	LocalAppOperationRealmWorldCharacterCreate        = localappop.OperationRealmWorldCharacterCreate
	LocalAppOperationRealmWorldCharacterReplace       = localappop.OperationRealmWorldCharacterReplace
	LocalAppOperationRealmWorldEntityList             = localappop.OperationRealmWorldEntityList
	LocalAppOperationRealmWorldEntityGet              = localappop.OperationRealmWorldEntityGet
	LocalAppOperationRealmWorldEntityCreate           = localappop.OperationRealmWorldEntityCreate
	LocalAppOperationRealmWorldRelationshipList       = localappop.OperationRealmWorldRelationshipList
	LocalAppOperationRealmWorldRelationshipGet        = localappop.OperationRealmWorldRelationshipGet
