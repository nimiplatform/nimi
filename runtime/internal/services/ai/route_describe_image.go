...
func executeImageGenerateRouteDescribeScenario(
	...
	if err := s.writeImageGenerateRouteDescribeHeader(ctx, probe, effective.modelResolved(), effective.catalogTarget, s.cloudTextProvider); err != nil {
		return nil, err
	}
