...
func defaultVerifiedAssets() []*runtimev1.LocalVerifiedAssetDescriptor {
	...
	runnable := []*runtimev1.LocalVerifiedAssetDescriptor{
		...
		{
			TemplateId:     "verified.stt.qwen3_asr",
			Title:          "Qwen3 ASR 0.6B",
			Description:    "Default local speech-to-text model for first-wave admission",
			InstallKind:    "download",
			AssetId:        "local/qwen3-asr",
			...
			FileCount:       1,
			TotalSizeBytes:  0,
			Tags:            []string{"stt", "verified", "recommended", "default"},
			ArtifactRoles:   []string{"stt_model", "tokenizer"},
			PreferredEngine: "speech",
		},
		{
			TemplateId:      "verified.tts.qwen3_tts",
			Title:           "Qwen3 TTS CustomVoice 0.6B",
			Description:     "Default local speech synthesis lane for first-wave admission",
			...
			FileCount:       2,
			TotalSizeBytes:  0,
			Tags:            []string{"tts", "voice", "verified", "recommended", "default"},
			ArtifactRoles:   []string{"tts_model", "speech_tokenizer", "tokenizer"},
			PreferredEngine: "speech",
		},
		{
			TemplateId:      "verified.voice.qwen3_tts_base",
			Title:           "Qwen3 TTS Base 0.6B",
			Description:     "Admitted local voice clone target for first-wave speech workflow execution",
			InstallKind:     "verified-hf-multi-file",
			AssetId:         "local/qwen3-tts-base",
			...
			FileCount:       2,
			TotalSizeBytes:  0,
			Tags:            []string{"tts", "voice", "verified", "workflow", "clone"},
			ArtifactRoles:   []string{"tts_model", "speech_tokenizer", "tokenizer"},
			PreferredEngine: "speech",
		},
		{
			TemplateId:      "verified.voice.qwen3_tts_voicedesign",
			Title:           "Qwen3 TTS VoiceDesign 1.7B",
			Description:     "Admitted local voice design target for first-wave speech workflow execution",
			InstallKind:     "verified-hf-multi-file",
			AssetId:         "local/qwen3-tts-voicedesign",
			...
			FileCount:       2,
			TotalSizeBytes:  0,
			Tags:            []string{"tts", "voice", "verified", "workflow", "design"},
			ArtifactRoles:   []string{"tts_model", "speech_tokenizer", "tokenizer"},
			PreferredEngine: "speech",
		},
		{
