...
func TestCanonicalAppOperationContractIsExactUniqueAndExplicit(t *testing.T) {
	...
	want := []expectedRow{
		{id: "runtime.agent.work.reference.list", class: AuthorityClassAppAccess, domain: "agent.work"},
		{id: "runtime.agent.work.start", class: AuthorityClassAppAccess, domain: "agent.work"},
		{id: "runtime.agent.work.get", class: AuthorityClassAppAccess, domain: "agent.work"},
		{id: "runtime.agent.work.status.get", class: AuthorityClassAppAccess, domain: "agent.work"},
		{id: "runtime.agent.work.tool-calls.list", class: AuthorityClassAppAccess, domain: "agent.work"},
		{id: "runtime.agent.work.tool-result.submit", class: AuthorityClassAppAccess, domain: "agent.work"},
		{id: "runtime.agent.work.cancel", class: AuthorityClassAppAccess, domain: "agent.work"},
		{id: "runtime.agent.work.events.subscribe", class: AuthorityClassAppAccess, domain: "agent.work"},
		{id: "runtime.integration.catalog.list", class: AuthorityClassAppAccess, domain: "integration.consume"},
		{id: "runtime.integration.connection.list", class: AuthorityClassAppAccess, domain: "integration.consume"},
		{id: "runtime.integration.call.invoke", class: AuthorityClassAppAccess, domain: "integration.consume"},
		{id: "runtime.integration.call.get", class: AuthorityClassAppAccess, domain: "integration.consume"},
		{id: "runtime.integration.call.list", class: AuthorityClassAppAccess, domain: "integration.consume"},
		{id: "runtime.integration.call.cancel", class: AuthorityClassAppAccess, domain: "integration.consume"},
		{id: "runtime.integration.provider.register", class: AuthorityClassAppAccess, domain: "integration.provide"},
		{id: "runtime.integration.provider.unregister", class: AuthorityClassAppAccess, domain: "integration.provide"},
		{id: "runtime.integration.provider.poll", class: AuthorityClassAppAccess, domain: "integration.provide"},
		{id: "runtime.integration.provider.complete", class: AuthorityClassAppAccess, domain: "integration.provide"},
		{id: "runtime.integration.management.get", class: AuthorityClassAppAccess, domain: "integration.manage"},
		...
		{id: "realm.world-core.creation-eligibility.get", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-core.get", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-core.replace", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-character.list", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-character.get", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-character.create", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-character.replace", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-entity.list", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-entity.get", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-entity.create", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-relationship.list", class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: "realm.world-relationship.get", class: AuthorityClassAppAccess, domain: "realm.data"},
		...
		{id: AppOperationIDRealmChatList, class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: AppOperationIDRealmRealtimeChannelOpen, class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: AppOperationIDRealmRealtimeEventsSubscribe, class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: AppOperationIDRealmRealtimeEventsAck, class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: AppOperationIDRealmRealtimeSubscriptionClose, class: AuthorityClassAppAccess, domain: "realm.data"},
		{id: AppOperationIDRealmRealtimeChannelClose, class: AuthorityClassAppAccess, domain: "realm.data"},
		...
		{id: AppOperationIDAIRealtimeEventsRead, class: AuthorityClassAppAccess, domain: "runtime.consume"},
		{id: AppOperationIDAIRealtimeOutputInterrupt, class: AuthorityClassAppAccess, domain: "runtime.consume"},
		{id: AppOperationIDAIRealtimeClose, class: AuthorityClassAppAccess, domain: "runtime.consume"},
		{id: AppOperationIDVideoSessionOpen, class: AuthorityClassAppAccess, domain: "runtime.consume"},
		{id: AppOperationIDVideoSessionFrameSubmit, class: AuthorityClassAppAccess, domain: "runtime.consume"},
		{id: AppOperationIDVideoSessionResultRead, class: AuthorityClassAppAccess, domain: "runtime.consume"},
		{id: AppOperationIDVideoSessionClose, class: AuthorityClassAppAccess, domain: "runtime.consume"},
		{id: AppOperationIDAgentRealtimeOpen, class: AuthorityClassAppAccess, domain: "agent.local"},
		{id: AppOperationIDAgentRealtimeInputAppend, class: AuthorityClassAppAccess, domain: "agent.local"},
		{id: AppOperationIDAgentRealtimeEventsSubscribe, class: AuthorityClassAppAccess, domain: "agent.local"},
		{id: AppOperationIDAgentRealtimeStatusGet, class: AuthorityClassAppAccess, domain: "agent.local"},
		{id: AppOperationIDAgentRealtimeOutputInterrupt, class: AuthorityClassAppAccess, domain: "agent.local"},
		{id: AppOperationIDAgentRealtimeClose, class: AuthorityClassAppAccess, domain: "agent.local"},
		{id: "runtime.agent.introduction.get", class: AuthorityClassAppAccess, domain: "agent.local"},
