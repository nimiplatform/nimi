...
var operationSpecs = map[Operation]operationSpec{
	...
	OperationSharedAIConfigGet:       {selector: selectorNone, authorityClass: AuthorityClassUserPermission},
	OperationSharedAIConfigOverwrite: {selector: selectorNone, authorityClass: AuthorityClassUserPermission},
	OperationSharedAIProfilePreview:  {selector: selectorNone, authorityClass: AuthorityClassUserPermission},
	OperationSharedAIProfileApply:    {selector: selectorNone, authorityClass: AuthorityClassUserPermission},
