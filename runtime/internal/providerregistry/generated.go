...
var Records = map[string]ProviderRecord{
	...
	"bedrock": {
		...
		InlineSupported: true,
		DefaultEndpoint: "",
		DefaultTextModel: "anthropic.claude-sonnet-4-6-v1:0",
		RequiresExplicitEndpoint: true,
		SupportsText: true,
		SupportsEmbed: false,
		SupportsImage: false,
	...
	"fireworks": {
		...
		InlineSupported: true,
		DefaultEndpoint: "",
		DefaultTextModel: "accounts/fireworks/models/llama4-maverick-instruct-basic",
		RequiresExplicitEndpoint: true,
		SupportsText: true,
		SupportsEmbed: false,
		SupportsImage: false,
	...
	"groq": {
		...
		DefaultTextModel: "meta-llama/llama-4-maverick-17b-128e-instruct",
		RequiresExplicitEndpoint: false,
		SupportsText: true,
		SupportsEmbed: false,
		SupportsImage: false,
	...
	"hunyuan": {
		...
		DefaultTextModel: "hunyuan-turbo",
		RequiresExplicitEndpoint: false,
		SupportsText: true,
		SupportsEmbed: true,
		SupportsImage: true,
	...
	"siliconflow": {
		...
		InlineSupported: true,
		DefaultEndpoint: "",
		DefaultTextModel: "deepseek-ai/DeepSeek-V3",
		RequiresExplicitEndpoint: true,
		SupportsText: true,
		SupportsEmbed: true,
		SupportsImage: false,
	...
	"suno": {
		...
		ManagedConnectorSupported: true,
		InlineSupported: true,
		DefaultEndpoint: "https://apibox.erweima.ai",
		DefaultTextModel: "",
		RequiresExplicitEndpoint: false,
		SupportsText: false,
		SupportsEmbed: false,
	...
	"together": {
		...
		InlineSupported: true,
		DefaultEndpoint: "",
		DefaultTextModel: "meta-llama/Llama-4-Maverick-17B-128E-Instruct-FP8",
		RequiresExplicitEndpoint: true,
		SupportsText: true,
		SupportsEmbed: false,
		SupportsImage: false,
