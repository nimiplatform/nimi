...
var Records = map[string]ProviderRecord{
	...
	"fireworks": {
		...
		DynamicAllowedCapabilities:    []string{"text.generate"},
		DynamicDenyModelPatterns:      nil,
	...
	"groq": {
		...
		DynamicFailurePolicy:          "use_cache_then_fail_closed",
		DynamicAllowedCapabilities:    []string{"text.generate", "audio.transcribe", "audio.synthesize"},
		DynamicDenyModelPatterns:      nil,
		DynamicAllowModelPatterns:     nil,
		DynamicPreferredModelPatterns: nil,
		SupportsText:                  true,
	...
	"openrouter": {
		...
		DynamicSelectionMode:          "pass_through",
		DynamicFailurePolicy:          "use_cache_then_fail_closed",
		DynamicAllowedCapabilities:    []string{"text.generate", "text.embed", "image.generate", "video.generate", "audio.synthesize", "audio.transcribe"},
		DynamicDenyModelPatterns:      nil,
		DynamicAllowModelPatterns:     nil,
		DynamicPreferredModelPatterns: nil,
		SupportsText:                  true,
	...
	"xai": {
		...
		DynamicSelectionMode:          "pass_through",
		DynamicFailurePolicy:          "use_cache_then_fail_closed",
		DynamicAllowedCapabilities:    []string{"text.generate", "image.generate", "video.generate", "audio.synthesize", "audio.transcribe"},
		DynamicDenyModelPatterns:      nil,
		DynamicAllowModelPatterns:     nil,
		DynamicPreferredModelPatterns: nil,
		SupportsText:                  true,
