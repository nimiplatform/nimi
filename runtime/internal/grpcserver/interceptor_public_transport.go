...
var publicTransportBlockedMethods = map[string]runtimev1.ReasonCode{
	...
	"/nimi.runtime.v1.RuntimeAccountService/ListLocalAppPermissionRequests":         runtimev1.ReasonCode_PROTECTED_ORIGIN_ROLE_MISMATCH,
	"/nimi.runtime.v1.RuntimeAccountService/SubscribeLocalAppPermissionRequests":    runtimev1.ReasonCode_PROTECTED_ORIGIN_ROLE_MISMATCH,
	"/nimi.runtime.v1.RuntimeAccountService/GetLocalAppPermissionOwnerProjection":   runtimev1.ReasonCode_PROTECTED_ORIGIN_ROLE_MISMATCH,
	"/nimi.runtime.v1.RuntimeAccountService/ListLocalAppPermissionOwnerProjections": runtimev1.ReasonCode_PROTECTED_ORIGIN_ROLE_MISMATCH,
	"/nimi.runtime.v1.RuntimeAccountService/DecideLocalAppPermission":               runtimev1.ReasonCode_PROTECTED_ORIGIN_ROLE_MISMATCH,
	"/nimi.runtime.v1.RuntimeAccountService/RevokeLocalAppPermission":               runtimev1.ReasonCode_PROTECTED_ORIGIN_ROLE_MISMATCH,
