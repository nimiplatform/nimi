...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		RuntimeID:                             resolveRuntimeID(fileCfg),
		...
		SourceMaterializationPacketHMACSecret: readStringWithFileConfigFallback("SOURCE_MATERIALIZATION_PACKET_HMAC_SECRET", fileCfg.SourceMaterializationPacketHMACSecret, ""),
