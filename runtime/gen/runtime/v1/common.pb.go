...
const (
	...
	ReasonCode_APP_STORAGE_ENTRY_ALREADY_EXISTS ReasonCode = 581
	ReasonCode_APP_STORAGE_OBJECT_TOO_LARGE     ReasonCode = 582
	ReasonCode_APP_STORAGE_RANGE_INVALID        ReasonCode = 583
	...
	ReasonCode_APP_PACKAGE_JOB_NOT_FOUND        ReasonCode = 587
	ReasonCode_APP_PACKAGE_JOB_PHASE_CONFLICT   ReasonCode = 588
	ReasonCode_APP_PACKAGE_JOB_NOT_CANCELABLE   ReasonCode = 589
	// GRANT family (510+)
	...
	ReasonCode_ARTIFACT_UPLOAD_MIME_UNSUPPORTED ReasonCode = 615
	ReasonCode_ARTIFACT_UPLOAD_TOO_LARGE        ReasonCode = 616
	ReasonCode_ARTIFACT_UPLOAD_CONTENT_MISMATCH ReasonCode = 617
	...
	ReasonCode_AGENT_AI_CONFIG_INVALID               ReasonCode = 679
	ReasonCode_AGENT_AI_CONFIG_TARGET_REQUIRED       ReasonCode = 680
	ReasonCode_AGENT_AI_CONFIG_TARGET_INVALID        ReasonCode = 681
	...
	ReasonCode_AI_LOCAL_DRIVER_UNAVAILABLE                    ReasonCode = 688
	ReasonCode_AI_LOCAL_ASSET_NOT_FOUND                       ReasonCode = 689
	ReasonCode_AI_LOCAL_ASSET_CONTENT_UNVERIFIED              ReasonCode = 690
	...
	ReasonCode_AI_LOCAL_SELECTION_NOT_FOUND          ReasonCode = 697
	...
	ReasonCode_AI_LOCAL_EXECUTION_CONTENT_MISMATCH ReasonCode = 705
	...
	ReasonCode_AI_CONFIG_REVISION_CONFLICT ReasonCode = 726
	...
	ReasonCode_AI_FACE_TARGET_AMBIGUOUS            ReasonCode = 741
	ReasonCode_AI_VIDEO_DECODE_FAILED              ReasonCode = 742
	...
	ReasonCode_APP_ACTIVITY_TOO_LARGE                ReasonCode = 757
	ReasonCode_APP_ACTIVITY_PAGE_TOKEN_INVALID       ReasonCode = 758
	ReasonCode_APP_ACTIVITY_CURSOR_EXPIRED           ReasonCode = 759
	ReasonCode_APP_ACTIVITY_AGENT_UNAVAILABLE        ReasonCode = 760
	ReasonCode_APP_ACTIVITY_UNAVAILABLE              ReasonCode = 761
	ReasonCode_APP_ACTIVITY_OPEN_REQUEST_UNAVAILABLE ReasonCode = 762
)
...
var (
	ReasonCode_name = map[int32]string{
		...
		581: "APP_STORAGE_ENTRY_ALREADY_EXISTS",
		582: "APP_STORAGE_OBJECT_TOO_LARGE",
		583: "APP_STORAGE_RANGE_INVALID",
		584: "APP_STORAGE_CURSOR_INVALID",
		585: "APP_STORAGE_INTEGRITY_FAILURE",
		586: "APP_STORAGE_ARTIFACT_UNAVAILABLE",
		587: "APP_PACKAGE_JOB_NOT_FOUND",
		588: "APP_PACKAGE_JOB_PHASE_CONFLICT",
		589: "APP_PACKAGE_JOB_NOT_CANCELABLE",
		...
		615: "ARTIFACT_UPLOAD_MIME_UNSUPPORTED",
		616: "ARTIFACT_UPLOAD_TOO_LARGE",
		617: "ARTIFACT_UPLOAD_CONTENT_MISMATCH",
		...
		679: "AGENT_AI_CONFIG_INVALID",
		680: "AGENT_AI_CONFIG_TARGET_REQUIRED",
		681: "AGENT_AI_CONFIG_TARGET_INVALID",
		682: "AGENT_AI_CONFIG_TARGET_UNAVAILABLE",
		683: "AGENT_AI_CONFIG_CAPABILITY_MISMATCH",
		684: "AGENT_AI_CONFIG_MODEL_TARGET_MISMATCH",
		685: "AI_LOCAL_CONFIGURATION_NOT_FOUND",
		686: "AI_LOCAL_REQUIREMENT_NOT_FOUND",
		687: "AI_LOCAL_BINDING_CONFLICT",
		688: "AI_LOCAL_DRIVER_UNAVAILABLE",
		689: "AI_LOCAL_ASSET_NOT_FOUND",
		690: "AI_LOCAL_ASSET_CONTENT_UNVERIFIED",
		...
		697: "AI_LOCAL_SELECTION_NOT_FOUND",
		...
		705: "AI_LOCAL_EXECUTION_CONTENT_MISMATCH",
		706: "LOCAL_APP_SNAPSHOT_UNAVAILABLE",
		...
		726: "AI_CONFIG_REVISION_CONFLICT",
		727: "APP_PACKAGE_SELECTION_INVALID",
		728: "APP_PACKAGE_SELECTION_STALE",
		729: "APP_PACKAGE_POLICY_BLOCKED",
		730: "APP_PACKAGE_ALREADY_INSTALLED",
		731: "APP_PACKAGE_INSTALL_UNAVAILABLE",
		732: "APP_PACKAGE_JOB_ACTIVE",
		733: "APP_CATALOG_UNAVAILABLE",
		734: "APP_PACKAGE_UNINSTALL_UNAVAILABLE",
		...
		741: "AI_FACE_TARGET_AMBIGUOUS",
		742: "AI_VIDEO_DECODE_FAILED",
		...
		757: "APP_ACTIVITY_TOO_LARGE",
		758: "APP_ACTIVITY_PAGE_TOKEN_INVALID",
		759: "APP_ACTIVITY_CURSOR_EXPIRED",
		760: "APP_ACTIVITY_AGENT_UNAVAILABLE",
		761: "APP_ACTIVITY_UNAVAILABLE",
		762: "APP_ACTIVITY_OPEN_REQUEST_UNAVAILABLE",
	}
...
const file_runtime_v1_common_proto_rawDesc = "" +
	...
	"\x17APP_STORAGE_UNAVAILABLE\x10\xb9\x04\x12%\n" +
	" APP_STORAGE_ENTRY_ALREADY_EXISTS\x10\xc5\x04\x12!\n" +
	"\x1cAPP_STORAGE_OBJECT_TOO_LARGE\x10\xc6\x04\x12\x1e\n" +
	...
	"\x19APP_PACKAGE_JOB_NOT_FOUND\x10\xcb\x04\x12#\n" +
	"\x1eAPP_PACKAGE_JOB_PHASE_CONFLICT\x10\xcc\x04\x12#\n" +
	"\x1eAPP_PACKAGE_JOB_NOT_CANCELABLE\x10\xcd\x04\x12%\n" +
	...
	" ARTIFACT_UPLOAD_MIME_UNSUPPORTED\x10\xe7\x04\x12\x1e\n" +
	"\x19ARTIFACT_UPLOAD_TOO_LARGE\x10\xe8\x04\x12%\n" +
	" ARTIFACT_UPLOAD_CONTENT_MISMATCH\x10\xe9\x04\x12*\n" +
	...
	"\x19LOCAL_APP_SESSION_REVOKED\x10\x8a\x05\x12\x1e\n" +
	...
	"!LOCAL_APP_DEVELOPER_MODE_DISABLED\x10\x92\x05\x12\x16\n" +
	...
	"&AGENT_PRESENTATION_ASSET_NOT_VALIDATED\x10\xa6\x05\x12\x1c\n" +
	"\x17AGENT_AI_CONFIG_INVALID\x10\xa7\x05\x12$\n" +
	"\x1fAGENT_AI_CONFIG_TARGET_REQUIRED\x10\xa8\x05\x12#\n" +
	"\x1eAGENT_AI_CONFIG_TARGET_INVALID\x10\xa9\x05\x12'\n" +
	"\"AGENT_AI_CONFIG_TARGET_UNAVAILABLE\x10\xaa\x05\x12(\n" +
	"#AGENT_AI_CONFIG_CAPABILITY_MISMATCH\x10\xab\x05\x12*\n" +
	"%AGENT_AI_CONFIG_MODEL_TARGET_MISMATCH\x10\xac\x05\x12%\n" +
	" AI_LOCAL_CONFIGURATION_NOT_FOUND\x10\xad\x05\x12#\n" +
	"\x1eAI_LOCAL_REQUIREMENT_NOT_FOUND\x10\xae\x05\x12\x1e\n" +
	"\x19AI_LOCAL_BINDING_CONFLICT\x10\xaf\x05\x12 \n" +
	"\x1bAI_LOCAL_DRIVER_UNAVAILABLE\x10\xb0\x05\x12\x1d\n" +
	"\x18AI_LOCAL_ASSET_NOT_FOUND\x10\xb1\x05\x12&\n" +
	...
	"!AI_CONFIG_PERSISTENCE_UNAVAILABLE\x10\xb8\x05\x12!\n" +
	...
	"\"AI_LOCAL_EXECUTION_PROCESS_CRASHED\x10\xc0\x05\x12(\n" +
	"#AI_LOCAL_EXECUTION_CONTENT_MISMATCH\x10\xc1\x05\x12#\n" +
	...
	"\x1bAI_CONFIG_REVISION_CONFLICT\x10\xd6\x05\x12\"\n" +
	"\x1dAPP_PACKAGE_SELECTION_INVALID\x10\xd7\x05\x12 \n" +
	"\x1bAPP_PACKAGE_SELECTION_STALE\x10\xd8\x05\x12\x1f\n" +
	"\x1aAPP_PACKAGE_POLICY_BLOCKED\x10\xd9\x05\x12\"\n" +
	"\x1dAPP_PACKAGE_ALREADY_INSTALLED\x10\xda\x05\x12$\n" +
	"\x1fAPP_PACKAGE_INSTALL_UNAVAILABLE\x10\xdb\x05\x12\x1b\n" +
	"\x16APP_PACKAGE_JOB_ACTIVE\x10\xdc\x05\x12\x1c\n" +
	"\x17APP_CATALOG_UNAVAILABLE\x10\xdd\x05\x12&\n" +
	...
	"\x18AI_FACE_TARGET_AMBIGUOUS\x10\xe5\x05\x12\x1b\n" +
