...
type MusicTranscriptionInputProfile struct {
	...
	MaxDurationSeconds uint32   `protobuf:"varint,3,opt,name=max_duration_seconds,json=maxDurationSeconds,proto3" json:"max_duration_seconds,omitempty"`
	MaxSourceBytes     uint32   `protobuf:"varint,4,opt,name=max_source_bytes,json=maxSourceBytes,proto3" json:"max_source_bytes,omitempty"`
...
func (x *MusicTranscriptionInputProfile) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MusicTranscriptionInputProfile) GetParts() []string {
	if x != nil {
		return x.Parts
	}
	return nil
...
func (x *MusicTranscriptionInputProfile) GetMaxDurationSeconds() uint32 {
	if x != nil {
		return x.MaxDurationSeconds
	}
	return 0
...
func (x *MusicTranscriptionInputProfile) GetMaxSourceBytes() uint32 {
	if x != nil {
...
func (x *MusicTranscriptionInputProfile) GetSupportsRange() bool {
	if x != nil {
