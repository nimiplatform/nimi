...
const (
	...
	AccountReasonCode_ACCOUNT_REASON_CODE_ACCOUNT_DELETED                      AccountReasonCode = 40
)
...
var (
	AccountReasonCode_name = map[int32]string{
		...
		40: "ACCOUNT_REASON_CODE_ACCOUNT_DELETED",
	}
	AccountReasonCode_value = map[string]int32{
		...
		"ACCOUNT_REASON_CODE_ACCOUNT_DELETED":                      40,
	}
)
...
const file_runtime_v1_account_proto_rawDesc = "" +
	...
	"\"ACCOUNT_SESSION_DELIVERY_KIND_LIVE\x10\x03*\x80\x0f\n" +
	...
	")PRESENCE_VERIFICATION_METHOD_TEST_HARNESS\x10\x03*\xde\x03\n" +
	...
	"\x1dACCOUNT_CALLER_MODE_LOCAL_APP\x10\t\"\x04\b\x01\x10\x01\"\x04\b\x04\x10\x04\"\x04\b\a\x10\a\"\x04\b\b\x10\b*)ACCOUNT_CALLER_MODE_LOCAL_FIRST_PARTY_APP*+ACCOUNT_CALLER_MODE_DESKTOP_LAUNCHED_AVATAR*\x17ACCOUNT_CALLER_MODE_MOD*'ACCOUNT_CALLER_MODE_LOCAL_DEVELOPER_APP*-ACCOUNT_CALLER_MODE_DESKTOP_LAUNCHED_NIMI_APP*\xe7\x01\n" +
